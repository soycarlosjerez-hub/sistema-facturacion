...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->call(PlantillaImpresionesSeeder::class); // Plantillas de impresion por modulo
        $this->call(PlantillaPresupuestosSeeder::class); // Plantillas de presupuesto adicionales
