            ...
            <div class="ui-card h-100" style="--delay:.15s">
                ...
                <div class="ui-card-body">
                    <form action="{{ route('pagos.store') }}" method="POST" id="form-pago">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="ui-input-group input-group-lg border rounded-4 overflow-hidden shadow-sm mb-2">
                                ...
                                <input type="number" name="monto" id="input-monto" class="ui-input border-0 fw-bold" 
                                       ...
                                       value="{{ $maxPago }}" required style="border-left:0;">
                            </div>
                            
                            <!-- Botones Rápidos -->
                            <div class="d-flex gap-2">
                                <button type="button" class="ui-btn ui-btn-ghost ui-btn-sm rounded-pill px-3" onclick="setMonto({{ $maxPago * 0.25 }})">25%</button>
                                <button type="button" class="ui-btn ui-btn-ghost ui-btn-sm rounded-pill px-3" onclick="setMonto({{ $maxPago * 0.5 }})">50%</button>
                                <button type="button" class="ui-btn ui-btn-solid ui-btn-sm rounded-pill px-3 fw-bold" onclick="setMonto({{ $maxPago }})">Total</button>
                            </div>
                        </div>
                        ...
                        <div class="row g-2">
                            <div class="col-6">
                                <a href="{{ route('clientes.cuentas') }}" class="ui-btn ui-btn-ghost w-100 rounded-pill py-2">Atrás</a>
                            </div>
                            <div class="col-6">
