    ...
    <div class="ui-header mb-4" style="--delay:0s">
        ...
        <div class="ui-header-body">
            ...
            <div class="ui-header-actions">
                ...
                <a href="{{ route('cuentas-bancarias.create') }}" class="ui-btn ui-btn-primary ui-btn-sm rounded-pill">
            ...
            <form method="GET" id="search-form" class="row g-2 align-items-center">
                <div class="col-lg-4">
                    <div class="ui-input-group">
                        ...
                        <input type="text" name="buscar" id="busqueda-cuenta" class="ui-input" placeholder="Nombre, banco, número de cuenta..." value="{{ request('buscar') }}" autocomplete="off">
                    </div>
                </div>
                ...
                <div class="col-lg-2 d-flex gap-2">
                    ...
                    <a href="{{ route('cuentas-bancarias.index') }}" class="ui-btn ui-btn-ghost"><i class="bi bi-x-lg"></i></a>
                </div>
            </form>
        </div>
    </div>
                        ...
                        @forelse($cuentas as $c)
                            <tr>
                                ...
                                <td class="text-end pe-4">
                                    <a href="{{ route('cuentas-bancarias.show', $c) }}" class="ui-action ui-action-view" title="Ver">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <a href="{{ route('cuentas-bancarias.edit', $c) }}" class="ui-action ui-action-edit" title="Editar">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <form action="{{ route('cuentas-bancarias.destroy', $c) }}" method="POST" class="d-inline"
                                          onclick="event.preventDefault();UI.confirm.delete('{{ route('cuentas-bancarias.destroy', $c) }}', '{{ addslashes($c->nombre) }}')">
                                        @csrf @method('DELETE')
