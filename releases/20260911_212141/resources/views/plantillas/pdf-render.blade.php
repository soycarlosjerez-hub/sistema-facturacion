...
<head>
    <meta charset="UTF-8">
    <title>{{ $template->nombre }} - Factura #{{ str_pad($venta->id, 5, '0', STR_PAD_LEFT) }}</title>
    <style>
        @page {
            margin: 0;
            padding: 0;
            ...
            <div class="d-flex justify-content-between">
                <div>
                    ...
                    <div class="empresa-datos">
                        ...
                        @if(!empty($empresa['empresa_rnc']))RNC/Cedula: {{ $empresa['empresa_rnc'] }} @endif
