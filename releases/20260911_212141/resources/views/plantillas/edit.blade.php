                ...
                <div class="ui-card mb-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            @endif
                            <a href="{{ route('plantillas.toggle', $plantilla) }}" class="ui-btn btn-sm w-100 {{ $plantilla->activo ? 'ui-btn-ghost text-danger' : 'ui-btn-solid text-success' }}" style="font-size: 0.85rem;">
...
$(function() {
    ...
    function updatePreview() {
        ...
        if (showFiscal) html += '<div style="font-size: 10px;">' + ncf + '</div>';
        html += '</div>';
