                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="serial_imei" value="{{ old('serial_imei') }}" class="ui-input @error('serial_imei') is-invalid @enderror" required placeholder="Ej. ABC123456789" autocomplete="off">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="serial_esn" value="{{ old('serial_esn') }}" class="ui-input @error('serial_esn') is-invalid @enderror" placeholder="Ej. ESN001234">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="marca" value="{{ old('marca') }}" class="ui-input @error('marca') is-invalid @enderror" required placeholder="Ej. Apple, Samsung">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="modelo" value="{{ old('modelo') }}" class="ui-input @error('modelo') is-invalid @enderror" required placeholder="Ej. iPhone 15 Pro, Galaxy S24">
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="text" name="color" value="{{ old('color') }}" class="ui-input @error('color') is-invalid @enderror" placeholder="Ej. Negro, Blanco">
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="number" name="almacenamiento_gb" value="{{ old('almacenamiento_gb') }}" class="ui-input @error('almacenamiento_gb') is-invalid @enderror" min="0" placeholder="128, 256...">
                ...
                <div class="row g-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="tipo_dispositivo" class="ui-select">
                                ...
                                @foreach(['celular','laptop','desktop','tablet','servidor','impresora','monitor','router','switch','camara','ups','otro'] as $opt)
                                    <option value="{{ $opt }}" {{ old('tipo_dispositivo') == $opt ? 'selected' : '' }}>{{ ucfirst($opt) }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="procesador" value="{{ old('procesador') }}" class="ui-input" placeholder="Ej. M3 Pro, i7-13700K">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="ui-label small fw-semibold">Memoria RAM</label>
                            <input type="text" name="memoria_ram" value="{{ old('memoria_ram') }}" class="ui-input" placeholder="Ej. 16GB, 32GB">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select name="almacenamiento_tipo" class="ui-select">
                                ...
                                @foreach(['HDD','SSD','NVMe','hybrid'] as $opt)
                                    <option value="{{ $opt }}" {{ old('almacenamiento_tipo') == $opt ? 'selected' : '' }}>{{ $opt }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="almacenamiento_capacidad" value="{{ old('almacenamiento_capacidad') }}" class="ui-input" placeholder="Ej. 512GB, 1TB">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="ui-label small fw-semibold">Sistema Operativo</label>
                            <input type="text" name="sistema_operativo" value="{{ old('sistema_operativo') }}" class="ui-input" placeholder="Ej. iOS 17, Windows 11">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="ui-label small fw-semibold">Puertos</label>
                            <textarea name="puertos" class="ui-input" rows="2" placeholder="Ej. USB-C, HDMI, 3.5mm audio...">{{ old('puertos') }}</textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="ui-label small fw-semibold">Peso (gramos)</label>
                            <input type="number" name="peso_gramos" value="{{ old('peso_gramos') }}" class="ui-input" min="0" step="0.01" placeholder="Ej. 187">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="estado" class="ui-select @error('estado') is-invalid @enderror" required>
                                ...
                                @foreach(['disponible','vendido','en_reparacion','dañado','reservado','mantenimiento'] as $opt)
                                    <option value="{{ $opt }}" {{ old('estado') == $opt ? 'selected' : '' }}>{{ ucfirst(str_replace('_', ' ', $opt)) }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <div class="ui-input-group input-group-lg">
                                ...
                                <input type="number" name="precio_venta" value="{{ old('precio_venta') }}" class="ui-input @error('precio_venta') is-invalid @enderror" step="0.01" min="0" required placeholder="0.00">
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <div class="ui-input-group input-group-lg">
                                <span class="ui-input-group-text bg-light fw-bold">$</span>
                                <input type="number" name="precio_compra" value="{{ old('precio_compra') }}" class="ui-input" step="0.01" min="0" placeholder="0.00">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <select name="comprado_a_proveedor_id" class="ui-select">
                                ...
                                @foreach($proveedores as $prov)
                                    <option value="{{ $prov->id }}" {{ old('comprado_a_proveedor_id') == $prov->id ? 'selected' : '' }}>{{ $prov->nombre }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="date" name="fecha_compra" value="{{ old('fecha_compra') }}" class="ui-input">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            <label class="ui-label small fw-semibold">Factura de Compra</label>
                            <input type="text" name="factura_compra" value="{{ old('factura_compra') }}" class="ui-input" placeholder="Ej. F-000123">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <select name="garantia_tipo" class="ui-select">
                                ...
                                <option value="fabrica" {{ old('garantia_tipo') == 'fabrica' ? 'selected' : '' }}>De Fábrica</option>
                                <option value="extendida" {{ old('garantia_tipo') == 'extendida' ? 'selected' : '' }}>Extendida</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="date" name="garantia_desde" value="{{ old('garantia_desde') }}" class="ui-input">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            <label class="ui-label small fw-semibold">Garantía Hasta</label>
                            <input type="date" name="garantia_hasta" value="{{ old('garantia_hasta') }}" class="ui-input">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="ui-card-body">
                ...
                <div class="row g-3">
                    <div class="col-md-3">
                        <div class="d-flex align-items-center gap-3 p-3 rounded-3" style="background: rgba(220,38,38,.04);">
                            <div class="form-check form-switch mb-0">
                                <input class="form-check-input" type="checkbox" name="bloqueado_icloud" value="1" id="chk_bloqueado_icloud" role="switch" style="width:3em;height:1.5em;" {{ old('bloqueado_icloud') ? 'checked' : '' }}>
                    ...
                    <div class="col-md-3">
                        <div class="d-flex align-items-center gap-3 p-3 rounded-3" style="background: rgba(220,38,38,.04);">
                            <div class="form-check form-switch mb-0">
                                <input class="form-check-input" type="checkbox" name="bloqueado_fr" value="1" id="chk_bloqueado_fr" role="switch" style="width:3em;height:1.5em;" {{ old('bloqueado_fr') ? 'checked' : '' }}>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <textarea name="observaciones" class="ui-input" rows="3" placeholder="Notas adicionales sobre el equipo...">{{ old('observaciones') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
