...
<td style="padding:12px 16px;color:#1e293b;font-size:14px;">{{ $user->name }}</td>
</tr>
<tr>
...
<td style="padding:12px 16px;color:#1e293b;font-size:14px;border-top:1px solid #e2e8f0;">{{ $user->email }}</td>
</tr>
<tr style="background:#f8fafc;">
...
<span style="background:{{ $instance->businessType->color ?? '#3b82f6' }};color:#fff;padding:3px 12px;border-radius:999px;font-size:13px;font-weight:600;">
...
<td style="padding:12px 16px;color:#1e293b;font-size:14px;border-top:1px solid #e2e8f0;">{{ $instance->rnc }}</td>
</tr>
<tr>
...
<td style="padding:12px 16px;color:#1e293b;font-size:14px;border-top:1px solid #e2e8f0;">{{ $instance->telefono }}</td>
</tr>
<tr style="background:#f8fafc;">
...
<td style="padding:12px 16px;color:#1e293b;font-size:14px;border-top:1px solid #e2e8f0;">{{ $instance->direccion }}</td>
</tr>
<tr>
...
<td style="padding:12px 16px;color:#1e293b;font-size:14px;border-top:1px solid #e2e8f0;">{{ $instance->created_at->format('d/m/Y H:i') }}</td>
</tr>
</table>
...
<a href="{{ route('owner.instances.index') }}" style="display:inline-block;background:linear-gradient(135deg,#3b82f6,#2563eb);color:#fff;text-decoration:none;padding:14px 32px;border-radius:10px;font-weight:700;font-size:15px;">
