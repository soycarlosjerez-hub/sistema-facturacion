...
@section('title', 'Nuevo Documento SGC')
...
<div class="ui-page">
    ...
    <div class="ui-header mb-4" style="--delay:0s">
        ...
        <div class="ui-header-body">
            <div class="ui-header-left">
                ...
                <div>
                    <h4 class="ui-header-title">Nuevo Documento SGC</h4>
                    <div class="ui-header-meta">
                        <a href="{{ route('sgc.documentos.index') }}" class="text-white-50 text-decoration-none small me-2">
                            <i class="bi bi-arrow-left me-1"></i> Volver
                        </a>
                        Listado de documentos del sistema de gestión de calidad
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="ui-card" style="--delay:.1s">
        ...
        <div class="ui-card-body">
            <form action="{{ route('sgc.documentos.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="descripcion" class="form-control form-control-custom" rows="3">{{ old('descripcion') }}</textarea>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="categoria" class="form-select form-select-custom" required>
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" name="formato" class="form-control form-control-custom" value="{{ old('formato') }}" placeholder="PDF">
                        @error('formato')<div class="text-danger small mt-1">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-md-4">
                        <label class="form-label-custom">Versión</label>
                        <input type="text" name="version" class="form-control form-control-custom" value="{{ old('version') }}" placeholder="1.0">
                        @error('version')<div class="text-danger small mt-1">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-md-3">
                        <label class="form-label-custom">Fecha Emisión</label>
                        <input type="date" name="fecha_emision" class="form-control form-control-custom" value="{{ old('fecha_emision') }}">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="date" name="fecha_revision" class="form-control form-control-custom" value="{{ old('fecha_revision') }}">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="date" name="fecha_vencimiento" class="form-control form-control-custom" value="{{ old('fecha_vencimiento') }}">
                    ...
                    <div class="col-md-5">
                        <label class="form-label-custom">Archivo Adjunto</label>
                ...
                <div class="d-flex gap-2 mt-4 pt-3 border-top">
                    ...
                    <a href="{{ route('sgc.documentos.index') }}" class="ui-btn ui-btn-ghost ui-btn-sm rounded-pill px-4">
