@extends('layouts.app')
@section('title', 'Nuevo Contrato de Mantenimiento')
...
<div class="ui-page" style="--accent:#06b6d4;--accent-rgb:6,182,212;--accent-hover:#0891b2;">
    ...
    {{-- Form --}}
    <form action="{{ route('climatizacion.contratos.store') }}" method="POST" id="contratoForm">
        @csrf
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="tipo_periodicidad" id="tipo_periodicidad" class="ui-select @error('tipo_periodicidad') is-invalid @enderror" required>
                            ...
                            @foreach(\App\Models\ContratoMantenimiento::PERIODICIDADES as $val => $label)
                                <option value="{{ $val }}" {{ old('tipo_periodicidad') == $val ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="ui-input-group">
                            ...
                            <input type="number" step="0.01" min="0" name="valor_mensual" id="valor_mensual"
                                   ...
                                   value="{{ old('valor_mensual') }}" placeholder="0.00" required>
                        </div>
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="date" name="vigencia_desde" id="vigencia_desde"
                               ...
                               value="{{ old('vigencia_desde') }}" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date" name="vigencia_hasta" id="vigencia_hasta"
                               ...
                               value="{{ old('vigencia_hasta') }}" required>
        ...
        <div class="ui-card" style="--delay:.2s">
            ...
            <div class="ui-card-body">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <div class="ui-input-group">
                            ...
                            <input type="number" step="0.01" min="0" name="deducible" id="deducible"
                                   ...
                                   value="{{ old('deducible', 0) }}" placeholder="0.00">
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="ui-input-group">
                            ...
                            <input type="number" step="0.01" min="0" name="cobertura_maxima" id="cobertura_maxima"
                                   ...
                                   value="{{ old('cobertura_maxima', 0) }}" placeholder="0.00">
                        </div>
                    ...
                    <div class="col-md-4 d-flex align-items-end pb-2">
                        <div class="form-check">
                            ...
                            <input type="checkbox" name="incluye_visitas" id="incluye_visitas" class="form-check-input"
                                   value="1" {{ old('incluye_visitas') ? 'checked' : '' }}>
                    ...
                    <div class="col-md-4" id="visitasAnualesGroup" style="{{ old('incluye_visitas') ? '' : 'display:none;' }}">
                        ...
                        <input type="number" min="0" name="num_visitas_anuales" id="num_visitas_anuales"
                               ...
                               value="{{ old('num_visitas_anuales', 0) }}" placeholder="0">
                ...
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        <textarea name="equipos_cubiertos" id="equipos_cubiertos"
                                  ...
                                  rows="4" placeholder="Detalle aquí los equipos cubiertos por este contrato...">{{ old('equipos_cubiertos') }}</textarea>
