                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nombre" id="nombre"
                               ...
                               value="{{ old('nombre') }}" placeholder="Nombre del tipo de equipo" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="slug" id="slug"
                               ...
                               value="{{ old('slug') }}" placeholder="ej: minisplit-inverter" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="icono" id="icono"
                               ...
                               value="{{ old('icono') }}" placeholder="ej: bi-snow">
