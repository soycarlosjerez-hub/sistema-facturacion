...
<div class="ui-page" style="--accent:#3b82f6;--accent-rgb:59,130,246;--accent-hover:#2563eb;">
    ...
    <form action="{{ route('instance.users.store', $instance->id) }}" method="POST" id="userForm">
        @csrf
                ...
                <div class="ui-card h-100">
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="ui-input" value="{{ old('name') }}" placeholder="Ej: Juan Pérez" required>
                        </div>

                        <div class="mb-3">
                            <label class="ui-label">Correo Electrónico</label>
                            <input type="email" name="email" class="ui-input" value="{{ old('email') }}" placeholder="ejemplo@correo.com" required>
                        </div>
                            ...
                            <div class="role-picker" id="rolePicker">
                                @if($instanceRoles->count() > 0)
                                    @foreach($instanceRoles as $rol)
                                        <label class="role-card {{ old('instance_role_id') == $rol->id ? 'active' : '' }}" data-role-id="{{ $rol->id }}">
                                            <input type="radio" name="instance_role_id" value="{{ $rol->id }}" class="d-none" {{ old('instance_role_id') == $rol->id ? 'checked' : '' }}>
    ...
    <div class="premium-sticky-bar">
        <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('instance.users.index', $instance->id) }}" class="btn-cancel">Cancelar</a>
