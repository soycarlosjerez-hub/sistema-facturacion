    ...
    <div class="premium-header-green mb-4">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3" style="position:relative; z-index:2;">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('instance.users.edit', [$instance->id, $user->id]) }}" class="ui-btn ui-btn-primary ui-btn-sm rounded-pill">
                    <i class="bi bi-pencil me-1"></i>Editar
                </a>
                <a href="{{ route('instance.users.index', $instance->id) }}" class="ui-btn ui-btn-primary ui-btn-sm rounded-pill">
            ...
            <div class="info-card">
                <div class="card-body p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="info-value small">{{ $user->created_at->format('d M Y') }}</div>
                    </div>
                    <div class="mb-3">
                        <div class="info-label">Última Actualización</div>
                        <div class="info-value small">{{ $user->updated_at->format('d M Y') }}</div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="info-value small">
                            ...
                            @else
                                <span class="badge bg-light text-dark rounded-pill px-3 py-2">{{ ucfirst($user->role) }}</span>
                            @endif
                        </div>
                    </div>
                    <div class="mb-3">
    ...
    <div class="premium-sticky-bar">
        <div class="d-flex align-items-center justify-content-between">
            <div class="d-flex align-items-center gap-2">
                ...
                <span class="fw-semibold d-none d-sm-inline">{{ $user->name }}</span>
            </div>
            <div class="d-flex gap-2">
                <a href="{{ route('instance.users.index', $instance->id) }}" class="btn-cancel">Cerrar</a>
                <a href="{{ route('instance.users.edit', [$instance->id, $user->id]) }}" class="btn-save"><i class="bi bi-pencil me-2"></i>Editar Usuario</a>
            </div>
        </div>
    </div>
</div>
