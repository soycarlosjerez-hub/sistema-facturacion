...
foreach ($clientes as $c) {
    ...
    if (strpos($c->nombre, "\r") !== false) {
        $special[] = 'carriage return';
    }
    if (strpos($c->nombre, '\\') !== false) {
        $special[] = 'backslash';
    }
    if (strpos($c->nombre, '<script') !== false) {
        $special[] = 'script tag';
    }
