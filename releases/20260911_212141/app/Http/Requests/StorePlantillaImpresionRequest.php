...
class StorePlantillaImpresionRequest extends FormRequest
{
    ...
    {
        return [
            'codigo' => 'required|string|max:100|unique:plantilla_impresiones,codigo',
            'nombre' => 'required|string|max:200',
            'modulo' => 'required|string|in:ventas,compras,cotizaciones,devoluciones,ordenes,conduces,presupuestos',
    ...
    public function messages(): array
    {
        return [
            ...
            'codigo.unique' => 'El código de plantilla ya existe. Usa un valor único.',
        ];
    }
}
