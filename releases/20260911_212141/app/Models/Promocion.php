...
class Promocion extends Model
{
    ...
    public function estaVigente(): bool
    {
        ...
        if ($this->valido_desde && $this->valido_desde->gt(now()->toDateString())) {
            return false;
        }
        if ($this->valido_hasta && $this->valido_hasta->lt(now()->toDateString())) {
            return false;
        }
        if ($this->uso_maximo && $this->uso_actual >= $this->uso_maximo) {
            return false;
        }
