...
class UpdateProductoRequest extends FormRequest
{
    ...
    {
        $routeModel = $this->route('producto');
        $productoId = is_object($routeModel) ? $routeModel->getKey() : $routeModel;
        ...
        return [
            ...
            'codigo_referencia' => 'nullable|string|max:100|unique:productos,codigo_referencia,'.$productoId,
