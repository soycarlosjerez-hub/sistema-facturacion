<?php $__env->startSection('title', 'FlowApi Documentation'); ?>
<?php $__env->startSection('topbar_class', 'px-4'); ?>
<?php $__env->startSection('topbar_extra'); ?>
    <span class="text-muted fw-normal" style="font-size: 0.8rem;">FlowHub-compatible API — Carritos, Checkout, Promos, Lealtad</span>
...
<div class="api-docs-wrapper">
    ...
    <aside class="api-sidebar" id="apiSidebar">
        ...
        <nav class="api-sidebar-nav" id="apiSidebarNav">
            ...
            <div class="api-nav-module" data-module="<?php echo e(strtolower($module['name'])); ?>">
                <a href="#module-<?php echo e(preg_replace('/[^a-z0-9]+/', '-', strtolower($module['name']))); ?>"
                   ...
                   onclick="toggleModule(this); return false;">
                    ...
                    <span class="endpoint-count" style="font-size:0.65rem;color:var(--api-muted);margin-left:0.5rem;">
                        (<?php echo e(count($module['endpoints'])); ?>)
                    </span>
                    <i class="bi bi-chevron-down collapse-icon"></i>
                </a>
                <div class="api-nav-endpoints" style="max-height: none;">
                    <?php $__currentLoopData = $module['endpoints']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $endpoint): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $moduleId = preg_replace('/[^a-z0-9]+/', '-', strtolower($module['name']));
                        $endpointId = $moduleId . '-endpoint-' . $endpoint['slug'];
                    ?>
                    <a href="#<?php echo e($endpointId); ?>"
                       class="api-nav-endpoint"
                       data-endpoint="<?php echo e($endpointId); ?>"
                       data-method="<?php echo e($endpoint['method']); ?>">
                        <span class="nav-method-badge method-<?php echo e($endpoint['method']); ?>"><?php echo e($endpoint['method']); ?></span>
                        <span class="nav-path"><?php echo e($endpoint['path']); ?></span>
                    </a>
    ...
    <main class="api-main" id="apiMain">
        <div class="api-header">
            <div class="d-flex align-items-center gap-2 mb-2">
                ...
                <span class="api-base-url">
                    <i class="bi bi-link-45deg"></i> <?php echo e(request()->getScheme()); ?>://<?php echo e(request()->getHost()); ?>/api
                </span>
                <a href="<?php echo e(route('flowapi.documentation.export')); ?>" class="btn btn-sm btn-outline-success rounded-pill ms-auto" title="Exportar documentación para IA">
                    <i class="bi bi-download me-1"></i> Exportar
                </a>
            </div>
            <h1>FlowApi Documentation</h1>
        ...
        <?php
            $moduleId = preg_replace('/[^a-z0-9]+/', '-', strtolower($module['name']));
        ?>
        <section class="api-module" id="module-<?php echo e($moduleId); ?>" data-module="<?php echo e(strtolower($module['name'])); ?>">
            <div class="api-module-header">
                <h2><?php echo e($module['name']); ?></h2>
                <span class="api-module-badge"><?php echo e(count($module['endpoints'])); ?> <?php echo e(Str::plural('endpoint', count($module['endpoints']))); ?></span>
            </div>
            <?php if($module['description']): ?>
                <p class="api-module-desc"><?php echo e($module['description']); ?></p>
            <?php endif; ?>
            ...
            <?php
                $endpointId = $moduleId . '-endpoint-' . $endpoint['slug'];
            ?>
            <div class="endpoint-card" id="<?php echo e($endpointId); ?>">
                <div class="endpoint-card-header" onclick="toggleEndpoint(this)">
                    <span class="method-badge method-<?php echo e($endpoint['method']); ?>"><?php echo e($endpoint['method']); ?></span>
                    <span class="endpoint-path" title="Copiar endpoint" onclick="event.stopPropagation(); copyPath(this)" style="cursor:pointer;" data-path="<?php echo e($endpoint['path']); ?>"><?php echo e($endpoint['path']); ?> <i class="bi bi-files"></i></span>
                    <span class="endpoint-action-title"><?php echo e($endpoint['action_title'] ?: $endpoint['name']); ?></span>
                    <i class="bi bi-chevron-down endpoint-expand-icon"></i>
                </div>
                <div class="endpoint-card-body">
                    <?php if($endpoint['summary']): ?>
                        <div class="endpoint-summary"><?php echo e($endpoint['summary']); ?></div>
                    <?php endif; ?>

                    <?php if($endpoint['permissions']): ?>
                        <div class="endpoint-permissions">
                            <i class="bi bi-shield-lock me-1"></i> <?php echo e($endpoint['permissions']); ?>

                        </div>
                    <?php endif; ?>

                    
                    <?php if($endpoint['headers']): ?>
                    <div class="detail-section">
                        ...
                        <div class="code-block-wrapper">
                            ...
                            <pre><?php echo e($endpoint['headers']); ?></pre>
                        </div>
                    </div>
                    <?php endif; ?>

                    
                    <?php if(!empty($endpoint['query_params'])): ?>
                    <div class="detail-section">
                        <div class="detail-section-title">
                        ...
                        <div class="table-responsive">
                            <table class="detail-table">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $endpoint['query_params']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $param): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><code class="field-name"><?php echo e($param['field'] ?? ''); ?></code></td>
                                        <td><span class="field-type"><?php echo e($param['type'] ?? '-'); ?></span></td>
                                        <td>
                                            <?php
                                                $req = $param['required'] ?? '';
                                                $isReq = str_contains($req, 'Sí') || str_contains($req, 'Yes') || str_contains($req, '*');
                                            ?>
                                            <span class="field-required <?php echo e($isReq ? 'required-yes' : 'required-no'); ?>">
                                                <?php echo e($isReq ? 'Requerido' : 'Opcional'); ?>

                                            </span>
                                        </td>
                                        <td><?php echo e($param['description'] ?? ''); ?></td>
                                    </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
                    ...
                    <?php if(!empty($endpoint['path_params'])): ?>
                    <div class="detail-section">
                        <div class="detail-section-title">
                        ...
                        <div class="table-responsive">
                            <table class="detail-table">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $endpoint['path_params']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $param): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><code class="field-name"><?php echo e($param['field'] ?? ''); ?></code></td>
                                        <td><span class="field-type"><?php echo e($param['type'] ?? '-'); ?></span></td>
                                        <td><?php echo e($param['description'] ?? ''); ?></td>
                    ...
                    <div class="detail-section">
                        ...
                        <div class="table-responsive">
                            <table class="detail-table">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $endpoint['campos']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $campo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><code class="field-name"><?php echo e($campo['field'] ?? ''); ?></code></td>
                                        <td><span class="field-type"><?php echo e($campo['type'] ?? '-'); ?></span></td>
                                        <td>
                                            <?php
                                                $req = $campo['required'] ?? '';
                                                $isReq = str_contains($req, 'Sí') || str_contains($req, 'Yes') || str_contains($req, '*');
                                        ...
                                        <td><?php echo e($campo['description'] ?? ''); ?></td>
                                    </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
                    ...
                    <?php if($endpoint['request_body_json']): ?>
                    <div class="detail-section">
                        <div class="detail-section-title">
                        ...
                        <div class="code-block-wrapper">
                            <button class="copy-btn" onclick="copyCode(this)"><i class="bi bi-clipboard"></i> Copy</button>
                            <pre><?php echo e($endpoint['request_body_json']); ?></pre>
                        </div>
                    </div>
                    <?php endif; ?>

                    
                    <?php if($endpoint['validations']): ?>
                    <div class="detail-section">
                        <div class="detail-section-title">
                        ...
                        <div class="code-block-wrapper">
                            <button class="copy-btn" onclick="copyCode(this)"><i class="bi bi-clipboard"></i> Copy</button>
                            <pre><?php echo e($endpoint['validations']); ?></pre>
                        </div>
                    </div>
                    <?php endif; ?>
                        ...
                        <div class="detail-section">
                            <div class="detail-section-title">
                                ...
                                <span style="margin-left:0.5rem;font-weight:700;color:var(--api-method-get);">
                                    <?php echo e($response['status_code']); ?> <?php echo e($response['status_text']); ?>
                            ...
                            <div class="code-block-wrapper">
                                <button class="copy-btn" onclick="copyCode(this)"><i class="bi bi-clipboard"></i> Copy</button>
                                <pre><?php echo e($response['json']); ?></pre>
                            </div>
                            <?php endif; ?>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if($endpoint['example_request']): ?>
                    <div class="detail-section">
                        <div class="detail-section-title">
                        ...
                        <div class="code-block-wrapper">
                            <button class="copy-btn" onclick="copyCode(this)"><i class="bi bi-clipboard"></i> Copy</button>
                            <pre><?php echo e($endpoint['example_request']); ?></pre>
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
        ...
        <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(!empty($module['field_references'])): ?>
            <?php
                $moduleId = preg_replace('/[^a-z0-9]+/', '-', strtolower($module['name']));
            ?>
            <section class="api-module" id="module-<?php echo e($moduleId); ?>-fields">
                <div class="api-module-header">
                    <h2 style="font-size:1.15rem;"><?php echo e($module['name']); ?> — Field Reference</h2>
                </div>
                <?php $__currentLoopData = $module['field_references']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ref): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="field-ref-section">
                    <h4><?php echo e($ref['title']); ?></h4>
                    <div class="table-responsive">
                        <table class="detail-table">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $ref['fields']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><code class="field-name"><?php echo e($field['name'] ?? $field['field'] ?? ''); ?></code></td>
                                    <td><span class="field-type"><?php echo e($field['type'] ?? '-'); ?></span></td>
        ...
        <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php
                $moduleId = preg_replace('/[^a-z0-9]+/', '-', strtolower($module['name']));
            ?>
            <div class="api-notas" id="module-<?php echo e($moduleId); ?>-notas">
                <h3><?php echo e($module['name']); ?> — Notas</h3>
                <?php echo Illuminate\Support\Str::markdown($module['notas']); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/api/flowapi.blade.php ENDPATH**/ ?>