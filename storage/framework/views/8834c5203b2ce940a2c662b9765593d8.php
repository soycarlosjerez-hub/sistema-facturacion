    ...
    <div class="ui-header mb-4">
        ...
        <div class="ui-header-body">
            <div class="ui-header-left">
                ...
                <div>
                    <h4 class="ui-header-title"><?php echo e(Auth::user()?->name ?? 'Mi Perfil'); ?></h4>
                    <div class="ui-header-meta">
                        <i class="bi bi-shield-check me-1"></i>
                        <?php echo e(ucfirst(Auth::user()?->roles?->first()?->name ?? Auth::user()?->role ?? 'Usuario')); ?>
        ...
        <div class="col-lg-6">
            ...
            <div class="ui-card mb-4" style="--delay:.25s;">
                ...
                <div class="card-body p-4">
                    ...
                    <?php endif; ?>
                    <div class="d-grid">
                        <a href="<?php echo e(route('two-factor.index')); ?>" class="ui-btn <?php echo e(auth()->user()->two_factor_secret ? 'ui-btn-ghost' : 'ui-btn-solid'); ?> fw-semibold">
                            <i class="bi bi-shield-fill-check me-2"></i>
                            <?php echo e(auth()->user()->two_factor_secret ? 'Administrar 2FA' : 'Activar 2FA'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/profile/edit.blade.php ENDPATH**/ ?>