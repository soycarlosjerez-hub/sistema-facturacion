...
<div class="container-fluid px-4 ui-page" style="--accent:#10b981;--accent-rgb:16,185,129;--accent-hover:#059669;">
        ...
        <div class="ui-header-body w-100">
            <div class="ui-header-left">
                ...
                <div>
                    ...
                    <div class="ui-header-meta">Registro fiscal conforme normativa DGII — Mes <?php echo e(\Carbon\Carbon::create($anio, $mes, 1)->translatedFormat('F')); ?> <?php echo e($anio); ?></div>
                </div>
            </div>
            <div class="ui-header-actions">
                <a href="<?php echo e(route('libros.ventas.csv', compact('mes','anio'))); ?>" class="ui-btn ui-btn-solid rounded-pill"><i class="bi bi-file-earmark-spreadsheet me-1"></i>CSV</a>
                <a href="<?php echo e(route('libros.ventas.pdf', compact('mes','anio'))); ?>" class="ui-btn ui-btn-solid rounded-pill"><i class="bi bi-file-earmark-pdf me-1"></i>PDF</a>
                <a href="<?php echo e(route('libros.compras.index', compact('mes','anio'))); ?>" class="ui-btn ui-btn-ghost rounded-pill"><i class="bi bi-arrow-left me-1"></i>Ir a Libro de Compras</a>
            </div>
        </div>
    </div>
    ...
    <div class="ui-card filter-card mb-4">
        ...
        <div class="px-4 py-3">
        <form method="GET" action="<?php echo e(route('libros.ventas.index')); ?>" class="row g-2 align-items-end">
            <div class="col-auto">
            ...
            <div class="col-auto">
                <input type="text" name="cliente" class="ui-select" placeholder="Buscar..." value="<?php echo e(request('cliente')); ?>">
            </div>
            <div class="col-auto">
            ...
            <div class="col-auto">
                <select name="tipo_ncf" class="ui-select">
                    ...
                    <option value="e31" <?php echo e(request('tipo_ncf')=='e31'?'selected':''); ?>>E31 (B1)</option>
                    <option value="e32" <?php echo e(request('tipo_ncf')=='e32'?'selected':''); ?>>E32 (B2)</option>
                    <option value="e33" <?php echo e(request('tipo_ncf')=='e33'?'selected':''); ?>>E33 (Débito)</option>
                    <option value="e34" <?php echo e(request('tipo_ncf')=='e34'?'selected':''); ?>>E34 (Crédito)</option>
                    <option value="e41" <?php echo e(request('tipo_ncf')=='e41'?'selected':''); ?>>E41 (Compra)</option>
                </select>
            </div>
            <div class="col-auto">
        ...
        <div class="table-responsive px-3 py-3">
            <table class="table align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="ps-4"><code><?php echo e(strtoupper($t->ncf_tipo)); ?></code></td>
                        <td class="text-center"><?php echo e(number_format($t->cantidad)); ?></td>
                        <td class="text-end">RD$ <?php echo e(number_format($t->subtotal, 2)); ?></td>
                        <td class="text-end">RD$ <?php echo e(number_format($t->itbis_total, 2)); ?></td>
                        <td class="text-end pe-4 fw-bold">RD$ <?php echo e(number_format($t->total_ventas, 2)); ?></td>
                    </tr>
            ...
            <table id="ventasTable" class="table align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="font-monospace small"><?php echo e($v->ncf ?? 'S/N'); ?></span></td>
                        <td><span class="fw-semibold small"><?php echo e($v->cliente->nombre ?? 'Consumidor Final'); ?></span></td>
                        <td><span class="font-monospace small"><?php echo e($v->cliente->rnc_cedula ?? '00000000000'); ?></span></td>
                        <td class="text-end">RD$ <?php echo e(number_format($v->subtotal, 2)); ?></td>
                        <td class="text-end">RD$ <?php echo e(number_format($v->impuestos, 2)); ?></td>
                        <td class="text-end fw-bold">RD$ <?php echo e(number_format($v->total, 2)); ?></td>
                        <td class="text-center"><span class="badge badge-<?php echo e($v->estado); ?>"><?php echo e(strtoupper(str_replace('_',' ',$v->estado))); ?></span></td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/libros/ventas/index.blade.php ENDPATH**/ ?>