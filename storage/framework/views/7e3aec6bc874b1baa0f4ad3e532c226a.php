...
<head>
    ...
    <title>Cotización <?php echo e($cotizacion->numero); ?></title>
    <style>
        body {
...
<body>
    <div class="email-container">
        <div class="email-header">
            <h1>📋 Cotización <?php echo e($cotizacion->numero); ?></h1>
            <p>Fecha: <?php echo e($cotizacion->fecha->format('d/m/Y')); ?> | Válida hasta: <?php echo e($cotizacion->fecha_validez->format('d/m/Y')); ?></p>
        </div>

        <div class="email-body">
            <p class="greeting">
                Estimado/a <strong><?php echo e($cotizacion->cliente?->nombre ?? 'Cliente'); ?></strong>,
            </p>

            <p>
                Adjunto encontrará la cotización <strong><?php echo e($cotizacion->numero); ?></strong> con los detalles de los productos y servicios solicitados.
            </p>
            ...
            <div class="info-box">
                <div class="info-row">
                    ...
                    <span class="info-value"><?php echo e($cotizacion->numero); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Fecha de emisión:</span>
                    <span class="info-value"><?php echo e($cotizacion->fecha->format('d/m/Y')); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Válida hasta:</span>
                    <span class="info-value"><?php echo e($cotizacion->fecha_validez->format('d/m/Y')); ?> (<?php echo e($cotizacion->dias_validez); ?> días)</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Atendido por:</span>
                    <span class="info-value"><?php echo e($cotizacion->user?->name ?? 'N/A'); ?></span>
                </div>
            </div>
                    ...
                    <?php $__currentLoopData = $cotizacion->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td>
                                ...
                                <?php if($item->codigo): ?>
                                    <br><small style="color: #6c757d;"><?php echo e($item->codigo); ?></small>
                                <?php endif; ?>
                            </td>
                            <td class="text-center"><?php echo e($item->cantidad); ?></td>
                            <td class="text-right">RD$<?php echo e(number_format($item->precio_unitario, 2)); ?></td>
                            <td class="text-right">RD$<?php echo e(number_format($item->subtotal, 2)); ?></td>
                        </tr>
            ...
            <div class="cta-container">
                <a href="<?php echo e($urlVer); ?>" class="cta-button">
            ...
            <?php if($cotizacion->condiciones): ?>
                <div class="info-box" style="border-left-color: #6c757d;">
                    ...
                    <p style="margin: 0; font-size: 13px; color: #495057;"><?php echo e($cotizacion->condiciones); ?></p>
                </div>
            <?php endif; ?>
            ...
            <p style="margin-top: 20px;">
                Atentamente,<br>
                <strong><?php echo e($cotizacion->user?->name ?? 'Equipo de Ventas'); ?></strong>
            </p>
        </div>
        ...
        <div class="email-footer">
            <p>
                ...
                <a href="<?php echo e($urlVer); ?>">Ver cotización #<?php echo e($cotizacion->numero); ?></a>
            </p>
...
<?php /**PATH /var/www/html/sistema-facturacion/resources/views/emails/cotizacion-enviada.blade.php ENDPATH**/ ?>