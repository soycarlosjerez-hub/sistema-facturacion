<?php $__env->startSection('title', 'Detalle de Log de Auditoría'); ?>
    ...
    <div class="ui-header mb-4" style="--delay:0s">
        ...
        <div class="ui-header-body">
            ...
            <div class="ui-header-actions">
                <a href="<?php echo e(route('owner.audit-logs.index', $instance ?? null)); ?>" class="ui-btn ui-btn-ghost ui-btn-sm rounded-pill">
                ...
                <div class="ui-card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-sm-6">
                            ...
                            <div class="detail-value fw-semibold"><?php echo e($auditLog->description); ?></div>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="detail-value"><?php echo e(class_basename($auditLog->model_type)); ?> #<?php echo e($auditLog->model_id); ?></div>
                        </div>
                        <div class="col-sm-6">
                            <div class="detail-label">Modelo completo</div>
                            <div class="detail-value font-monospace text-muted small"><?php echo e($auditLog->model_type); ?></div>
                        </div>
                        <div class="col-sm-6">
                            <div class="detail-label">Usuario</div>
                            <div class="detail-value"><?php echo e($auditLog->user?->name ?? '—'); ?> (#<?php echo e($auditLog->user_id); ?>)</div>
                        </div>
                        <div class="col-sm-6">
                            <div class="detail-label">Fecha/Hora</div>
                            <div class="detail-value"><?php echo e($auditLog->created_at->format('d/m/Y h:i:s A')); ?></div>
                        </div>
                        <div class="col-sm-6">
                            <div class="detail-label">Dirección IP</div>
                            <div class="detail-value font-monospace"><?php echo e($auditLog->ip_address); ?></div>
                        </div>
                        <?php if($auditLog->user_agent): ?>
                        <div class="col-sm-6">
                            <div class="detail-label">User Agent</div>
                            <div class="detail-value font-monospace text-muted small" style="word-break:break-all;"><?php echo e($auditLog->user_agent); ?></div>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/owner/audit-logs/show.blade.php ENDPATH**/ ?>