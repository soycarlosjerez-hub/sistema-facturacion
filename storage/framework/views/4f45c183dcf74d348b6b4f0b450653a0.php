<?php $__env->startSection('title', 'Mis Entregas'); ?>
...
<div class="ui-page" style="--accent:#0ea5e9;--accent-rgb:14,165,233;--accent-hover:#0284c7;">
            ...
            <div class="ui-header-left">
                ...
                <div>
                    ...
                    <div class="ui-header-meta">
                        ...
                        <span><?php echo e(now()->translatedFormat('l, d \\d\\e F \\d\\e Y')); ?></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row g-3 mb-4">
        <div class="col-6 col-md-3">
            <div class="stat-card stat-card-warning">
                <div class="stat-value"><?php echo e($pendientes->count()); ?></div>
                <div class="stat-label">Pendientes</div>
            </div>
        </div>
        <div class="col-6 col-md-3">
            <div class="stat-card stat-card-info">
                <div class="stat-value"><?php echo e($enCamino->count()); ?></div>
                <div class="stat-label">En Camino</div>
            </div>
        </div>
        <div class="col-6 col-md-3">
            <div class="stat-card stat-card-success">
                <div class="stat-value"><?php echo e($entregadasHoy); ?></div>
                <div class="stat-label">Entregas Hoy</div>
            </div>
        </div>
        <div class="col-6 col-md-3">
            <div class="stat-card stat-card">
                <div class="stat-value"><?php echo e($ventas->count()); ?></div>
    ...
    <div class="mb-4">
        <h6 class="fw-bold mb-3" style="color:#d97706;">
            <i class="bi bi-clock-history me-2"></i>Pendientes (<?php echo e($pendientes->count()); ?>)
        </h6>
        <?php $__currentLoopData = $pendientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $venta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="orden-card mb-3" style="--delay:.<?php echo e($loop->index); ?>s">
            <div class="orden-card-accent creado"></div>
            <div class="p-3">
                <div class="d-flex justify-content-between align-items-start mb-2">
                    <div>
                        <span class="fw-bold" style="font-size:.95rem;">Venta #<?php echo e($venta->numero_venta ?? $venta->id); ?></span>
                        <?php if($venta->numero_ncf): ?>
                        <span class="ms-2" style="font-size:.7rem;color:#64748b;">NCF: <?php echo e($venta->numero_ncf); ?></span>
                        <?php endif; ?>
                    </div>
                ...
                <div class="mb-2">
                    <div class="order-info-row">
                        ...
                        <span class="order-info-value"><?php echo e($venta->cliente->nombre ?? 'Sin cliente'); ?></span>
                    </div>
                    <?php if($venta->cliente && $venta->cliente->telefono): ?>
                    <div class="order-info-row">
                        <span class="order-info-label"><i class="bi bi-telephone me-1"></i>Tel</span>
                        <span class="order-info-value"><?php echo e($venta->cliente->telefono); ?></span>
                    </div>
                    <?php endif; ?>
                    <div class="order-info-row">
                        <span class="order-info-label"><i class="bi bi-cash me-1"></i>Total</span>
                        <span class="order-info-value">$<?php echo e(number_format($venta->total, 2)); ?></span>
                    </div>
                    <div class="order-info-row">
                        <span class="order-info-label"><i class="bi bi-geo-alt me-1"></i>Dirección</span>
                        <span class="order-info-value"><?php echo e($venta->direccion_entrega ?? 'N/A'); ?></span>
                    </div>
                    <div class="order-info-row">
                        <span class="order-info-label"><i class="bi bi-clock me-1"></i>Hora</span>
                        <span class="order-info-value"><?php echo e($venta->created_at->format('h:i A')); ?></span>
                    </div>
                </div>
                <div class="d-grid gap-2">
                    <form action="<?php echo e(route('delivery-mis-entregas.updateStatus', $venta->deliveryTracking)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
    ...
    <?php if($enCamino->count()): ?>
    <div class="mb-4">
        <h6 class="fw-bold mb-3" style="color:#0284c7;">
            <i class="bi bi-truck me-2"></i>En Camino (<?php echo e($enCamino->count()); ?>)
        </h6>
        <?php $__currentLoopData = $enCamino; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $venta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="orden-card mb-3" style="--delay:.<?php echo e($loop->index); ?>s">
            ...
            <div class="p-3">
                ...
                <div class="d-grid gap-2">
                    <form action="<?php echo e(route('delivery-mis-entregas.updateStatus', $venta->deliveryTracking)); ?>" method="POST" class="d-flex gap-2" onsubmit="return UI.confirm.delete('¿Confirmar entrega completada?')">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PATCH'); ?>
                    ...
                    <form action="<?php echo e(route('delivery-mis-entregas.updateStatus', $venta->deliveryTracking)); ?>" method="POST" onsubmit="return UI.confirm.delete('¿Marcar como fallida?')">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PATCH'); ?>
    ...
    <?php if(! $pendientes->count() && ! $enCamino->count()): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/delivery-mis-entregas/index.blade.php ENDPATH**/ ?>