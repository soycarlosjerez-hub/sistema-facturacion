<?php $__env->startSection('title', 'POS — Punto de Venta'); ?>
            ...
            <div class="ui-header-left">
                ...
                <div>
                    ...
                    <div class="ui-header-meta">
                        ...
                        <span id="pos-clock"><?php echo e(now()->format('h:i A')); ?></span>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row g-2">
                            <div class="col-md-4">
                                ...
                                <select class="form-select form-select-sm" id="delivery-empresa">
                                    ...
                                    <?php $__currentLoopData = \App\Models\DeliveryCompany::where('activo', true)->orderBy('nombre')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empresa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="ui-card">
                ...
                <div class="card-body p-3">
                    ...
                    <div class="row g-2" id="servicios-list">
                        <?php $__empty_0 = true; $__currentLoopData = $servicios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $svc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
                        <div class="col-6">
                            <div class="pos-servicio-card" data-servicio="<?php echo e($svc->id); ?>" onclick="app.addServicio(<?php echo e($svc->id); ?>, '<?php echo e(addslashes($svc->nombre)); ?>', <?php echo e($svc->precio); ?>, 'servicio')">
                                <div class="pos-servicio-icon"><i class="bi bi-droplet"></i></div>
                                <div class="pos-servicio-nombre text-dark mb-1" style="font-size:0.85rem;"><?php echo e($svc->nombre); ?></div>
                                <div class="pos-servicio-precio small">RD$ <?php echo e(number_format($svc->precio, 2)); ?></div>
                            </div>
                        </div>
            ...
            <div class="ui-card">
                ...
                <div class="card-body p-3">
                    ...
                    <div class="row g-2" id="productos-list" style="max-height: 500px; overflow-y: auto;">
                        <?php $__empty_0 = true; $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
                        <?php if($prod->linea_negocio && $prod->linea_negocio !== 'todos'): ?>
                        <div class="col-6 col-md-4 producto-item" data-linea="<?php echo e($prod->linea_negocio); ?>">
                            <div class="pos-producto-card" onclick="app.addProducto(<?php echo e($prod->id); ?>, '<?php echo e(addslashes($prod->nombre)); ?>', <?php echo e($prod->precio); ?>, <?php echo e($prod->stock); ?>, 'producto')">
                                <div class="pos-producto-nombre text-dark mb-1" style="font-size:0.82rem;"><?php echo e($prod->nombre); ?></div>
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="pos-producto-precio small">RD$ <?php echo e(number_format($prod->precio, 2)); ?></div>
                                    <span class="badge rounded-pill <?php echo e($prod->stock <= $prod->stock_minimo ? 'bg-danger' : 'bg-success'); ?>" style="font-size:0.65rem;"><?php echo e($prod->stock); ?></span>
                                </div>
                            </div>
                        </div>
                        <?php endif; ?>
...
const app = (() => {
    ...
    window.app = {
        ...
        async cargarZonasPorEmpresa() {
            ...
            try {
                const resp = await fetch('<?php echo e(route("pos.delivery.zones")); ?>');
        ...
        async confirmar() {
            ...
            if (isDelivery) {
                ...
                try {
                    const resp = await fetch('<?php echo e(route("pos.checkout-delivery")); ?>', {
                        method: 'POST',
                ...
                fetch('<?php echo e(route("pos.checkout")); ?>', {
                    method: 'POST', headers: {'Content-Type':'application/json', 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'}, body: JSON.stringify(data)
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/pos/index.blade.php ENDPATH**/ ?>