...
<div class="ui-page" style="--accent:#6366f1;--accent-rgb:99,102,241;--accent-hover:#4f46e5;">
    ...
    <?php if(session('success')): ?>
        <div class="alert alert-success border-0 rounded-3 shadow-sm d-flex align-items-center mb-4">
            <i class="bi bi-check-circle-fill me-2"></i><div><?php echo e(session('success')); ?></div>
        </div>
    <?php endif; ?>
        ...
        <div class="ui-card-body p-0">
            <div class="table-responsive">
                <table class="ui-table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        <?php $__empty_0 = true; $__currentLoopData = $modulos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
                            <tr class="table-light">
                                <td colspan="9" class="fw-bold text-primary">
                                    <i class="bi bi-folder2 me-1"></i><?php echo e(ucfirst($categoria)); ?>

                                    <span class="badge bg-primary bg-opacity-10 text-primary ms-2"><?php echo e(count($items)); ?></span>
                                </td>
                            </tr>
                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modulo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr id="row-<?php echo e($modulo->id); ?>">
                                    <td class="text-muted"><?php echo e($modulo->orden); ?></td>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <i class="bi <?php echo e($modulo->icon); ?> text-muted"></i>
                                            <span class="fw-semibold"><?php echo e($modulo->label); ?></span>
                                        </div>
                                    </td>
                                    <td><code><?php echo e($modulo->key); ?></code></td>
                                    <td><span class="badge bg-secondary bg-opacity-10 text-secondary"><?php echo e($modulo->categoria); ?></span></td>
                                    <td><small class="text-muted"><?php echo e($modulo->sidebar_route ?? '-'); ?></small></td>
                                    <td><small class="text-muted"><?php echo e($modulo->sidebar_permission ?? '-'); ?></small></td>
                                    <td class="text-center">
                                        <div class="form-check form-switch d-flex justify-content-center">
                                            <input class="form-check-input" type="checkbox"
                                                <?php echo e($modulo->activo ? 'checked' : ''); ?>

                                                onchange="toggleModulo(<?php echo e($modulo->id); ?>, this.checked)">
                                        </div>
                                    </td>
                                    <td class="text-center"><?php echo e($modulo->orden); ?></td>
                                    <td class="text-end">
                                        <div class="d-flex gap-1 justify-content-end">
                                            <button class="ui-action ui-action-edit rounded-pill"
                                                onclick="openEditModal(<?php echo e($modulo->toJson()); ?>)" title="Editar">
                                                <i class="bi bi-pencil"></i>
                                            </button>
                                            <form action="<?php echo e(route('modulos.destroy', $modulo)); ?>" method="POST" class="d-inline"
...
<div class="modal fade" id="createModal" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content rounded-4 border-0 shadow">
            <form action="<?php echo e(route('modulos.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/modulos/index.blade.php ENDPATH**/ ?>