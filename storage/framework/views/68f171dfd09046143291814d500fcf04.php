...
<head>
    ...
    <title>Erpipos — Iniciar Sesión</title>
    ...
    <div class="login-wrapper">
        <div class="login-card">
            ...
            <div class="brand-section">
                ...
                <h1 class="brand-name">Erpipos</h1>
            ...
            <!-- Form -->
            <form id="loginForm" method="POST" action="<?php echo e(route('login')); ?>" autocomplete="off">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="options-row">
                    ...
                    <?php if(Route::has('password.request')): ?>
                        <a href="<?php echo e(route('password.request')); ?>" class="forgot-link">¿Olvidaste tu contraseña?</a>
                    <?php endif; ?>
                </div>
            ...
            <div class="login-footer">
                <?php if(Route::has('register')): ?>
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="btn-register-link">
...
<?php /**PATH /var/www/html/sistema-facturacion/resources/views/auth/login.blade.php ENDPATH**/ ?>