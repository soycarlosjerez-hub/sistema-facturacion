...
<div class="container">
    ...
    <div class="content">
        ...
        <p>Bienvenido a <strong><?php echo e(config('app.name')); ?></strong>. Tu empresa <strong><?php echo e($empresa); ?></strong> ya est&aacute; activa en el plan <span class="badge"><?php echo e($planNombre); ?></span>.</p>
        <div class="details">
            <p><strong>Periodo de prueba:</strong> <?php echo e($trialDays); ?> d&iacute;as</p>
            <p><strong>Termina el:</strong> <?php echo e($trialEnds); ?></p>
            <p><strong>Precio mensual despu&eacute;s de la prueba:</strong> RD$ <?php echo e($precio); ?>/mes</p>
        </div>
...
</html><?php /**PATH /var/www/html/sistema-facturacion/resources/views/emails/bienvenida-suscripcion.blade.php ENDPATH**/ ?>