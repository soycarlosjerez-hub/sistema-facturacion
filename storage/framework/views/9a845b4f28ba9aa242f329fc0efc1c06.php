...
<div class="ui-page" style="--accent:#6366f1;--accent-rgb:99,102,241;--accent-hover:#4f46e5;">
    ...
    <div class="ui-header mb-4" style="--delay:0s">
        ...
        <div class="ui-header-body">
            ...
            <div class="ui-header-actions">
                ...
                <a href="<?php echo e(route('productos.create')); ?>" class="ui-btn ui-btn-primary ui-btn-sm rounded-pill">
    ...
    <div class="ui-card mb-4" style="--delay:.1s">
        ...
        <div class="card-body p-3">
            <form method="GET" action="<?php echo e(route('productos.index')); ?>" id="filtros-form" class="row g-2 align-items-end" role="search" aria-label="Filtros de productos">
                <div class="col-12 col-sm-6 col-lg-3">
                    ...
                    <div class="ui-input-group">
                        ...
                        <input type="text" name="nombre" id="busqueda-producto" class="ui-input" placeholder="Nombre, código, referencia o SKU..." value="<?php echo e(request('nombre')); ?>" autocomplete="off">
                    </div>
                </div>
                <div class="col-6 col-sm-3 col-lg-2">
                    ...
                    <select name="stock_status" id="filter-stock" class="ui-select">
                        ...
                        <option value="ultimas_unidades" <?php echo e(request('stock_status') == 'ultimas_unidades' ? 'selected' : ''); ?>>Últimas unidades (≤2)</option>
                        <option value="critical" <?php echo e(request('stock_status') == 'critical' ? 'selected' : ''); ?>>Crítico (&le; 5)</option>
                        <option value="low" <?php echo e(request('stock_status') == 'low' ? 'selected' : ''); ?>>Bajo (6-15)</option>
                        <option value="ok" <?php echo e(request('stock_status') == 'ok' ? 'selected' : ''); ?>>Normal (&gt; 15)</option>
                    </select>
                </div>
                <div class="col-6 col-sm-3 col-lg-2">
                ...
                <div class="col-6 col-sm-3 col-lg-2">
                    ...
                    <input type="number" name="precio_min" id="filter-precio-min" class="ui-input" placeholder="RD$ 0.00" value="<?php echo e(request('precio_min')); ?>" step="0.01" min="0">
                </div>
                <div class="col-6 col-sm-3 col-lg-2">
                    <label class="ui-label small fw-bold text-muted" for="filter-precio-max">Precio Máx.</label>
                    <input type="number" name="precio_max" id="filter-precio-max" class="ui-input" placeholder="RD$ 0.00" value="<?php echo e(request('precio_max')); ?>" step="0.01" min="0">
                </div>
                <div class="col-12 col-lg-3 d-flex gap-2">
                    <button type="submit" class="ui-btn ui-btn-solid flex-grow-1"><i class="bi bi-funnel me-1"></i>Filtrar</button>
                    <a href="<?php echo e(route('productos.index')); ?>" class="ui-btn ui-btn-ghost"><i class="bi bi-x-lg"></i></a>
                </div>
                <div class="col-12">
                    <div class="d-flex gap-2 flex-wrap">
                        <a href="<?php echo e(route('productos.import')); ?>" class="ui-btn ui-btn-solid rounded-pill shadow-sm fw-medium">
                            <i class="bi bi-upload me-1"></i> Importar CSV
                        </a>
                        <a href="<?php echo e(route('productos.exportar', request()->all())); ?>" class="ui-btn ui-btn-solid rounded-pill shadow-sm fw-medium">
                            <i class="bi bi-file-excel me-1"></i> Excel
                        </a>
                        <a href="<?php echo e(route('productos.pdf', request()->all())); ?>" class="ui-btn ui-btn-solid rounded-pill shadow-sm fw-medium">
...
$(function() {
    ...
    const canEdit = <?php echo e(auth()->user()->can('productos.edit') ? 'true' : 'false'); ?>;
    const canToggle = canEdit;
    const canDelete = <?php echo e(auth()->user()->can('productos.delete') ? 'true' : 'false'); ?>;
    ...
    const table = $('#productos-table').DataTable({
        ajax: {
            url: '<?php echo e(route("productos.ajax")); ?>',
            type: 'GET',
    ...
    function reloadWithFilters() {
        ...
        table.ajax.url('<?php echo e(route("productos.ajax")); ?>?' + params.toString()).load();
    }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/productos/index.blade.php ENDPATH**/ ?>