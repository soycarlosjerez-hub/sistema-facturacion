        ...
        <div class="ui-header-body">
            <div class="ui-header-left">
                ...
                <div>
                    ...
                    <div class="ui-header-meta">
                        <?php echo e($caja->nombre); ?> - Turno iniciado <?php echo e($sesion->fecha_apertura->format('d/m/Y h:i A')); ?>

                    </div>
                </div>
            </div>
            <div class="ui-header-actions">
                <a href="<?php echo e(route('cajas.index')); ?>" class="ui-btn ui-btn-solid ui-btn-sm rounded-pill">
            ...
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-body p-4">
                    <form id="form-cierre" action="<?php echo e(route('sesiones.cerrar', $sesion->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-6">
                                <div class="p-3 bg-light rounded-4 h-100">
                                    ...
                                    <div class="d-flex justify-content-between mb-2">
                                        ...
                                        <span class="fw-bold">RD$<?php echo e(number_format($sesion->monto_inicial, 2)); ?></span>
                                    </div>
                                    <div class="d-flex justify-content-between mb-2">
                                        <span class="text-muted small">Ventas Totales:</span>
                                        <span class="fw-bold">RD$<?php echo e(number_format($ventasTotales, 2)); ?></span>
                                    </div>
                                    <hr class="opacity-25">
                                    <div class="d-flex justify-content-between mb-2">
                                        <span class="text-muted small">Cobros en Efectivo:</span>
                                        <span class="fw-bold text-success">RD$<?php echo e(number_format($pagosEfectivo, 2)); ?></span>
                                        <input type="hidden" name="cobros_efectivo" value="<?php echo e($pagosEfectivo); ?>">
                                    </div>
                                    <div class="d-flex justify-content-between mb-2">
                                        <span class="text-muted small">Cobros con Tarjeta:</span>
                                        <span class="fw-bold text-info">RD$<?php echo e(number_format($pagosTarjeta, 2)); ?></span>
                                        <input type="hidden" name="cobros_tarjeta" value="<?php echo e($pagosTarjeta); ?>">
                                    </div>
                                    <div class="d-flex justify-content-between mb-3">
                                        <span class="text-muted small">Transferencias:</span>
                                        <span class="fw-bold text-primary">RD$<?php echo e(number_format($pagosTransferencia, 2)); ?></span>
                                        <input type="hidden" name="cobros_transferencia" value="<?php echo e($pagosTransferencia); ?>">
                                    </div>
                                    ...
                                    <div class="p-2 bg-success bg-opacity-10 rounded-3 d-flex justify-content-between align-items-center">
                                        ...
                                        <span class="fs-5 fw-bold text-success">RD$<?php echo e(number_format($totalEsperado, 2)); ?></span>
                                    </div>
                                    <input type="hidden" name="total_esperado" value="<?php echo e($totalEsperado); ?>">
                                </div>
                            </div>
                                ...
                                <div class="p-3 bg-white border border-primary border-opacity-25 rounded-4 h-100 shadow-sm">
                                    ...
                                    <table class="table table-sm table-borderless mb-3" id="denom-table">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <?php $__currentLoopData = $denominations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td class="small fw-bold align-middle">
                                                    <i class="bi bi-file-earmark me-1 text-primary"></i><?php echo e($d['label']); ?>

                                                </td>
                                                <td>
                                                    <input type="number" min="0" value="0" class="form-control form-control-sm text-center denom-input" data-value="<?php echo e($d['value']); ?>">
                                                </td>
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $coins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td class="small fw-bold align-middle">
                                                    <i class="bi bi-circle me-1 text-warning"></i><?php echo e($c['label']); ?>

                                                </td>
                                                <td>
                                                    <input type="number" min="0" value="0" class="form-control form-control-sm text-center denom-input" data-value="<?php echo e($c['value']); ?>">
                                                </td>
                                                <td class="small text-end align-middle denom-subtotal">RD$0</td>
                                            </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <a href="<?php echo e(route('cajas.index')); ?>" class="btn btn-light w-100 rounded-pill py-3 fw-bold">
...
<script>
    const totalEsperadoJs = <?php echo e($totalEsperado); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/cajas/cierre.blade.php ENDPATH**/ ?>