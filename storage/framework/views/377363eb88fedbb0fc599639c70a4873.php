<?php $__env->startSection('title', 'Nuevo Tipo de Equipo'); ?>
...
<div class="ui-page" style="--accent:#06b6d4;--accent-rgb:6,182,212;--accent-hover:#0891b2;">
    ...
    <div class="ui-header mb-4" style="--delay:0s">
        ...
        <div class="ui-header-body">
            <div class="ui-header-left">
                ...
                <div>
                    <h4 class="ui-header-title">Nuevo Tipo de Equipo</h4>
    ...
    <form action="<?php echo e(route('climatizacion.tipos-equipos.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('nombre')); ?>" placeholder="Nombre del tipo de equipo" required>
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('slug')); ?>" placeholder="ej: minisplit-inverter" required>
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <option value="residencial" <?php echo e(old('categoria') === 'residencial' ? 'selected' : ''); ?>>Residencial</option>
                            <option value="comercial" <?php echo e(old('categoria') === 'comercial' ? 'selected' : ''); ?>>Comercial</option>
                            <option value="industrial" <?php echo e(old('categoria') === 'industrial' ? 'selected' : ''); ?>>Industrial</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('icono')); ?>" placeholder="ej: bi-snow">
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('orden', 0)); ?>" min="0" placeholder="0">
                    ...
                    <div class="col-md-2 d-flex align-items-end pb-2">
                        <div class="form-check form-switch">
                            ...
                            <input type="checkbox" name="activo" id="activo" class="form-check-input"
                                   value="1" <?php echo e(old('activo', '1') ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/climatizacion/tipos-equipos/create.blade.php ENDPATH**/ ?>