<?php $__env->startSection('title', $catSub->exists ? 'Editar Subcategoría' : 'Nueva Subcategoría'); ?>
...
<div class="ui-page" style="--accent:#8b5cf6;--accent-rgb:139,92,246;--accent-hover:#7c3aed;">
    <div class="ui-header mb-4">
        ...
        <div class="ui-header-body">
            <div class="ui-header-left">
                ...
                <div>
                    <h4 class="ui-header-title"><?php echo e($catSub->exists ? 'Editar: ' . $catSub->nombre : 'Nueva Subcategoría'); ?></h4>
    ...
    <div class="ui-card">
        ...
        <div class="card-body p-4">
            <form action="<?php echo e($catSub->exists ? route('category-subcategories.update', $catSub) : route('category-subcategories.store')); ?>" method="POST">
                <?php echo csrf_field(); ?> <?php if($catSub->exists): ?> <?php echo method_field('PUT'); ?> <?php endif; ?>

                <div class="mb-3">
                    <label class="ui-label">Nombre <span class="text-danger">*</span></label>
                    <input type="text" name="nombre" class="ui-input" value="<?php echo e(old('nombre', $catSub->nombre)); ?>" required>
                </div>
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <select name="category_id" class="ui-select">
                            ...
                            <option value="<?php echo e($cat->id); ?>" <?php echo e(old('category_id', $catSub->category_id) == $cat->id ? 'selected' : ''); ?>><?php echo e($cat->nombre); ?></option>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="parent_id" class="ui-select">
                            ...
                            <option value="<?php echo e($sub->id); ?>" <?php echo e(old('parent_id', $catSub->parent_id) == $sub->id ? 'selected' : ''); ?>><?php echo e($sub->nombre); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
                <div class="row g-3 mt-3">
                    <div class="col-md-4">
                        ...
                        <input type="number" name="orden" class="ui-input" value="<?php echo e(old('orden', $catSub->orden)); ?>" min="0">
                    </div>
                    <div class="col-md-4">
                        ...
                        <select name="business_type_id" class="ui-select">
                            ...
                            <option value="<?php echo e($bt->id); ?>" <?php echo e(old('business_type_id', $catSub->business_type_id) == $bt->id ? 'selected' : ''); ?>><?php echo e($bt->nombre); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
                <div class="mt-3">
                    <div class="d-flex align-items-center gap-3 p-3 rounded-3" style="background:rgba(139,92,246,0.05);">
                        <div class="form-check form-switch mb-0">
                            <input class="form-check-input" type="checkbox" name="activa" value="1" id="chk-activa" <?php echo e(old('activa', $catSub->activa) ? 'checked' : ''); ?> role="switch" style="width:3em;height:1.5em;">
...
<div class="ui-sticky-bar">
    <div class="ui-sticky-bar-inner">
        ...
        <button type="submit" form="" class="ui-btn ui-btn-solid rounded-pill px-5">
            <i class="bi bi-check-lg me-2"></i><?php echo e($catSub->exists ? 'Actualizar' : 'Crear'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/category-subcategories/form.blade.php ENDPATH**/ ?>