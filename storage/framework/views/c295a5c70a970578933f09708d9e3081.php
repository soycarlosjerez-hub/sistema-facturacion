<?php $__env->startSection('title', 'Capacitaciones'); ?>
    ...
    <div class="ui-header mb-4" style="--delay:0s">
        ...
        <div class="ui-header-body">
            ...
            <div class="ui-header-actions">
                <a href="<?php echo e(route('sgc.capacitaciones.competencias')); ?>" class="ui-btn ui-btn-ghost ui-btn-sm rounded-pill me-2">
                    <i class="bi bi-award me-1"></i> Competencias
                </a>
                <a href="<?php echo e(route('sgc.capacitaciones.create')); ?>" class="ui-btn ui-btn-primary ui-btn-sm rounded-pill">
                    <i class="bi bi-plus-lg me-1"></i> Nueva Capacitación
                </a>
            </div>
        </div>
        <div class="mt-3">
            <form method="GET" action="<?php echo e(route('sgc.capacitaciones.index')); ?>" class="d-flex gap-2 align-items-center flex-wrap">
                ...
                <?php if(request('buscar') || request('estado')): ?>
                    <a href="<?php echo e(route('sgc.capacitaciones.index')); ?>" class="ui-btn ui-btn-ghost ui-btn-sm rounded-pill px-3 text-white border-white border-opacity-25">
    ...
    <div class="ui-card" style="--delay:.1s">
        ...
        <div class="ui-card-body p-0">
            <table class="dt-table datatable" id="capacitaciones-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $capacitaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e(Str::limit($cap->titulo, 40)); ?></td>
                        <td><?php echo e($cap->fecha ? $cap->fecha->format('d/m/Y') : '-'); ?></td>
                        <td><?php echo e($cap->horario_label); ?></td>
                        <td><span class="badge-status badge-<?php echo e($cap->modalidad); ?>"><?php echo e($cap->modalidad_label); ?></span></td>
                        <td><?php echo e($cap->instructor_label); ?></td>
                        <td><span class="badge bg-primary bg-opacity-10 text-primary" style="font-size:.7rem;"><?php echo e($cap->participantes->count()); ?></span></td>
                        <td><span class="badge-status badge-<?php echo e($cap->estado); ?>"><?php echo e($cap->estado_label); ?></span></td>
                        <td>
                            <div class="d-flex gap-1">
                                <a href="<?php echo e(route('sgc.capacitaciones.show', $cap)); ?>" class="btn btn-sm btn-outline-primary rounded-pill" title="Ver">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <a href="<?php echo e(route('sgc.capacitaciones.edit', $cap)); ?>" class="btn btn-sm btn-outline-warning rounded-pill" title="Editar">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/sgc/capacitaciones/index.blade.php ENDPATH**/ ?>