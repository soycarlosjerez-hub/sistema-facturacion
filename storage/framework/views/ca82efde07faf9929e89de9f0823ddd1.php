<?php $__env->startSection('title', 'Nueva Zona de Cobertura'); ?>
...
<div class="ui-page" style="--accent:#0ea5e9;--accent-rgb:14,165,233;--accent-hover:#0284c7;">
    ...
    <div class="ui-card mb-5" style="--delay:.1s">
        ...
        <form id="zoneForm" method="POST" action="<?php echo e(route('delivery-zones.store')); ?>">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                           value="<?php echo e(old('nombre')); ?>" required maxlength="100" placeholder="Ej: Zona Norte, Centro Histórico">
...
unset($__errorArgs, $__bag); ?>"
                              rows="2" maxlength="300" placeholder="Describe los límites o características de la zona..."><?php echo e(old('descripcion')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('radio_km')); ?>" required placeholder="5">
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('tiempo_estimado_minutos')); ?>" required placeholder="30">
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('minimo_para_envio_gratis', 0)); ?>" placeholder="0">
                        </div>
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('tarifa_base')); ?>" required placeholder="150.00">
                        </div>
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('tarifa_por_km')); ?>" required placeholder="25.00">
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/delivery-zones/create.blade.php ENDPATH**/ ?>