<?php $__env->startSection('title', 'Reportes Restaurante'); ?>
    ...
    <div class="ui-header d-flex flex-wrap justify-content-between align-items-center mb-4">
        ...
        <div class="ui-header-body w-100">
            ...
            <div class="ui-header-actions">
                <a href="<?php echo e(route('reportes.index')); ?>" class="ui-btn ui-btn-ghost rounded-pill btn-sm">
                ...
                <div class="card-body p-0">
                    <div class="table-responsive px-3 py-3">
                        <table id="restauranteMeseroTable" class="table align-middle mb-0">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $ventasPorMesero; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($v->usuario?->name ?? '—'); ?></td>
                                    <td class="text-center"><?php echo e($v->total_ordenes); ?></td>
                                    <td class="text-end fw-bold">RD$ <?php echo e(number_format($v->total_ventas, 2)); ?></td>
                                </tr>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive px-3 py-3">
                        <table id="restauranteMesaTable" class="table align-middle mb-0">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $ventasPorMesa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($v->mesa?->nombre ?? 'Mesa ' . ($v->mesa?->numero ?? $v->mesa_id)); ?></td>
                                    <td class="text-center"><?php echo e($v->total_ordenes); ?></td>
                                    <td class="text-end fw-bold">RD$ <?php echo e(number_format($v->total_ventas, 2)); ?></td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive px-3 py-3">
                        <table id="restauranteTurnoTable" class="table align-middle mb-0">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $ventasPorHora; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($v->turno); ?></td>
                                    <td class="text-center"><?php echo e($v->total_ordenes); ?></td>
                                    <td class="text-end fw-bold">RD$ <?php echo e(number_format($v->total_ventas, 2)); ?></td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive px-3 py-3">
                        <table id="restauranteProductosTable" class="table align-middle mb-0">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $productosTop; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($i + 1); ?></td>
                                    <td><?php echo e($p->producto->nombre ?? '—'); ?></td>
                                    <td class="text-center"><?php echo e($p->total_cantidad); ?></td>
                                    <td class="text-end fw-bold">RD$ <?php echo e(number_format($p->total_ventas, 2)); ?></td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
                        </table>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/reportes/restaurante.blade.php ENDPATH**/ ?>