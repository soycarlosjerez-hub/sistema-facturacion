<?php $__env->startSection('title', 'KDS - Pantalla de Cocina'); ?>
...
function loadOrders() {
    fetch('<?php echo e(route("kds.orders")); ?>')
        .then(r => r.json())
...
function updateDetalle(detalleId, estado) {
    fetch('<?php echo e(route("kds.update", ["detalle" => "_DETALLE_"])); ?>'.replace('_DETALLE_', detalleId), {
        method: 'POST',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/ordenes/kds.blade.php ENDPATH**/ ?>