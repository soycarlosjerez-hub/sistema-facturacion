    ...
    <div class="ui-header mb-4" style="--delay:0s">
        ...
        <div class="ui-header-body">
            ...
            <div class="ui-header-actions">
                <a href="<?php echo e(route('backups.config')); ?>" class="ui-btn ui-btn-primary ui-btn-sm ui-btn-pill">
                    <i class="bi bi-gear me-1"></i> Configuración
                </a>
                <form method="POST" action="<?php echo e(route('backups.store')); ?>" style="display:inline;" id="backupForm">
                    <?php echo csrf_field(); ?>
        ...
        <div class="col-6 col-lg-3">
            <div class="ui-stat" style="--delay:.15s">
                ...
                <div class="ui-stat-body text-center">
                    ...
                    <div class="ui-stat-value text-warning" style="color:#f59e0b !important;"><?php echo e($countManual); ?></div>
        ...
        <div class="col-6 col-lg-3">
            <div class="ui-stat" style="--delay:.2s">
                ...
                <div class="ui-stat-body text-center">
                    ...
                    <div class="ui-stat-value" style="color:#8b5cf6 !important;"><?php echo e($countAuto); ?></div>
                    ...
                    <tbody>
                        <?php $__empty_0 = true; $__currentLoopData = $backups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $backup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
                            <tr>
                                ...
                                <td><span class="fw-semibold"><?php echo e($backup->sizeForHumans()); ?></span></td>
                                <td><small class="text-muted"><?php echo e($backup->user?->name ?? 'Sistema'); ?></small></td>
                                <td><small><?php echo e($backup->created_at->format('d/m/Y h:i A')); ?></small></td>
                                <td class="text-end pe-4">
                                    <div class="d-flex gap-1 justify-content-end">
                                        <?php if($backup->status === 'completado'): ?>
                                            <a href="<?php echo e(route('backups.download', $backup)); ?>" class="ui-action ui-action-print" title="Descargar">
                                                <i class="bi bi-download"></i>
                                            </a>
                                        <?php endif; ?>
                                        <button type="button" class="ui-action ui-action-delete"
                                                onclick="UI.confirm.delete('<?php echo e(route('backups.destroy', $backup)); ?>', '<?php echo e($backup->filename); ?>')"
                                                title="Eliminar">
                            ...
                            <tr>
                                <td colspan="7">
                                    <div class="ui-empty-state py-5">
                                        ...
                                        <form method="POST" action="<?php echo e(route('backups.store')); ?>" style="display:inline;">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/backups/index.blade.php ENDPATH**/ ?>