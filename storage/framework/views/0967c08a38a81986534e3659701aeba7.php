<?php $__env->startSection('title', "API Keys — {$instance->nombre}"); ?>
...
<div class="container-fluid px-4 py-3">
        ...
        <div class="d-flex align-items-start gap-3">
            ...
            <div class="flex-grow-1">
                ...
                <div class="ui-input-group input-group-sm mb-1">
                    <input type="text" class="ui-input font-monospace bg-white" value="<?php echo e(session('new_api_key')); ?>" readonly id="newApiKeyInput">
        ...
        <div class="ui-header-body">
            <div class="ui-header-left">
                ...
                <div>
                    ...
                    <p class="mb-0 opacity-75"><?php echo e($instance->nombre); ?> &middot; <?php echo e($instance->slug); ?></p>
                </div>
            </div>
    ...
    <div class="ui-card mb-4" style="--delay:.15s">
        ...
        <div class="card-header bg-transparent border-0 p-4 d-flex justify-content-between align-items-center">
            ...
            <small class="text-muted"><?php echo e($apiKeys->count()); ?> clave(s)</small>
        </div>
        <div class="card-body p-4 pt-0">
            <?php if($apiKeys->isNotEmpty()): ?>
            <div class="table-responsive">
                <table class="table table-sm table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <span class="fw-bold"><?php echo e($key->name); ?></span>
                            </td>
                            <td>
                                <code class="user-select-all small"><?php echo e($key->mask()); ?></code>
                            </td>
                            <td>
                                <span class="ui-badge ui-badge-<?php echo e($key->is_active ? 'success' : 'neutral'); ?> rounded-pill text-uppercase" style="font-size:.65rem;">
                                    <?php echo e($key->is_active ? 'Activa' : 'Inactiva'); ?>

                                </span>
                            </td>
                            <td>
                                <small class="text-muted"><?php echo e($key->last_used_at?->diffForHumans() ?? 'Nunca'); ?></small>
                            </td>
                            <td>
                                <small class="text-muted"><?php echo e($key->created_at->format('d/m/Y H:i')); ?></small>
                            </td>
                            <td>
                                <small><?php echo e($key->creator?->name ?? '—'); ?></small>
                            </td>
                            <td class="text-end">
                                <div class="d-flex gap-1 justify-content-end">
                                    <form method="POST" action="<?php echo e(route('owner.instances.api-keys.regenerate', [$instance, $key])); ?>" onsubmit="return UI.confirm.delete('&iquest;Regenerar la clave &quot;<?php echo e($key->name); ?>&quot;? La clave actual dejar&aacute; de funcionar inmediatamente.')" class="d-inline">
                                        <?php echo csrf_field(); ?>
                                        <button type="submit" class="ui-action ui-action-edit" title="Regenerar">
                                            <i class="bi bi-arrow-clockwise"></i>
                                        </button>
                                    </form>
                                    <form method="POST" action="<?php echo e(route('owner.instances.api-keys.toggle', [$instance, $key])); ?>" class="d-inline">
                                        <?php echo csrf_field(); ?>
                                        <button type="submit" class="ui-action ui-action-<?php echo e($key->is_active ? 'view' : 'edit'); ?>" title="<?php echo e($key->is_active ? 'Desactivar' : 'Activar'); ?>">
                                            <i class="bi bi-<?php echo e($key->is_active ? 'pause-fill' : 'play-fill'); ?>"></i>
                                        </button>
                                    </form>
                                    <form method="POST" action="<?php echo e(route('owner.instances.api-keys.destroy', [$instance, $key])); ?>" onsubmit="return UI.confirm.delete('&iquest;Eliminar permanentemente la clave &quot;<?php echo e($key->name); ?>&quot;? Esta acci&oacute;n no se puede deshacer.')" class="d-inline">
...
<div class="modal fade" id="createKeyModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-4 border-0 shadow">
            <form method="POST" action="<?php echo e(route('owner.instances.api-keys.generate', $instance)); ?>">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/owner/instances/api-keys.blade.php ENDPATH**/ ?>