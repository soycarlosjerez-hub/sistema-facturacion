...
<div class="container">
    ...
    <div class="content">
        ...
        <p>Nos complace confirmar el pago de la suscripci&oacute;n de <strong><?php echo e($empresa); ?></strong>. &iexcl;Su servicio est&aacute; activo!</p>
        <div class="details">
            <p><strong>Monto pagado:</strong> RD$ <?php echo e($monto); ?></p>
            <p><strong>Referencia:</strong> <?php echo e($referencia); ?></p>
            <p><strong>Suscripci&oacute;n activa hasta:</strong> <?php echo e($mesPagado); ?></p>
        </div>
        <p>Gracias por confiar en <?php echo e(config('app.name')); ?>. Puede gestionar su suscripci&oacute;n y ver su historial de pagos cuando lo desee.</p>
        <p style="text-align: center; margin: 25px 0 15px 0;">
            <a href="<?php echo e($suscripcionUrl); ?>" class="btn">Ver Mi Suscripci&oacute;n</a>
        </p>
...
</html><?php /**PATH /var/www/html/sistema-facturacion/resources/views/emails/pago-confirmado.blade.php ENDPATH**/ ?>