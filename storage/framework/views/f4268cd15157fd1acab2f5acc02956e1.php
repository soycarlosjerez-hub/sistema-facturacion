<?php $__env->startSection('title', $company->nombre); ?>
...
<div class="ui-page" style="--accent:#3b82f6;--accent-rgb:59,130,246;--accent-hover:#2563eb;">
    ...
    <div class="ui-header mb-4">
        ...
        <div class="ui-header-body">
            <div class="ui-header-left">
                ...
                <div>
                    <h4 class="ui-header-title"><?php echo e($company->nombre); ?></h4>
                    <div class="ui-header-meta">
                        <i class="bi bi-info-circle me-1"></i>
                        <span>Empresa de delivery</span>
                        <span class="divider">•</span>
                        <i class="bi bi-hash me-1"></i>
                        <span><?php echo e($company->nombre_corto); ?></span>
                    </div>
                </div>
            </div>
            <div class="ui-header-actions">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delivery-companies.edit')): ?>
                <a href="<?php echo e(route('delivery-companies.edit', $company)); ?>" class="ui-btn ui-btn-solid ui-btn-sm rounded-pill">
                ...
                <div class="ui-card-body">
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div class="info-value"><?php echo e($company->nombre); ?></div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">Código</div>
                            <div class="info-value">
                                <span class="ui-badge ui-badge-info"><?php echo e($company->nombre_corto); ?></span>
                            </div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">Comisión</div>
                            <div class="info-value"><?php echo e($company->comision_formateada); ?></div>
                        </div>
                        <div class="info-item">
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value"><?php echo e($company->created_at->format('d/M/Y H:i')); ?></div>
                        </div>
                        <div class="info-item">
                            <div class="info-label">Última actualización</div>
                            <div class="info-value"><?php echo e($company->updated_at->format('d/M/Y H:i')); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-6">
                    <div class="stat-card" style="--delay:.15s">
                        <div class="ui-card-body">
                            ...
                            <div class="stat-value" style="color: #3b82f6;"><?php echo e($totalVentas); ?></div>
                ...
                <div class="col-6">
                    <div class="stat-card" style="--delay:.2s">
                        <div class="ui-card-body">
                            ...
                            <div class="stat-value" style="color: #10b981;">RD$ <?php echo e(number_format($totalDeliveryFees, 2)); ?></div>
                    ...
                    <div class="stat-card" style="--delay:.25s">
                        <div class="ui-card-body">
                            <div class="stat-label" style="color: #8b5cf6;">
                                <i class="bi bi-percent me-1"></i>Comisiones estimadas (<?php echo e($company->comision_formateada); ?>)
                            </div>
                            <div class="stat-value" style="color: #8b5cf6;">RD$ <?php echo e(number_format($totalComisiones, 2)); ?></div>
    ...
    <div class="ui-card" style="--delay:.3s">
        ...
        <div class="ui-card-body px-0">
            <?php if($ventasConDelivery->isNotEmpty()): ?>
                ...
                <table class="ui-table table-hover align-middle mb-0">
                    <thead>
                        <tr>
                            ...
                            <th>Total</th>
                            <th>Delivery Fee</th>
                            <th>Comisión (<?php echo e($company->comision_formateada); ?>)</th>
                            <th>Fecha</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php $__currentLoopData = $ventasConDelivery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $venta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="ps-4 fw-semibold">
                                <a href="<?php echo e(route('ventas.show', $venta)); ?>" class="text-decoration-none" style="color: var(--accent, #3b82f6);">
                                    <?php echo e($venta->ncf); ?>

                                </a>
                            </td>
                            <td>
                                <?php echo e($venta->cliente ? $venta->cliente->nombre : '<span class="text-muted">Sin cliente</span>'); ?>

                            </td>
                            <td class="fw-semibold"><?php echo e(renderMoneda($venta->total)); ?></td>
                            <td><?php echo e(renderMoneda($venta->delivery_fee ?? 0)); ?></td>
                            <td class="fw-semibold" style="color: #8b5cf6;">
                                <?php echo e(renderMoneda(round(($venta->delivery_fee ?? 0) * ($company->comision_porcentaje / 100), 2))); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/delivery-companies/show.blade.php ENDPATH**/ ?>