<?php $__env->startSection('title', 'Editar Garantía'); ?>
...
<div class="ui-page" style="--accent:#10b981;--accent-rgb:16,185,129;--accent-hover:#059669;">
            ...
            <div class="ui-header-left">
                ...
                <div>
                    ...
                    <div class="ui-header-meta">
                        ...
                        Garantía #<?php echo e($garantia->id); ?>

                    </div>
                </div>
            </div>
            <div class="ui-header-actions">
                <a href="<?php echo e(route('garantias.show', $garantia)); ?>" class="ui-btn ui-btn-primary ui-btn-sm rounded-pill">
    ...
    <form method="POST" action="<?php echo e(route('garantias.update', $garantia)); ?>">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $equipos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($equipo->id); ?>" <?php echo e(old('equipo_id', $garantia->equipo_id) == $equipo->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $ordenes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orden): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($orden->id); ?>" <?php echo e(old('orden_reparacion_id', $garantia->orden_reparacion_id) == $orden->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <option value="reparacion" <?php echo e(old('tipo', $garantia->tipo) == 'reparacion' ? 'selected' : ''); ?>>Reparación</option>
                            <option value="pieza" <?php echo e(old('tipo', $garantia->tipo) == 'pieza' ? 'selected' : ''); ?>>Pieza</option>
                            <option value="servicio" <?php echo e(old('tipo', $garantia->tipo) == 'servicio' ? 'selected' : ''); ?>>Servicio</option>
                            <option value="extendida" <?php echo e(old('tipo', $garantia->tipo) == 'extendida' ? 'selected' : ''); ?>>Extendida</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('fecha_inicio', $garantia->fecha_inicio ? $garantia->fecha_inicio->format('Y-m-d') : '')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('fecha_fin', $garantia->fecha_fin ? $garantia->fecha_fin->format('Y-m-d') : '')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" step="0.01" min="0" value="<?php echo e(old('cobertura', $garantia->cobertura)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" rows="4" placeholder="Describe la cobertura, exclusiones, condiciones..."><?php echo e(old('terminos_condiciones', $garantia->terminos_condiciones)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="d-flex gap-2">
            ...
            <a href="<?php echo e(route('garantias.show', $garantia)); ?>" class="ui-btn ui-btn-secondary rounded-pill px-4">
                Cancelar
            </a>
        </div>
    </form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/garantias/edit.blade.php ENDPATH**/ ?>