    ...
    <div class="ticket">
        ...
        <table class="items-table">
            ...
            <?php $__currentLoopData = $venta->detalles->where('tipo_linea', '!=', 'delivery'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                    <td colspan="3" style="font-size: 0.65rem; color: #0d6efd; padding-left: 24px;">Garantia: <?php echo e($d->producto->garantia_meses); ?> meses</td>
                </tr>
                <?php endif; ?>
                <?php if($d->notas): ?>
                <tr>
                    <td colspan="3" style="font-size: 0.65rem; font-style: italic; color: #666; padding-left: 24px;"><?php echo e($d->notas); ?></td>
                </tr>
                <?php endif; ?>
        ...
        <?php if($ecfActual): ?>
        <div class="separator"></div>
        <div class="encf" style="background: <?php echo e($ecfActual->estado == 'aprobado' ? '#e8f5e9' : '#fff3e0'); ?>; padding: 4px; margin: 6px 0; border: 1px solid <?php echo e($ecfActual->estado == 'aprobado' ? '#4caf50' : '#ff9800'); ?>">
            <span style="font-size: 9px; color: #666;">e-CF <?php echo e(strtoupper($ecfActual->estado)); ?></span>
        ...
        <div class="footer">
            ...
            <p style="margin-top: 8px; font-size: 9px; color: #666;"><?php echo e(now()->format('d/m/Y H:i:s')); ?></p>
        </div>
    </div>
