<?php $__env->startSection('title', 'Editar Dueño de Plataforma'); ?>
    ...
    <div class="ui-header mb-4" style="--delay:.1s">
        ...
        <div class="ui-header-body">
            ...
            <div class="ui-header-actions">
                <a href="<?php echo e(route('owner.owners.index')); ?>" class="ui-btn ui-btn-ghost">
        ...
        <div class="col-lg-8">
            ...
            <div class="owner-hero-card" style="--delay:.15s">
                ...
                <div class="owner-hero-info">
                    <h3 class="owner-hero-name"><?php echo e($owner->name); ?></h3>
                    ...
                    <div class="owner-hero-meta">
                        <span class="owner-hero-meta-item">
                            ...
                            <?php echo e($owner->business_instances_count); ?> inst. vinculadas
                        </span>
                        <span class="owner-hero-meta-item">
                            <i class="bi bi-check-circle"></i>
                            <?php echo e($owner->assigned_instances_count); ?> activas
                        </span>
                        <span class="owner-hero-meta-item">
                            <i class="bi bi-hash"></i>
                            ID #<?php echo e($owner->id); ?>
            ...
            <div class="form-glass-card" style="--delay:.2s">
                ...
                <div class="card-body p-4 p-md-5 position-relative" style="z-index:1;">
                    <form action="<?php echo e(route('owner.owners.update', $owner)); ?>" method="POST" id="ownerEditForm">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-field-floating">
                            ...
                            <input type="text"
                                   name="name"
                                   id="name"
                                   class="ui-input <?php $__errorArgs = ['name'];
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback d-block mt-1 small"><?php echo e($message); ?></div><?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                        </div>
                        ...
                        <div class="form-field-floating">
                            ...
                            <input type="email"
                                   name="email"
                                   id="email"
                                   class="ui-input <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-field-floating">
                            ...
                            <input type="password"
                                   name="password"
                                   id="password"
                                   class="ui-input <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/owner/owners/edit.blade.php ENDPATH**/ ?>