...
<div class="container">
    <div class="header">
        <h1>¡Bienvenido a <?php echo e($instanceName); ?>!</h1>
    </div>
    <div class="content">
        ...
        <div class="setup-box">
            ...
            <a href="<?php echo e($setPasswordUrl); ?>" class="btn">Establecer Contraseña &rarr;</a>
        </div>
        <p style="margin-top: 20px;">Una vez establecida su contraseña, podrá iniciar sesión en cualquier momento:</p>
        <p style="text-align: center; margin: 15px 0;">
            <a href="<?php echo e($loginUrl); ?>" style="color: #4e54c8; font-size: 14px;">Ir a Iniciar Sesión</a>
        </p>
        <p>Si tiene alguna duda, no dude en ponerse en contacto con el equipo de soporte.</p>
        <p>Saludos cordiales,<br/>El equipo de <?php echo e($instanceName); ?></p>
    </div>
    <div class="footer">
        &copy; <?php echo e(date('Y')); ?> <?php echo e($instanceName); ?>. Todos los derechos reservados.
        <br/><span style="font-size: 11px; color: #999;">Si no creó esta cuenta,ignore este email.</span>
    </div>
</div>
</body>
</html>
<?php /**PATH /var/www/html/sistema-facturacion/resources/views/emails/user_created.blade.php ENDPATH**/ ?>