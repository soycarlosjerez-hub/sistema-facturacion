...
<form action="<?php echo e(route('setup.step')); ?>" method="POST" class="row g-3" id="form-contrato">
    <?php echo csrf_field(); ?>
    ...
    <div class="col-md-4">
        ...
        <input type="date" name="vigencia_desde" class="ui-input" value="<?php echo e(date('Y-m-d')); ?>">
    </div>

    <div class="col-md-4">
        <label class="ui-label">Vigencia Hasta</label>
        <input type="date" name="vigencia_hasta" class="ui-input" value="<?php echo e(date('Y-m-d', strtotime('+1 year'))); ?>">
    </div>
...
<?php /**PATH /var/www/html/sistema-facturacion/resources/views/setup/_step-contrato.blade.php ENDPATH**/ ?>