...
<body>
<div class="container">
    <div class="header <?php echo e($level); ?>">
        <div class="icon"><?php echo e($level === 'critical' ? '🔴' : ($level === 'error' ? '⚠️' : '⚡')); ?></div>
        <h1><?php echo e($title); ?></h1>
        <span class="badge <?php echo e($level); ?>"><?php echo e($level); ?></span>
    </div>
    <div class="content">

        <?php if($tenantName || $tenantId): ?>
        <div class="section">
            <div class="section-title">Instancia</div>
            <div class="info-box">
                <div class="info-row">
                    <span class="info-label">ID</span>
                    <span class="info-value"><?php echo e($tenantId ?? 'N/A'); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Nombre</span>
                    <span class="info-value"><?php echo e($tenantName ?? 'N/A'); ?></span>
                </div>
            </div>
        </div>
        <?php endif; ?>

        <?php if($userName || $userEmail || $userRole || $userId): ?>
        <div class="section">
            <div class="section-title">Usuario</div>
            <div class="info-box">
                <div class="info-row">
                    <span class="info-label">ID</span>
                    <span class="info-value"><?php echo e($userId ?? 'N/A'); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Nombre</span>
                    <span class="info-value"><?php echo e($userName ?? 'N/A'); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Email</span>
                    <span class="info-value"><?php echo e($userEmail ?? 'N/A'); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Rol</span>
                    <span class="info-value"><?php echo e($userRole ?? 'N/A'); ?></span>
                </div>
            </div>
        </div>
        <?php endif; ?>

        <?php if($httpMethod || $url || $referer): ?>
        <div class="section">
            <div class="section-title">Requerimiento</div>
            <div class="info-box">
                <div class="info-row">
                    <span class="info-label">Método</span>
                    <span class="info-value"><?php echo e($httpMethod ?? 'N/A'); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">URL</span>
                    <span class="info-value"><?php echo e($url ?? 'N/A'); ?></span>
                </div>
                <?php if($referer): ?>
                <div class="info-row">
                    <span class="info-label">Referer</span>
                    <span class="info-value"><?php echo e($referer); ?></span>
                </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <table class="input-table">
                ...
                <tr>
                    ...
                    <td><?php echo e(is_array($value) ? json_encode($value, JSON_UNESCAPED_UNICODE) : $value); ?></td>
                </tr>
        ...
        <div class="section">
            ...
            <div class="meta-grid">
                ...
                <div class="meta-item">
                    ...
                    <div class="meta-value"><?php echo e($sessionId); ?></div>
                </div>
                <?php endif; ?>
                <?php if($ipAddress): ?>
                <div class="meta-item">
                    <div class="meta-label">IP</div>
                    <div class="meta-value"><?php echo e($ipAddress); ?></div>
                </div>
                <?php endif; ?>
                <?php if($userAgent): ?>
                <div class="meta-item" style="grid-column: 1 / -1;">
                    <div class="meta-label">User-Agent</div>
                    <div class="meta-value"><?php echo e($userAgent); ?></div>
                </div>
                <?php endif; ?>
                <?php if($createdAt): ?>
                <div class="meta-item">
        ...
        <div class="section">
            ...
            <div class="section-value"><?php echo e($exceptionClass); ?></div>
        </div>
        <?php endif; ?>
        ...
        <div class="section">
            ...
            <div class="section-value"><?php echo e($file); ?>:<?php echo e($line); ?></div>
        </div>
        <?php endif; ?>
        ...
        <div class="section">
            ...
            <div class="section-value"><?php echo e($source); ?></div>
        </div>
        <?php endif; ?>

        <div class="section">
            <div class="section-title">Stack Trace</div>
            <div class="code-block"><?php echo e($errorMessage); ?></div>
        </div>
        ...
        <div class="section" style="margin-top: 20px;">
            ...
            <table class="context-table">
                <?php $__currentLoopData = $context; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <th><?php echo e($key); ?></th>
                    <td><?php echo e(is_array($value) ? json_encode($value, JSON_UNESCAPED_UNICODE) : $value); ?></td>
                </tr>
        ...
        <div style="text-align: center; margin-top: 25px;">
            <a href="<?php echo e(url('/owner/errors')); ?>" class="btn-view">Ver Panel de Errores</a>
        </div>
    </div>
    <div class="footer">
        &copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?> — Sistema de Alertas Automático
    </div>
</div>
</body>
</html>
<?php /**PATH /var/www/html/sistema-facturacion/resources/views/emails/error-alert.blade.php ENDPATH**/ ?>