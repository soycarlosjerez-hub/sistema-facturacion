...
<form action="<?php echo e(route('setup.step')); ?>" method="POST" class="row g-3" id="form-categoria-producto">
    <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/html/sistema-facturacion/resources/views/setup/_step-categoria-producto.blade.php ENDPATH**/ ?>