...
.modal-header.reusable-header {
    background: <?php echo e($colorData['gradient']); ?>;
...
.modal-footer.reusable-footer .btn-submit {
    ...
    padding: 0.6rem 1.5rem;
    transition: all 0.2s;
    box-shadow: 0 4px 14px <?php echo e($colorData['hex']); ?>33;
}

.modal-footer.reusable-footer .btn-submit:hover {
    box-shadow: 0 6px 20px <?php echo e($colorData['hex']); ?>55;
...
body.dark-mode .modal-body.reusable-body textarea:focus {
    background: #1e293b;
    border-color: <?php echo e($colorData['dark_hex']); ?>;
    color: #e2e8f0;
    box-shadow: 0 0 0 3px <?php echo e($colorData['hex']); ?>22;
}
...
<div class="modal fade" id="<?php echo e($id); ?>" tabindex="-1" aria-labelledby="<?php echo e($id); ?>Label"
     data-bs-backdrop="<?php echo e($closeOnBackdrop ?? true ? 'static' : 'false'); ?>"
     data-bs-keyboard="<?php echo e($closeOnEsc ?? true ? 'true' : 'false'); ?>">
        ...
        <div class="modal-content reusable-modal">
            ...
            <?php if($formAction): ?>
                <form action="<?php echo e($formAction); ?>" method="POST" id="<?php echo e($id); ?>Form">
                    <?php echo csrf_field(); ?>
                    <?php if(in_array($formMethod, ['PUT', 'PATCH', 'DELETE'])): ?>
            ...
            <div class="modal-header reusable-header">
                ...
                <h5 class="modal-title" id="<?php echo e($id); ?>Label">
                    <i class="bi <?php echo e($icon ?? 'bi-info-circle'); ?>"></i>
                    <?php echo e($title); ?>
            ...
            <div class="modal-footer reusable-footer">
                ...
                <button type="submit" class="btn btn-submit" id="<?php echo e($id); ?>Submit">
...
<?php $__env->startPush('modal-scripts'); ?>
<script>
(function() {
    var modalEl = document.getElementById('<?php echo e($id); ?>');
    if (!modalEl) return;
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/sistema-facturacion/resources/views/partials/modal-generic.blade.php ENDPATH**/ ?>