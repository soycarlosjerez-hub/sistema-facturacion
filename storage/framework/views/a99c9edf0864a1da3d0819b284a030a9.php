...
<div class="container-fluid px-4 py-3">
        ...
        <div class="ui-header-body">
            <div class="ui-header-left">
                ...
                <div>
                    ...
                    <h2 class="fw-bold mb-0"><?php echo e($role->name); ?></h2>
                    <p class="mb-0 opacity-75"><?php echo e(count($selectedMods)); ?> módulos asignados</p>
                </div>
            </div>
    ...
    <form action="<?php echo e(route('owner.instances.roles.update', [$instance, $role])); ?>" method="POST" id="roleForm">
                    ...
                    <div class="card-body p-4">
                        <div class="mb-3">
                            ...
                            <div class="position-relative">
                                ...
                                <input type="text" name="name" id="name" class="ui-input ps-5 <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('name', $role->name)); ?>" placeholder="Nombre del rol" required>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="alert alert-warning rounded-3 mt-3 mb-0 d-flex align-items-center gap-2 small">
                            ...
                            <span><?php echo e($role->users()->count()); ?> usuario(s) usan este rol.</span>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="ui-card mt-3" style="--delay:.25s; background: linear-gradient(135deg, rgba(99,102,241,0.05), rgba(79,70,229,0.05));">
                    <div class="card-body p-3 text-center">
                        ...
                        <div class="fs-1 fw-bold" id="modCount" style="color: #4f46e5;"><?php echo e(count($selectedMods)); ?></div>
                                    ...
                                    <?php $__currentLoopData = $modulosCategoria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modulo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-md-6">
                                            <label class="perm-toggle <?php echo e($checked ? 'is-checked' : ''); ?> mod-filterable" data-text="<?php echo e(strtolower($modulo->key)); ?> <?php echo e(strtolower($modulo->label)); ?> <?php echo e(strtolower($categoria)); ?>">
                                                ...
                                                <small class="text-muted" style="font-size: 0.65rem;"><?php echo e($modulo->key); ?></small>
                                            </label>
                                        </div>
    ...
    <?php if($role->users()->count() == 0): ?>
    <form action="<?php echo e(route('owner.instances.roles.destroy', [$instance, $role])); ?>" method="POST" onsubmit="return confirm('¿Eliminar el rol &quot;<?php echo e($role->name); ?>&quot;? Esta acción no se puede deshacer.')">
...
<div class="ui-sticky-bar">
    <div class="ui-sticky-bar-inner">
        <div class="d-flex align-items-center gap-2" id="saveBarLeft">
            ...
            <span class="fw-semibold d-none d-sm-inline">Editando Rol: <?php echo e($role->name); ?></span>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/owner/instances/roles/edit.blade.php ENDPATH**/ ?>