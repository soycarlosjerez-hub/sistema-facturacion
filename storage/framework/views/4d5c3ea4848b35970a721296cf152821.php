...
<?php $__env->startSection('title', 'Nueva Cita'); ?>
...
<div class="container-fluid px-4 py-3 premium-page">
    <div class="premium-header mb-4">
        ...
        <div class="d-flex justify-content-between align-items-center position-relative" style="z-index: 2;">
            ...
            <a href="<?php echo e(route('tattoo.citas.index')); ?>" class="btn btn-light rounded-pill px-4 shadow-sm fw-bold" style="backdrop-filter:blur(8px);background:rgba(255,255,255,.2);border:1.5px solid rgba(255,255,255,.35);">
    ...
    <div class="premium-card" style="animation-delay:.1s;">
        ...
        <div class="card-body">
            <form id="citaForm" action="<?php echo e(route('tattoo.citas.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="cliente_id" class="form-select rounded-3" required>
                            ...
                            <?php $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($cl->id); ?>" <?php echo e(old('cliente_id') == $cl->id ? 'selected' : ''); ?>><?php echo e($cl->nombre); ?> <?php if($cl->telefono): ?> (<?php echo e($cl->telefono); ?>) <?php endif; ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="col-md-3">
                        ...
                        <select name="diseno_id" class="form-select rounded-3">
                            ...
                            <?php $__currentLoopData = $disenos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($d->id); ?>" <?php echo e(old('diseno_id') == $d->id ? 'selected' : ''); ?>><?php echo e($d->titulo); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="col-md-3">
                        ...
                        <select name="lugar_tatuaje" class="form-select rounded-3">
                            ...
                            <?php $__currentLoopData = $lugares; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($l); ?>" <?php echo e(old('lugar_tatuaje') == $l ? 'selected' : ''); ?>><?php echo e(ucfirst($l)); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group rounded-3">
                            ...
                            <input type="number" name="total_servicio" id="totalServicio" class="form-control" min="1" step="0.01" required value="<?php echo e(old('total_servicio')); ?>">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label small fw-bold">% Depósito</label>
                        <div class="input-group rounded-3">
                            <input type="number" name="deposito_pct" id="depositoPct" class="form-control" min="0" max="100" step="1" value="<?php echo e(old('deposito_pct', 30)); ?>">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group rounded-3">
                            <span class="input-group-text">RD$</span>
                            <input type="number" name="descuento_aplicado" class="form-control" min="0" step="0.01" value="<?php echo e(old('descuento_aplicado', 0)); ?>">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <label class="form-label small fw-bold">Tamaño aprox.</label>
                        <input type="text" name="tamanio_approx" class="form-control rounded-3" value="<?php echo e(old('tamanio_approx')); ?>" placeholder="Ej: 10cm">
                    </div>
                </div>
                <hr class="my-4">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="artista_id" class="form-select rounded-3">
                            ...
                            <?php $__currentLoopData = $artistas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($a->id); ?>" <?php echo e(old('artista_id') == $a->id ? 'selected' : ''); ?>><?php echo e($a->nombre_completo); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="col-md-4">
                        ...
                        <input type="datetime-local" name="fecha_hora_inicio" class="form-control rounded-3" required
                               value="<?php echo e(old('fecha_hora_inicio', now()->addDay()->setHour(10)->setMinute(0)->format('Y-m-d\TH:i'))); ?>">
                    </div>
                    <div class="col-md-2">
                        <label class="form-label small fw-bold">Duración (min) <span class="text-danger">*</span></label>
                        <input type="number" name="duracion_min" class="form-control rounded-3" min="15" max="600" step="15" value="<?php echo e(old('duracion_min', 60)); ?>" required>
                    </div>
                    <div class="col-md-2 d-flex align-items-end">
                        <div class="form-check">
                            <input type="checkbox" name="revision_previa" class="form-check-input" id="revision_previa" value="1" <?php echo e(old('revision_previa') ? 'checked' : ''); ?>>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="notas_cliente" class="form-control rounded-3" rows="2" maxlength="1000"><?php echo e(old('notas_cliente')); ?></textarea>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label small fw-bold">Notas internas</label>
                        <textarea name="notas_internas" class="form-control rounded-3" rows="2" maxlength="1000"><?php echo e(old('notas_internas')); ?></textarea>
                    </div>
                </div>
            </form>
        </div>
...
<div class="premium-sticky-bar">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="<?php echo e(route('tattoo.citas.index')); ?>" class="btn-cancel me-2">Cancelar</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/tattoo/citas/create.blade.php ENDPATH**/ ?>