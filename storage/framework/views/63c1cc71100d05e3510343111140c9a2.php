...
<div class="container-fluid px-4 ui-page" style="--accent:#8b5cf6;--accent-rgb:139,92,246;--accent-hover:#7c3aed;">
        ...
        <div class="ui-header-body w-100">
            <div class="ui-header-left">
                ...
                <div>
                    ...
                    <div class="ui-header-meta"><?php echo e($totalProductos); ?> producto(s) &middot; <?php echo e($bajoStock); ?> bajo stock &middot; <?php echo e($sinStock); ?> sin stock</div>
                </div>
            </div>
            <div class="ui-header-actions">
                <a href="<?php echo e(route('reportes.stock.csv', request()->all())); ?>" class="ui-btn ui-btn-solid rounded-pill"><i class="bi bi-download me-1"></i> CSV</a>
                <a href="<?php echo e(route('reportes.stock.pdf', request()->all())); ?>" class="ui-btn ui-btn-solid rounded-pill"><i class="bi bi-file-pdf me-1"></i> PDF</a>
            ...
            <form method="GET" class="row gx-3 gy-3 align-items-end">
                <div class="col-auto">
                    ...
                    <select name="filtro" class="ui-select">
                        <option value="todos" <?php echo e($filtro === 'todos' ? 'selected' : ''); ?>>Todos los productos</option>
                        <option value="bajo_stock" <?php echo e($filtro === 'bajo_stock' ? 'selected' : ''); ?>>Stock bajo</option>
                        <option value="sin_stock" <?php echo e($filtro === 'sin_stock' ? 'selected' : ''); ?>>Sin stock</option>
                    </select>
                </div>
                <div class="col-auto">
                    <label class="ui-label small fw-semibold mb-1"><i class="bi bi-search text-primary me-1"></i>Buscar</label>
                    <input type="text" name="buscar" class="ui-input" placeholder="Buscar producto..." value="<?php echo e($buscar); ?>">
                </div>
                <div class="col-auto">
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-3"><div class="ui-stat text-center p-3"><div class="ui-stat-label">Total Productos</div><div class="ui-stat-value"><?php echo e($totalProductos); ?></div></div></div>
        <div class="col-md-3"><div class="ui-stat text-center p-3"><div class="ui-stat-label">Valor Inventario</div><div class="ui-stat-value text-primary">RD$ <?php echo e(number_format($totalValorInventario, 2)); ?></div></div></div>
        <div class="col-md-3"><div class="ui-stat text-center p-3"><div class="ui-stat-label">Stock Bajo</div><div class="ui-stat-value text-warning"><?php echo e($bajoStock); ?></div></div></div>
        <div class="col-md-3"><div class="ui-stat text-center p-3"><div class="ui-stat-label">Sin Stock</div><div class="ui-stat-value text-danger"><?php echo e($sinStock); ?></div></div></div>
    </div>
            ...
            <table id="stockTable" class="table align-middle mb-0">
                ...
                <tbody>
                    <?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <tr>
                            <td class="ps-4 font-monospace small"><?php echo e($p->codigo_barras ?? $p->referencia ?? '-'); ?></td>
                            <td><span class="fw-semibold small"><?php echo e($p->nombre); ?></span></td>
                            <td class="text-end"><span class="badge bg-<?php echo e($estado); ?> bg-opacity-10 text-<?php echo e($estado); ?> rounded-pill"><?php echo e($p->stock); ?></span></td>
                            <td class="text-end"><?php echo e($p->stock_minimo ?? 0); ?></td>
                            <td class="text-end">RD$ <?php echo e(number_format($p->precio_compra ?? 0, 2)); ?></td>
                            <td class="text-end">RD$ <?php echo e(number_format($p->precio ?? 0, 2)); ?></td>
                            <td class="text-end pe-4 fw-bold">RD$ <?php echo e(number_format($p->stock * ($p->precio_compra ?? 0), 2)); ?></td>
                        </tr>
                ...
                <tfoot class="fw-bold">
                    <tr>
                        ...
                        <td class="text-end pe-4 py-3">RD$ <?php echo e(number_format($totalValorInventario, 2)); ?></td>
                    </tr>
                </tfoot>
            </table>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/reportes/stock.blade.php ENDPATH**/ ?>