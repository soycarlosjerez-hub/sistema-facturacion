...
<p style="margin:0 0 20px;color:#334155;font-size:15px;line-height:1.5;">Tu solicitud para <strong><?php echo e($instance->nombre); ?></strong> ha sido aprobada. Tu empresa ya está lista para operar.</p>
...
<span style="background:<?php echo e($instance->businessType->color ?? '#22c55e'); ?>;color:#fff;padding:3px 12px;border-radius:999px;font-size:13px;font-weight:600;">
...
<?php if($instance->trial_ends_at): ?>
<p style="margin:0 0 24px;color:#334155;font-size:15px;line-height:1.5;">Tu periodo de prueba de <strong><?php echo e($instance->trialDays()); ?> días</strong> está activo. Fecha de vencimiento: <?php echo e($instance->trial_ends_at->format('d/m/Y')); ?>.</p>
<?php endif; ?>

<table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom:24px;">
<tr>
<td align="center" style="padding:8px 0;">
<a href="<?php echo e(route('login')); ?>" style="display:inline-block;background:linear-gradient(135deg,#3b82f6,#2563eb);color:#fff;text-decoration:none;padding:14px 32px;border-radius:10px;font-weight:700;font-size:15px;">
Acceder a mi Panel
</a>
</td>
</tr>
...
<?php /**PATH /var/www/html/sistema-facturacion/resources/views/emails/solicitud-aprobada.blade.php ENDPATH**/ ?>