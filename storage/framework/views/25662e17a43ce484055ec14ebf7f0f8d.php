<?php $__env->startSection('title', 'Confirmar Restauración de Backup'); ?>
    ...
    <div class="ui-header mb-4" style="--delay:0s">
        ...
        <div class="ui-header-body">
            ...
            <div class="ui-header-actions">
                <a href="<?php echo e(route('owner.backups.index')); ?>" class="ui-btn ui-btn-ghost ui-btn-sm rounded-pill">
                ...
                <div class="ui-card-body p-4">
                    ...
                    <div class="p-3 rounded-4 mb-4" style="background:rgba(239,68,68,.05);border:1px solid rgba(239,68,68,.15);">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <div class="fw-bold"><?php echo e($backup->nombre ?? $backup->filename ?? 'Backup'); ?></div>
                                <small class="text-muted"><?php echo e($backup->created_at ? $backup->created_at->format('d/m/Y h:i A') : 'Fecha desconocida'); ?></small>
                            </div>
                        </div>
                    </div>
                    ...
                    <form method="POST" action="<?php echo e(route('owner.backups.restore', $backup)); ?>" id="restoreForm">
                        <?php echo csrf_field(); ?>
                        <div class="mb-4">
                        ...
                        <div class="d-flex gap-2">
                            <a href="<?php echo e(route('owner.backups.index')); ?>" class="ui-btn ui-btn-ghost rounded-pill flex-fill">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/owner/backups/restore-confirm.blade.php ENDPATH**/ ?>