...
<div class="container-fluid px-4 ui-page" style="--accent:#3b82f6;--accent-rgb:59,130,246;--accent-hover:#2563eb">
    ...
    <div class="premium-header-amber mb-4">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3" style="position:relative; z-index:2;">
            ...
            <a href="<?php echo e(route('usuarios.create')); ?>" class="ui-btn ui-btn-primary ui-btn-sm rounded-pill">
            ...
            <div class="ui-stat p-3" style="--delay:.1s">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="ui-stat-value text-primary"><?php echo e($stats['total']); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="ui-stat p-3" style="--delay:.15s">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="ui-stat-value text-danger"><?php echo e($stats['admin']); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="ui-stat p-3" style="--delay:.2s">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="ui-stat-value text-warning"><?php echo e($stats['gerente']); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="ui-stat p-3" style="--delay:.25s">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="ui-stat-value text-info"><?php echo e($stats['vendedor']); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="ui-stat p-3" style="--delay:.3s">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="ui-stat-value text-success"><?php echo e($stats['almacen']); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="ui-stat p-3" style="--delay:.35s">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="ui-stat-value"><?php echo e($stats['contador']); ?></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card-body p-3">
            <form method="GET" class="d-flex align-items-center gap-3 flex-wrap">
                <div class="d-flex align-items-center gap-2 flex-wrap flex-grow-1">
                    <a href="<?php echo e(route('usuarios.index')); ?>" class="role-filter-pill <?php echo e(!request('rol') ? 'active' : ''); ?>">
                        <i class="bi bi-people"></i> Todos
                        <span class="count"><?php echo e($stats['total']); ?></span>
                    </a>
                    <?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rolKey => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(in_array($rolKey, ['total', 'sin_rol'])): ?> <?php continue; ?> <?php endif; ?>
                        <?php if($count > 0 && isset($rolConfig[$rolKey])): ?>
                            <a href="<?php echo e(route('usuarios.index', ['rol' => $rolKey] + request()->except('rol'))); ?>" class="role-filter-pill <?php echo e(request('rol') == $rolKey ? 'active' : ''); ?>" style="<?php echo e(request('rol') == $rolKey ? 'background: ' . $rolConfig[$rolKey]['gradient'] : ''); ?>">
                                <i class="bi <?php echo e($rolConfig[$rolKey]['icon']); ?>"></i> <?php echo e($rolConfig[$rolKey]['label']); ?>
                ...
                <div class="ui-input-group" style="max-width: 280px;">
                    ...
                    <input type="text" name="buscar" class="ui-input border-0 bg-light" placeholder="Buscar por nombre o email..." value="<?php echo e(request('buscar')); ?>">
                    <?php if(request('buscar') || request('rol')): ?>
                        <a href="<?php echo e(route('usuarios.index')); ?>" class="btn btn-light border-0" title="Limpiar"><i class="bi bi-x-lg"></i></a>
                    <?php endif; ?>
                </div>
            </form>
        </div>
    ...
    <div class="ui-card overflow-hidden" style="--delay:.2s">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    <?php $__empty_0 = true; $__currentLoopData = $usuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
                        <?php
                        ...
                        <tr class="user-row">
                            <td class="ps-4 py-3">
                                <div class="d-flex align-items-center gap-3">
                                    <div class="user-avatar" style="background: <?php echo e($cfg['gradient'] ?? 'linear-gradient(135deg, #64748b 0%, #475569 100%)'); ?>;">
                                    ...
                                    <div>
                                        ...
                                        <small class="text-muted" style="font-size: 0.7rem;">ID #<?php echo e($user->id); ?></small>
                                    </div>
                                </div>
                            </td>
                            <td class="py-3">
                                <?php if($cfg): ?>
                                    <span class="role-badge bg-<?php echo e($cfg['color']); ?> bg-opacity-10 text-<?php echo e($cfg['color']); ?>">
                                        <i class="bi <?php echo e($cfg['icon']); ?>"></i> <?php echo e($cfg['label']); ?>

                                    </span>
                                    <div class="small text-muted mt-1" style="font-size: 0.7rem;">
                                        <i class="bi bi-key"></i> <?php echo e($rolPerms); ?> <?php echo e($rolPerms == 1 ? 'permiso' : 'permisos'); ?>
                            ...
                            <td class="py-3">
                                <div class="small text-dark"><?php echo e($user->email); ?></div>
                            </td>
                            <td class="py-3">
                            ...
                            <td class="py-3">
                                <div class="small text-muted"><?php echo e($user->created_at->format('d M, Y')); ?></div>
                                <small class="text-muted" style="font-size: 0.7rem;"><?php echo e($user->created_at->diffForHumans()); ?></small>
                            </td>
                            <td class="text-end pe-4 py-3">
                                <a href="<?php echo e(route('usuarios.show', $user->id)); ?>" class="user-action-btn view me-1" title="Ver perfil">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <a href="<?php echo e(route('usuarios.edit', $user->id)); ?>" class="ui-action ui-action-edit me-1" title="Editar">
                                    <i class="bi bi-pencil"></i>
                                </a>
                                <?php if($user->id !== auth()->id()): ?>
                                    <form action="<?php echo e(route('usuarios.destroy', $user->id)); ?>" method="POST" class="d-inline" onsubmit="return UI.confirm.delete('¿Eliminar al usuario &quot;<?php echo e($user->name); ?>&quot;? Esta acción no se puede deshacer.')">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_0): ?>
                        <tr>
                            <td colspan="5" class="text-center py-5">
                                ...
                                <a href="<?php echo e(route('usuarios.create')); ?>" class="btn btn-primary rounded-pill px-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/usuarios/index.blade.php ENDPATH**/ ?>