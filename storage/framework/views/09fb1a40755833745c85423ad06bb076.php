...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.application-logo','data' => ['class' => 'd-block h-9 w-auto fill-current text-dark']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'd-block h-9 w-auto fill-current text-dark']); ?>
...
<?php endif; ?>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                <div class="font-medium fs-6 text-dark"><?php echo e(Auth::user()->name); ?></div>
                <div class="font-medium fs-6 text-secondary"><?php echo e(Auth::user()->email); ?></div>
            </div>
...
<?php /**PATH /var/www/html/sistema-facturacion/resources/views/layouts/navigation.blade.php ENDPATH**/ ?>