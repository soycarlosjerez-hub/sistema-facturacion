...
<div class="container-fluid py-4">
    ...
    <?php if(session('setup_completed') || (Auth::user()->businessInstance->setup_completed ?? false)): ?>
        ...
        <div class="wz-header">
            ...
            <div class="wz-header-actions">
                <a href="<?php echo e(route('dashboard')); ?>" class="wz-btn wz-btn-primary wz-btn-sm">
                ...
                <div class="wz-card">
                    ...
                    <div class="wz-card-body text-center py-4">
                        ...
                        <div class="d-flex flex-wrap gap-3 justify-content-center">
                            <a href="<?php echo e(route('setup.abrir-caja')); ?>" class="wz-btn wz-btn-success wz-btn-lg">
                                <i class="bi bi-cash-stack"></i> Abrir Caja y Vender
                            </a>
                            <a href="<?php echo e(route('ncf.index')); ?>" class="wz-btn wz-btn-outline wz-btn-lg">
                                <i class="bi bi-receipt-cutoff"></i> Configurar NCF
                            </a>
                        </div>

                        <hr class="my-4" style="opacity:.5;">
                        <a href="#" class="text-decoration-none small text-muted" id="btnReiniciarWizard">
            ...
            <div class="col-lg-8">
                <div class="wz-card">
                    ...
                    <div class="wz-card-body text-center py-4">
                        ...
                        <form action="<?php echo e(route('setup.complete')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
        ...
        <div class="wz-stepper-card">
            <div class="wz-stepper">
                <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="wz-step <?php echo e($step['completed'] ? 'completed' : ($current && $step['key'] === $current['key'] ? 'current' : 'pending')); ?>">
                        <div class="wz-circle">
                            <?php if($step['completed']): ?>
                        ...
                        <span class="wz-label"><?php echo e($step['label']); ?></span>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
            ...
            <div class="col-lg-8">
                <div class="wz-card">
                    ...
                    <div class="wz-card-body">
                        <?php echo $__env->make("setup._step-{$current['key']}", ['step' => $current], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
...
<script>
document.getElementById('btnReiniciarWizard')?.addEventListener('click', function(e) {
    e.preventDefault();
    if (confirm('¿Reiniciar la configuración inicial? Se marcarán como pendientes los pasos incompletos.')) {
        const form = document.createElement('form');
        form.method = 'POST';
        form.action = '<?php echo e(route('setup.restart')); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/setup/wizard.blade.php ENDPATH**/ ?>