<?php $__env->startSection('title', 'Nueva Mejora Continua'); ?>
...
<div class="ui-page">
    ...
    <div class="ui-card" style="--delay:.1s">
        ...
        <div class="ui-card-body">
            <form action="<?php echo e(route('sgc.mejora.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="numero" class="form-control form-control-custom" value="<?php echo e(old('numero')); ?>" placeholder="AUTO si se deja vacío">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" name="titulo" class="form-control form-control-custom" value="<?php echo e(old('titulo')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="origen" class="form-select form-select-custom" required>
                            ...
                            <?php $__currentLoopData = \App\Models\MejoraContinua::getOrigenOptions(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="prioridad" class="form-select form-select-custom" required>
                            <?php $__currentLoopData = \App\Models\MejoraContinua::getPrioridadOptions(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($key); ?>" <?php echo e(old('prioridad') == $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="impacto" class="form-select form-select-custom">
                            <?php $__currentLoopData = \App\Models\MejoraContinua::getImpactoOptions(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($key); ?>" <?php echo e(old('impacto') == $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="beneficios_esperados" class="form-control form-control-custom" rows="2"><?php echo e(old('beneficios_esperados')); ?></textarea>
                        <?php $__errorArgs = ['beneficios_esperados'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="text-danger small mt-1"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="ahorro_estimado" class="form-control form-control-custom" value="<?php echo e(old('ahorro_estimado')); ?>" step="0.01">
                        <?php $__errorArgs = ['ahorro_estimado'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="text-danger small mt-1"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="costo_estimado" class="form-control form-control-custom" value="<?php echo e(old('costo_estimado')); ?>" step="0.01">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="d-flex gap-2 mt-4 pt-3 border-top">
                    ...
                    <a href="<?php echo e(route('sgc.mejora.index')); ?>" class="ui-btn ui-btn-ghost ui-btn-sm rounded-pill px-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/sgc/mejora_continua/create.blade.php ENDPATH**/ ?>