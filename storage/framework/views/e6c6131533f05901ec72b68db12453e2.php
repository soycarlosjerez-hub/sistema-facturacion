<?php $__env->startSection('title', 'Editar Gasto'); ?>
...
<div class="ui-page" style="--accent:#10b981;--accent-rgb:16,185,129;--accent-hover:#059669;">
    ...
    <form id="gastoForm" method="POST" action="<?php echo e(route('gastos.update', $gasto)); ?>">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('descripcion', $gasto->descripcion)); ?>" required maxlength="500">
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('monto', $gasto->monto)); ?>" required>
                            </div>
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>" <?php echo e((old('categoria', $gasto->categoria) === $key) ? 'selected' : ''); ?>><?php echo e($label); ?></option>
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php $__currentLoopData = $plantillas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $planta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($planta->id); ?>" <?php echo e(old('planta_gasto_id', $gasto->planta_gasto_id) == $planta->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <option value="efectivo" <?php echo e(old('metodo_pago', $gasto->metodo_pago) === 'efectivo' ? 'selected' : ''); ?>>Efectivo</option>
                                <option value="tarjeta" <?php echo e(old('metodo_pago', $gasto->metodo_pago) === 'tarjeta' ? 'selected' : ''); ?>>Tarjeta</option>
                                <option value="transferencia" <?php echo e(old('metodo_pago', $gasto->metodo_pago) === 'transferencia' ? 'selected' : ''); ?>>Transferencia</option>
                                <option value="cheque" <?php echo e(old('metodo_pago', $gasto->metodo_pago) === 'cheque' ? 'selected' : ''); ?>>Cheque</option>
                                <option value="otro" <?php echo e(old('metodo_pago', $gasto->metodo_pago) === 'otro' ? 'selected' : ''); ?>>Otro</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php $__currentLoopData = $proveedores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proveedor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($proveedor->id); ?>" <?php echo e(old('proveedor_id', $gasto->proveedor_id) == $proveedor->id ? 'selected' : ''); ?>><?php echo e($proveedor->nombre); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('fecha_gasto', $gasto->fecha_gasto->format('Y-m-d'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('comprobante', $gasto->comprobante)); ?>" maxlength="100" placeholder="Factura o recibo #">
...
unset($__errorArgs, $__bag); ?>"
                                      maxlength="2000" placeholder="Información adicional..."><?php echo e(old('notas', $gasto->notas)); ?></textarea>
...
<div class="ui-sticky-bar">
    <div class="ui-sticky-bar-inner">
        <a href="<?php echo e(route('gastos.index')); ?>" class="ui-btn ui-btn-ghost rounded-pill">Cancelar</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/gastos/edit.blade.php ENDPATH**/ ?>