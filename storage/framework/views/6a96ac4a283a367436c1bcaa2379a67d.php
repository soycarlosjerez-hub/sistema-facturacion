        ...
        <div class="ui-header-body w-100">
            <div class="ui-header-left">
                ...
                <div>
                    ...
                    <div class="ui-header-meta">Período: <?php echo e($desde); ?> al <?php echo e($hasta); ?> &middot; <?php echo e($cantidad); ?> sesión(es)</div>
                </div>
            </div>
            <div class="ui-header-actions">
                <a href="<?php echo e(route('reportes.caja.pdf', ['desde' => $desde, 'hasta' => $hasta, 'caja_id' => request('caja_id')])); ?>" class="ui-btn ui-btn-solid rounded-pill shadow-sm px-4"><i class="bi bi-file-pdf me-1"></i> PDF</a>
                <a href="<?php echo e(route('reportes.caja.csv', ['desde' => $desde, 'hasta' => $hasta, 'caja_id' => request('caja_id')])); ?>" class="ui-btn ui-btn-solid rounded-pill shadow-sm px-4"><i class="bi bi-download me-1"></i> CSV</a>
                ...
                <div class="col-12 col-sm-auto">
                    ...
                    <select name="caja_id" class="ui-select">
                        ...
                        <?php $__currentLoopData = $cajas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($c->id); ?>" <?php echo e(request('caja_id') == $c->id ? 'selected' : ''); ?>><?php echo e($c->nombre); ?></option>
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-3">
            <div class="ui-stat text-center p-3">
                ...
                <div class="ui-stat-value text-primary"><?php echo e($cantidad); ?></div>
                <div class="mt-2 d-flex justify-content-center gap-3">
                    <span><span class="badge bg-success rounded-pill"><?php echo e($abiertas); ?></span> abiertas</span>
                    <span><span class="badge bg-secondary rounded-pill"><?php echo e($cerradas); ?></span> cerradas</span>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="ui-stat text-center p-3">
                ...
                <div class="ui-stat-value text-success">RD$ <?php echo e(number_format($totalVentas, 2)); ?></div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="ui-stat text-center p-3">
                <div class="ui-stat-label">Descuadre Total</div>
                <div class="ui-stat-value <?php echo e($totalDescuadre >= 0 ? 'text-success' : 'text-danger'); ?>">RD$ <?php echo e(number_format($totalDescuadre, 2)); ?></div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="ui-stat text-center p-3">
                <div class="ui-stat-label">Promedio x Sesión</div>
                <div class="ui-stat-value text-info">RD$ <?php echo e($cantidad > 0 ? number_format($totalVentas / $cantidad, 2) : '0.00'); ?></div>
            </div>
        </div>
    </div>
            ...
            <table id="cajaTable" class="table align-middle mb-0">
                ...
                <tbody>
                    <?php $__currentLoopData = $sesiones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><span class="fw-semibold"><?php echo e($s->caja?->nombre ?? ''); ?></span></td>
                            <td><?php echo e($s->user?->name ?? ''); ?></td>
                            <td><?php echo e($s->fecha_apertura?->format('d/m/Y H:i') ?? '-'); ?></td>
                            <td>
                                <?php if($s->estado === 'cerrada'): ?>
                                    <span class="session-closed"><?php echo e($s->fecha_cierre?->format('d/m/Y H:i') ?? '-'); ?></span>
                                <?php else: ?>
                            ...
                            <td class="text-end fw-bold <?php echo e(($s->descuadre ?? 0) >= 0 ? 'text-success' : 'text-danger'); ?>">RD$ <?php echo e(number_format($s->descuadre ?? 0, 2)); ?></td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
                <tfoot>
                    <tr>
                        ...
                        <td class="text-end fw-bold">RD$ <?php echo e(number_format($sesiones->sum('monto_inicial'), 2)); ?></td>
                        <td class="text-end fw-bold">RD$ <?php echo e(number_format($sesiones->sum('ventas_efectivo'), 2)); ?></td>
                        <td class="text-end fw-bold">RD$ <?php echo e(number_format($sesiones->sum('ventas_tarjeta'), 2)); ?></td>
                        <td class="text-end fw-bold">RD$ <?php echo e(number_format($sesiones->sum('ventas_transferencia'), 2)); ?></td>
                        <td class="text-end fw-bold">RD$ <?php echo e(number_format($sesiones->sum('monto_declarado'), 2)); ?></td>
                        <td class="text-end fw-bold">RD$ <?php echo e(number_format($sesiones->sum('descuadre'), 2)); ?></td>
                    </tr>
                </tfoot>
            </table>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/reportes/caja.blade.php ENDPATH**/ ?>