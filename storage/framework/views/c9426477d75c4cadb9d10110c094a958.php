...
<div class="ui-page" style="--accent:#f59e0b;--accent-rgb:245,158,11;--accent-hover:#d97706;--delay:0s;">
    ...
    <form action="<?php echo e(route('alquileres.contratos.store')); ?>" method="POST" id="instanceForm">
        <?php echo csrf_field(); ?>
        <div class="row g-4">
            <div class="col-lg-8">
                                    ...
                                    <div class="ui-input-group">
                                        ...
                                        <select name="vivienda_id" id="vivienda_id" class="ui-select" required>
                                            ...
                                            <?php $__currentLoopData = $viviendas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vivienda): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($vivienda->id); ?>" <?php echo e(old('vivienda_id')==$vivienda->id?'selected':''); ?>><?php echo e($vivienda->nombre); ?> (<?php echo e($vivienda->tipo); ?>)</option>
                                    ...
                                    <div class="ui-input-group">
                                        ...
                                        <select name="inquilino_id" id="inquilino_id" class="ui-select" required>
                                            ...
                                            <?php $__currentLoopData = $inquilinos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inquilino): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($inquilino->id); ?>" <?php echo e(old('inquilino_id')==$inquilino->id?'selected':''); ?>><?php echo e($inquilino->nombre); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <div class="ui-input-group">
                                        ...
                                        <input type="date" name="fecha_inicio" id="fecha_inicio" class="ui-input" value="<?php echo e(old('fecha_inicio', date('Y-m-d'))); ?>" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <div class="ui-input-group">
                                        ...
                                        <input type="number" name="dia_pago" id="dia_pago" class="ui-input" value="<?php echo e(old('dia_pago', 1)); ?>" min="1" max="31">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="ui-input-group">
                                        ...
                                        <input type="number" step="0.01" name="monto_alquiler" id="monto_alquiler" class="ui-input" value="<?php echo e(old('monto_alquiler')); ?>" placeholder=" " required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="form-check">
                                    <input type="checkbox" name="deposito_pagado" id="deposito_pagado" class="form-check-input" value="1" <?php echo e(old('deposito_pagado')?'checked':''); ?>>
...
<div class="ui-sticky-bar">
    <div class="ui-sticky-bar-inner">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="<?php echo e(route('alquileres.contratos.index')); ?>" class="ui-btn ui-btn-ghost rounded-pill me-2">Cancelar</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/alquileres/contratos/create.blade.php ENDPATH**/ ?>