<?php $__env->startSection('title', 'Pantalla de Cocina — KDS'); ?>
            ...
            <div class="ui-header-left">
                ...
                <div>
                    ...
                    <div class="ui-header-meta">
                        ...
                        <span id="kds-clock"><?php echo e(now()->format('d/m/Y h:i:s A')); ?></span>
...
function cargarKds() {
    fetch('<?php echo e(route("restaurante.kds.orders")); ?>')
        .then(r => r.json())
        .then(data => {
...
function limpiarKds() {
    if (typeof Swal === 'undefined') {
        ...
        fetch('<?php echo e(route("restaurante.kds.limpiar")); ?>', {
            method: 'POST',
...
function cargarHistorial() {
    fetch('<?php echo e(route("restaurante.kds.historial")); ?>')
        .then(r => r.json())
        .then(function(data) {
            const ordenes = data.ordenes || [];
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/restaurante/kds.blade.php ENDPATH**/ ?>