...
<div class="container-fluid px-4 ui-page" style="--accent:#ef4444;--accent-rgb:239,68,68;--accent-hover:#dc2626;">
        ...
        <div class="ui-header-body w-100">
            <div class="ui-header-left">
                ...
                <div>
                    ...
                    <h2 class="ui-header-title mb-0">Crear Rol</h2>
                    <div class="ui-header-meta">Define un nuevo rol y selecciona los permisos que tendrá</div>
                </div>
            </div>
            <div class="ui-header-actions">
                <a href="<?php echo e(route($routePrefix . 'roles.index')); ?>" class="ui-btn ui-btn-primary rounded-pill px-4 fw-bold">
    ...
    <form action="<?php echo e(route($routePrefix . 'roles.store')); ?>" method="POST" id="roleForm">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('name')); ?>" placeholder=" " required maxlength="50" pattern="[a-z0-9_\-]+">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="ui-card">
                    ...
                    <div class="card-body">
                        ...
                        <small class="ui-card-subtitle">Inicia con permisos predefinidos</small>
                ...
                <div class="ui-card">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
                            <div>
                                <h5 class="ui-card-title"><i class="bi bi-key icon-purple"></i>Asignar Permisos</h5>
                                <small class="ui-card-subtitle">Marca los permisos que tendrá este rol</small>
                            </div>
                            ...
                            <div class="perm-module-card mb-3 perm-filterable" data-text="<?php echo e(strtolower($modulo)); ?>" style="--accent-color: <?php echo e($modulosColores[$modulo] ?? '#38bdf8'); ?>;">
                                <div class="module-header">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input module-check" data-module="<?php echo e($modulo); ?>" id="mod-<?php echo e($modulo); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/roles/create.blade.php ENDPATH**/ ?>