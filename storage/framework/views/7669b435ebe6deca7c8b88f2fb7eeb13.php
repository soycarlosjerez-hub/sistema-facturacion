...
<div class="container">
    ...
    <div class="content">
        ...
        <p>La suscripci&oacute;n de <strong><?php echo e($empresa); ?></strong> (plan <span class="badge"><?php echo e($planNombre); ?></span>) ha sido suspendida por falta de pago.</p>
        <div class="details">
            <p><strong>Meses atrasados:</strong> <?php echo e($mesesAtrasados); ?></p>
        ...
        <p style="text-align: center; margin: 25px 0 15px 0;">
            <a href="<?php echo e($suscripcionUrl); ?>" class="btn">Regularizar Pago</a>
        </p>
    ...
    <div class="footer">
        &copy; <?php echo e(date('Y')); ?> <?php echo e($empresa); ?>. Todos los derechos reservados.
    </div>
</div>
</body>
</html><?php /**PATH /var/www/html/sistema-facturacion/resources/views/emails/suscripcion-suspendida.blade.php ENDPATH**/ ?>