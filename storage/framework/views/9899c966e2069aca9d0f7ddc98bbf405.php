<?php $__env->startSection('title', 'Formulario 14-14 — Retenciones'); ?>
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center position-relative w-100" style="z-index:2;">
            <div>
                ...
                <p class="mb-0 text-white-50 fs-6">
                    ...
                    <?php echo e($mesNombre); ?> <?php echo e($anio); ?> &bull; Retenciones ITBIS e ISR
                </p>
            </div>
            <div class="d-flex gap-2 align-items-center flex-wrap mt-3 mt-md-0">
                <a href="<?php echo e(route('formulario.14-14.csv', ['mes' => $mes, 'anio' => $anio])); ?>"
                   class="export-btn btn btn-success text-white"
                   title="Exportar CSV">
                    <i class="bi bi-filetype-csv me-1"></i> CSV
                </a>
                <a href="<?php echo e(route('formulario.14-14.pdf', ['mes' => $mes, 'anio' => $anio])); ?>"
        ...
        <div class="p-4">
            ...
            <form method="GET" class="row g-3 align-items-end">
                    ...
                    <select name="mes" class="form-select form-select-sm" style="min-width:140px;">
                        <?php for($i = 1; $i <= 12; $i++): ?>
                            <option value="<?php echo e($i); ?>" <?php echo e($mes == $i ? 'selected' : ''); ?>>
                                <?php echo e(\Carbon\Carbon::create($anio, $i, 1)->format('F')); ?>
                ...
                <div class="col-auto">
                    ...
                    <a href="<?php echo e(route('formulario.14-14.index')); ?>" class="btn btn-outline-secondary btn-sm rounded-pill ms-1">
        ...
        <div class="col-sm-6 col-xl-3" style="animation-delay:.05s;">
            <div class="stat-card-1414 p-4 h-100" style="--card-accent: linear-gradient(135deg, #8b5cf6, #7c3aed);">
                ...
                <div class="stat-value text-purple mb-2">
                    RD$ <?php echo e(number_format($resumen['itbis_compras']['total_retenido'] ?? 0, 2)); ?>

                </div>
                <div class="stat-sub text-muted">
                    <i class="bi bi-receipt"></i>
                    <?php echo e($resumen['itbis_compras']['cantidad_compras'] ?? 0); ?> compra(s) con retención
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-xl-3" style="animation-delay:.1s;">
            <div class="stat-card-1414 p-4 h-100" style="--card-accent: linear-gradient(135deg, #ef4444, #dc2626);">
                ...
                <div class="stat-value text-danger mb-2">
                    RD$ <?php echo e(number_format($resumen['isr_compras']['total_retenido'] ?? 0, 2)); ?>

                </div>
                <div class="stat-sub text-muted">
                    <i class="bi bi-receipt"></i>
                    <?php echo e($resumen['isr_compras']['cantidad_compras'] ?? 0); ?> compra(s) con retención
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-xl-3" style="animation-delay:.15s;">
            <div class="stat-card-1414 p-4 h-100" style="--card-accent: linear-gradient(135deg, #3b82f6, #2563eb);">
                ...
                <div class="stat-value text-primary mb-2">
                    RD$ <?php echo e(number_format($resumen['itbis_ventas']['total_retenido'] ?? 0, 2)); ?>

                </div>
                <div class="stat-sub text-muted">
                    <i class="bi bi-basket"></i>
                    <?php echo e($resumen['itbis_ventas']['cantidad_ventas'] ?? 0); ?> venta(s) con retención
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-xl-3" style="animation-delay:.2s;">
            <div class="stat-card-1414 p-4 h-100" style="--card-accent: linear-gradient(135deg, #f59e0b, #d97706);">
                ...
                <div class="stat-value text-warning mb-2">
                    RD$ <?php echo e(number_format(($resumen['itbis_compras']['total_retenido'] ?? 0) + ($resumen['isr_compras']['total_retenido'] ?? 0), 2)); ?>
    ...
    <div class="table-container-1414 mb-5">
        <div class="p-4 pb-2">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <?php if($agrupado->isNotEmpty()): ?>
                        <span class="badge bg-danger rounded-pill ms-2"><?php echo e($agrupado->count()); ?></span>
                    <?php endif; ?>
                </div>
        ...
        <div class="table-responsive px-3 pb-3">
            <table id="proveedoresTable" class="table align-middle mb-0">
                ...
                <tbody>
                    <?php $__currentLoopData = $agrupado; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $prov): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="ps-4 text-muted fw-semibold"><?php echo e($idx + 1); ?></td>
                        <td><span class="provider-rnc"><?php echo e($prov['rnc']); ?></span></td>
                        <td><span class="provider-name" title="<?php echo e($prov['nombre']); ?>"><?php echo e($prov['nombre']); ?></span></td>
                        <td class="text-end"><span class="purchase-count"><?php echo e($prov['cantidad']); ?></span></td>
                        <td class="text-end amount-cell amount-itbis">RD$ <?php echo e(number_format($prov['itbis'], 2)); ?></td>
                        <td class="text-end amount-cell amount-isr">RD$ <?php echo e(number_format($prov['isr'], 2)); ?></td>
                        <td class="text-end pe-4 amount-cell amount-total">RD$ <?php echo e(number_format($prov['itbis'] + $prov['isr'], 2)); ?></td>
                    </tr>
                    ...
                    <tr class="totales-row">
                        ...
                        <td class="py-3"></td>
                        <td class="py-3"></td>
                        <td class="text-end py-3 fw-bold"><?php echo e($agrupado->sum('cantidad')); ?></td>
                        <td class="text-end py-3 amount-itbis">RD$ <?php echo e(number_format($agrupado->sum('itbis'), 2)); ?></td>
                        <td class="text-end py-3 amount-isr">RD$ <?php echo e(number_format($agrupado->sum('isr'), 2)); ?></td>
                        <td class="text-end pe-4 py-3 amount-total">RD$ <?php echo e(number_format($agrupado->sum(fn($p) => $p['itbis'] + $p['isr']), 2)); ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/formularios/14-14/index.blade.php ENDPATH**/ ?>