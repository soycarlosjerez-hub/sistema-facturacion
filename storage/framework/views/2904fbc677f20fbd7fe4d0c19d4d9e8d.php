<?php $__env->startSection('title', 'Verificación de Seguridad'); ?>
            ...
            <div class="card border-0 shadow-lg" style="border-radius: 1rem;">
                <div class="card-body p-5">
                    ...
                    <div class="alert alert-danger border-0 py-2 mb-3" role="alert">
                        ...
                        <?php echo e($errors->first('two_factor_code', 'Código incorrecto. Intente nuevamente.')); ?>

                    </div>
                    <?php endif; ?>

                    
                    <form action="<?php echo e(route('two-factor.verify')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" name="two_factor_code" class="form-control form-control-lg text-center fs-3 fw-bold letter-spacing"
                                   ...
                                   value="<?php echo e(old('two_factor_code')); ?>"
                    ...
                    <div class="text-center mt-3">
                        <form action="<?php echo e(route('two-factor.logout')); ?>" method="POST" class="d-inline">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/auth/two-factor-verify.blade.php ENDPATH**/ ?>