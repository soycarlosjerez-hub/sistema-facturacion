...
<form action="<?php echo e(route('setup.step')); ?>" method="POST" class="row g-3" id="form-tipo-equipo">
    <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/html/sistema-facturacion/resources/views/setup/_step-tipo-equipo.blade.php ENDPATH**/ ?>