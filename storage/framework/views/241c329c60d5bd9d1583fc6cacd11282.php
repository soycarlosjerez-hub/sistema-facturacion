            ...
            <div class="ui-card mb-4" style="--delay:.45s;">
                ...
                <div class="card-body px-3 px-lg-4 pb-3">
                    <div class="row g-3">
                        ...
                        <?php if($producto->garantia_terminos): ?>
                        <div class="col-12">
                            <div class="p-3 rounded-3" style="background:rgba(139,92,246,.03);border:1px solid rgba(139,92,246,.08);">
                                ...
                                <div style="white-space:pre-line;font-size:.85rem;color:#475569;line-height:1.6;"><?php echo e($producto->garantia_terminos); ?></div>
                            </div>
                        </div>
                        <?php endif; ?>
