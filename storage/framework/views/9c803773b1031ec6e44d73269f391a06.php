...
<form action="<?php echo e(route('setup.step')); ?>" method="POST" class="row g-3" id="form-lavador">
    <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/html/sistema-facturacion/resources/views/setup/_step-lavador.blade.php ENDPATH**/ ?>