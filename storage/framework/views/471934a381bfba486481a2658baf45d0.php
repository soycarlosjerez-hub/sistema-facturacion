<?php $__env->startSection('title', 'Contratos de Alquiler'); ?>
        ...
        <div class="ui-header-body">
            <div class="ui-header-left">
                ...
                <div>
                    ...
                    <small class="text-white opacity-75"><?php echo e($contratos->count()); ?> contratos registrados</small>
                </div>
            </div>
            <div>
                <a href="<?php echo e(route('alquileres.contratos.create')); ?>" class="ui-btn ui-btn-primary rounded-pill px-4 shadow-sm fw-bold" style="backdrop-filter:blur(8px);background:rgba(255,255,255,.2);border:1.5px solid rgba(255,255,255,.35);">
...
<script>
$(function() {
    const data = <?php echo json_encode($contratos, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/alquileres/contratos/index.blade.php ENDPATH**/ ?>