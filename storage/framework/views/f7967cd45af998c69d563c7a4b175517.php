...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('rnc')); ?>" placeholder="000-0000000-0" maxlength="20">
                    </div>
                    <div class="col-lg-4">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nombre')); ?>" required maxlength="255" placeholder="Nombre completo">
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('telefono')); ?>" placeholder="809-555-0100">
                    </div>
                    <div class="col-lg-4">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email')); ?>" placeholder="cliente@ejemplo.com">
                    </div>
                    <div class="col-lg-4">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('persona_contacto')); ?>" placeholder="Nombre de contacto">
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>" placeholder="Calle, número, sector..."><?php echo e(old('direccion')); ?></textarea>
                    </div>
                    <div class="col-lg-3">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('ciudad')); ?>" placeholder="Santo Domingo">
                    </div>
                    <div class="col-lg-3">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('codigo_postal')); ?>" placeholder="10101">
                    </div>
                </div>
            </div>
        </div>
...
unset($__errorArgs, $__bag); ?>">
                            <option value="consumo" <?php echo e(old('tipo_cliente') === 'consumo' ? 'selected' : ''); ?>>Consumo</option>
                            <option value="credito_fiscal" <?php echo e(old('tipo_cliente') === 'credito_fiscal' ? 'selected' : ''); ?>>Crédito Fiscal</option>
                            <option value="especial" <?php echo e(old('tipo_cliente') === 'especial' ? 'selected' : ''); ?>>Especial</option>
                            <option value="gubernamental" <?php echo e(old('tipo_cliente') === 'gubernamental' ? 'selected' : ''); ?>>Gubernamental</option>
                        </select>
                    </div>
                    <div class="col-lg-3">
...
unset($__errorArgs, $__bag); ?>">
                            <option value="micro" <?php echo e(old('segmento') === 'micro' ? 'selected' : ''); ?>>Micro</option>
                            <option value="pequeno" <?php echo e(old('segmento') === 'pequeno' ? 'selected' : ''); ?>>Pequeño</option>
                            <option value="mediano" <?php echo e(old('segmento') === 'mediano' ? 'selected' : ''); ?>>Mediano</option>
                            <option value="grande" <?php echo e(old('segmento') === 'grande' ? 'selected' : ''); ?>>Grande</option>
                        </select>
                    </div>
                    <div class="col-lg-3">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('limite_credito', 0)); ?>">
                        </div>
                    </div>
                    <div class="col-lg-3">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('dias_credito', 0)); ?>" placeholder="30">
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>" placeholder="Información adicional..."><?php echo e(old('notas')); ?></textarea>
                    </div>
                    <div class="col-lg-3 d-flex align-items-end">
                        <div class="form-check">
                            <input type="checkbox" name="activo" class="form-check-input" value="1" id="check-activo" <?php echo e(old('activo', '1') === '1' ? 'checked' : ''); ?>>
                            <label class="form-check-label" for="check-activo">Cliente activo</label>
                        </div>
                    </div>
                    <div class="col-lg-3 d-flex align-items-end">
                        <div class="form-check">
                            <input type="checkbox" name="acceso_api" class="form-check-input" value="1" id="check-api" <?php echo e(old('acceso_api') ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/clientes/create.blade.php ENDPATH**/ ?>