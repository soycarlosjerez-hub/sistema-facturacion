                ...
                <?php $__empty_1 = true; $__currentLoopData = $rankingUsuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="d-flex align-items-center gap-3 mb-3">
                        ...
                        <div style="min-width:0;flex-grow:1;">
                            <span class="fw-bold small d-block text-truncate" style="max-width:110px;"><?php echo e($user->name); ?></span>
                            <small class="text-muted"><?php echo e($user->tickets); ?> tickets</small>
                        </div>
        ...
        <div class="ui-card h-100" style="--delay:.15s">
            ...
            <div class="ui-card-body p-0">
                <div class="d-flex justify-content-between align-items-center p-4 pb-0">
                    ...
                    <a href="<?php echo e(route('ventas.index')); ?>" class="small fw-bold text-decoration-none">Ver historial</a>
                </div>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $activity['ultimasVentas']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $venta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td><span class="small text-muted"><?php echo e($venta->usuario->name ?? '—'); ?></span></td>
                                    <td class="text-end fw-bold"><?php echo e($moneda); ?> <?php echo e(number_format($venta->total, 2)); ?></td>
                                    <td>
                                        <?php
                                        ...
                                        ?>
                                        <span class="ui-badge ui-badge-<?php echo e($map[$venta->estado] ?? 'neutral'); ?>"><?php echo e($label[$venta->estado] ?? $venta->estado); ?></span>
                                    </td>
    ...
    <div class="col-xl-4">
        <div class="ui-card h-100" style="--delay:.2s">
            ...
            <div class="ui-card-body">
                ...
                <?php if($alertas['stock_critico']->count() > 0): ?>
                    <div class="d-flex align-items-center gap-2 p-3 rounded-3 mb-2" style="background:rgba(245,158,11,.08);border:1px solid rgba(245,158,11,.15);">
                        ...
                        <div class="flex-grow-1" style="min-width:0;">
                            <strong class="small"><?php echo e($alertas['stock_critico']->count()); ?> producto(s) con stock crítico</strong>
                            <div class="small text-muted text-truncate"><?php echo e($alertas['stock_critico']->pluck('nombre')->take(2)->implode(', ')); ?><?php if($alertas['stock_critico']->count() > 2): ?> y más...<?php endif; ?></div>
                        </div>
                        <a href="<?php echo e(route('productos.index', ['stock_status' => 'critical'])); ?>" class="ui-btn ui-btn-solid ui-btn-sm rounded-pill flex-shrink-0">Ver</a>
                    </div>
                <?php endif; ?>

                <?php if($kpis['facturasPendientes'] > 0): ?>
                    <div class="d-flex align-items-center gap-2 p-3 rounded-3 mb-2" style="background:rgba(239,68,68,.08);border:1px solid rgba(239,68,68,.15);">
                        ...
                        <div class="flex-grow-1">
                            <strong class="small"><?php echo e($kpis['facturasPendientes']); ?> factura(s) pendiente(s)</strong>
                            <div class="small text-muted">Cuentas abiertas o sin pagar</div>
                        </div>
                        <a href="<?php echo e(route('clientes.cuentas')); ?>" class="ui-btn ui-btn-danger ui-btn-sm rounded-pill flex-shrink-0">Cobrar</a>
                    </div>
                <?php endif; ?>

                <?php if($alertas['ncf_por_vencer']->count() > 0): ?>
                    <div class="d-flex align-items-center gap-2 p-3 rounded-3 mb-2" style="background:rgba(14,165,233,.08);border:1px solid rgba(14,165,233,.15);">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="small text-muted"><?php echo e($alertas['ncf_por_vencer']->pluck('nombre')->take(2)->implode(', ')); ?></div>
                        </div>
                        <a href="<?php echo e(route('ncf.index')); ?>" class="ui-btn ui-btn-primary ui-btn-sm rounded-pill flex-shrink-0">Revisar</a>
                    </div>
                <?php endif; ?>

                <?php if($alertas['productos_sin_rotacion'] > 0): ?>
                    <div class="d-flex align-items-center gap-2 p-3 rounded-3 mb-2" style="background:rgba(100,116,139,.08);border:1px solid rgba(100,116,139,.15);">
                        ...
                        <div class="flex-grow-1">
                            <strong class="small"><?php echo e($alertas['productos_sin_rotacion']); ?> producto(s) sin ventas este mes</strong>
                ...
                <?php if(count($alertas['sistema']) > 0): ?>
                    <div class="mt-3">
                        <small class="text-muted text-uppercase fw-bold small"><i class="bi bi-gear me-1"></i>Sistema</small>
                        <?php $__currentLoopData = $alertas['sistema']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alerta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="d-flex justify-content-between align-items-center gap-2 p-2 rounded-2 mb-1 small" style="background:rgba(0,0,0,.03);">
                                <div class="d-flex align-items-center gap-2" style="min-width:0;">
                                    <i class="bi <?php echo e($alerta['icono']); ?> flex-shrink-0"></i>
                                    <span class="text-truncate"><?php echo e($alerta['mensaje']); ?></span>
                                </div>
                                <a href="<?php echo e($alerta['link']); ?>" class="text-decoration-none fw-bold flex-shrink-0 text-nowrap"><?php echo e($alerta['link_text']); ?></a>
                            </div>
...
</div><?php /**PATH /var/www/html/sistema-facturacion/resources/views/dashboard/_activity.blade.php ENDPATH**/ ?>