<div class="ui-card" style="--delay:0s">
    ...
    <div class="ui-card-body">
        ...
        <form action="<?php echo e(route('pagos.store')); ?>" method="POST" class="row g-3">
            <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/html/sistema-facturacion/resources/views/pagos/index.blade.php ENDPATH**/ ?>