...
<div class="ui-page" style="--accent:#10b981;--accent-rgb:16,185,129;--accent-hover:#059669;">
            ...
            <div class="ui-header-left">
                ...
                <div>
                    ...
                    <div class="ui-header-meta">
                        ...
                        <span><?php echo e($mesasAll->count()); ?> mesa(s)</span>
                    </div>
                </div>
            </div>
    ...
    <?php if(session('error')): ?>
        <div class="alert alert-danger rounded-4 shadow-sm border-0 d-flex align-items-center mb-4" style="border-left:4px solid #dc3545 !important;">
            <i class="bi bi-exclamation-triangle-fill me-2"></i><div><?php echo e(session('error')); ?></div>
        </div>
    <?php endif; ?>
            ...
            <form id="filtros-form" class="row g-2 align-items-end">
                ...
                <div class="col-lg-3">
                    ...
                    <select id="filter-ubicacion" class="ui-select">
                        ...
                        <?php $__currentLoopData = $ubicaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ubi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($ubi->nombre); ?>"><?php echo e($ubi->nombre); ?></option>
                ...
                <div class="col-lg-2 d-flex gap-2 align-items-end">
                    ...
                    <a href="<?php echo e(route('restaurante.mesas.index')); ?>" class="ui-btn ui-btn-ghost" title="Limpiar filtros"><i class="bi bi-x-lg"></i></a>
                </div>
            </form>
        </div>
    </div>
...
<div class="modal fade" id="mesaModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-4 border-0 shadow">
            <form id="mesa-form" method="POST" action="<?php echo e(route('restaurante.mesa.store')); ?>">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-6">
                            ...
                            <select name="ubicacion_id" id="mesa-ubicacion" class="ui-select">
                                ...
                                <?php $__currentLoopData = $ubicaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ubi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($ubi->id); ?>"><?php echo e($ubi->nombre); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
...
function abrirModalCrear() {
    ...
    document.getElementById('mesa-form').action = '<?php echo e(route("restaurante.mesa.store")); ?>';
...
$(function() {
    const mesas = <?php echo json_encode($mesasAll, 15, 512) ?>;
                ...
                render: function(data) {
                    ...
                    if (data.estado !== 'ocupada') {
                        html += '<form action="/restaurante/mesa/' + id + '" method="POST" class="d-inline form-eliminar-mesa" data-numero="' + escapeHtml(data.numero) + '">' +
                            '<?php echo csrf_field(); ?><input type="hidden" name="_method" value="DELETE">' +
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/restaurante/mesas.blade.php ENDPATH**/ ?>