...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name')); ?>" required autofocus placeholder="Nombre completo">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email')); ?>" required placeholder="Correo electrónico" autocomplete="email">
...
unset($__errorArgs, $__bag); ?>" required placeholder="Contraseña (mín. 8 caracteres)">
                ...
                <div class="row g-0">
                    <div class="col-md-6 pe-md-2">
                        <div class="form-floating-custom">
                            ...
                            <input type="text" id="negocio_nombre" name="negocio_nombre" class="<?php $__errorArgs = ['negocio_nombre'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('negocio_nombre')); ?>" required placeholder="Nombre del negocio">
                            <?php $__errorArgs = ['negocio_nombre'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 ps-md-2">
                        <div class="form-floating-custom">
                            ...
                            <select id="business_type_id" name="business_type_id" class="<?php $__errorArgs = ['business_type_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                <option value="" disabled <?php echo e(old('business_type_id') ? '' : 'selected'); ?>>Selecciona el tipo de negocio</option>
                                <?php $__currentLoopData = $businessTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($type->id); ?>" <?php if(old('business_type_id') == $type->id): echo 'selected'; endif; ?>><?php echo e($type->nombre); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <?php $__errorArgs = ['business_type_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 pe-md-2">
                        <div class="form-floating-custom">
                            ...
                            <input type="text" id="rnc" name="rnc" class="<?php $__errorArgs = ['rnc'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('rnc')); ?>" required placeholder="RNC">
                            <?php $__errorArgs = ['rnc'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 ps-md-2">
                        <div class="form-floating-custom">
                            ...
                            <input type="text" id="telefono" name="telefono" class="<?php $__errorArgs = ['telefono'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('telefono')); ?>" required placeholder="Teléfono">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12">
                        <div class="form-floating-custom">
                            ...
                            <input type="text" id="direccion" name="direccion" class="<?php $__errorArgs = ['direccion'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('direccion')); ?>" required placeholder="Dirección">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="register-footer">
                ...
                <p>&copy; <?php echo e(date('Y')); ?> Erpipos — Todos los derechos reservados</p>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        <?php if($errors->any()): ?>
            const msgs = <?php echo json_encode($errors->first()); ?>;
...
</html><?php /**PATH /var/www/html/sistema-facturacion/resources/views/auth/register.blade.php ENDPATH**/ ?>