...
<div class="container">
    ...
    <div class="content">
        ...
        <p>Le recordamos que la suscripci&oacute;n de <strong><?php echo e($empresa); ?></strong> est&aacute; por vencer.</p>
        <div class="details">
            <p><strong>D&iacute;as restantes:</strong> <?php echo e($dias); ?></p>
            <p><strong>Fecha de vencimiento:</strong> <?php echo e($fechaVencimiento); ?></p>
            <p><strong>Saldo pendiente estimado:</strong> RD$ <?php echo e($deuda); ?></p>
        </div>
        ...
        <p style="text-align: center; margin: 25px 0 15px 0;">
            <a href="<?php echo e($suscripcionUrl); ?>" class="btn">Pagar Ahora</a>
        </p>
...
</html><?php /**PATH /var/www/html/sistema-facturacion/resources/views/emails/recordatorio-suscripcion.blade.php ENDPATH**/ ?>