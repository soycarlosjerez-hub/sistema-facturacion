<?php $__env->startSection('title', 'Configuración de Backups'); ?>
    ...
    <div class="ui-header mb-4" style="--delay:0s">
        ...
        <div class="ui-header-body">
            ...
            <div class="ui-header-actions">
                <a href="<?php echo e(route('owner.backups.index')); ?>" class="ui-btn ui-btn-ghost ui-btn-sm ui-btn-pill">
        ...
        <div class="col-md-4">
            <div class="ui-card" style="--delay:.05s">
                ...
                <div class="ui-card-body text-center p-4">
                    ...
                    <p class="text-muted small mb-0 font-monospace bg-light p-2 rounded d-inline-block"><?php echo e($backupDir); ?></p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="ui-card" style="--delay:.1s">
                ...
                <div class="ui-card-body text-center p-4">
                    ...
                    <p class="display-6 fw-bold mb-0"><?php echo e($backupCount); ?></p>
                    ...
                    <?php if($lastBackup): ?>
                        <div class="mb-3">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <span class="font-monospace small"><?php echo e($lastBackup->filename); ?></span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span class="fw-semibold">Tamaño</span>
                                <span><?php echo e($lastBackup->sizeForHumans()); ?></span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span class="fw-semibold">Tipo</span>
                                <span>
                                    <?php if($lastBackup->type === 'automatico'): ?>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <span><?php echo e($lastBackup->created_at->format('d/m/Y H:i:s')); ?></span>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="fw-semibold">Creado por</span>
                                <span><?php echo e($lastBackup->user?->name ?? 'Sistema'); ?></span>
                            </div>
                        </div>
                        <?php if($lastBackup->status === 'fallido'): ?>
                            <div class="alert alert-danger py-2 px-3 mb-0 small">
                                <i class="bi bi-x-circle me-2"></i>
                                Último estado: <?php echo e($lastBackup->notes ?: 'Error desconocido'); ?>
                ...
                <div class="ui-card-body p-4">
                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <span class="font-monospace small"><?php echo e($mysqldumpPath); ?></span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span class="fw-semibold">Estado</span>
                            <span>
                                <?php if(file_exists($mysqldumpPath) || str_contains($mysqldumpPath, 'mysqldump')): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/owner/backups/config.blade.php ENDPATH**/ ?>