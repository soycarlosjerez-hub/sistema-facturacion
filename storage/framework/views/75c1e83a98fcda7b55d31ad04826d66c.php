...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            <p class="greeting">
                Estimado/a <strong><?php echo e($reservacion->cliente_nombre); ?></strong>,
            </p>
            ...
            <div class="info-box">
                <div class="info-row">
                    ...
                    <span class="info-value"><?php echo e($reservacion->mesa->nombre ?? 'Mesa ' . $reservacion->mesa->numero); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Fecha y hora:</span>
                    <span class="info-value"><?php echo e($reservacion->fecha_hora->format('d/m/Y H:i')); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Personas:</span>
                    <span class="info-value"><?php echo e($reservacion->personas); ?></span>
                </div>
                <?php if($reservacion->notas): ?>
                <div class="info-row" style="flex-direction: column; gap: 4px;">
                    <span class="info-label">Notas:</span>
                    <span class="info-value" style="font-weight: normal;"><?php echo e($reservacion->notas); ?></span>
                </div>
                <?php endif; ?>
            </div>
...
<?php /**PATH /var/www/html/sistema-facturacion/resources/views/emails/reservacion-confirmada.blade.php ENDPATH**/ ?>