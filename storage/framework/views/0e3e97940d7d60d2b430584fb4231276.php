<!DOCTYPE html>
<html><head><meta charset="utf-8"><title>Gastos <?php echo e($desde); ?> al <?php echo e($hasta); ?></title>
...
<p class="meta">Período: <?php echo e($desde); ?> al <?php echo e($hasta); ?> &middot; <?php echo e($cantidad); ?> gasto(s)</p>
<table><thead><tr>
...
<tr>
<td><?php echo e(str_pad($g->id,4,'0',STR_PAD_LEFT)); ?></td>
<td><?php echo e($g->descripcion); ?></td>
<td><?php echo e($g->categoria ?? ''); ?></td>
<td><?php echo e($g->metodo_pago ?? ''); ?></td>
<td><?php echo e($g->comprobante ?? ''); ?></td>
<td><?php echo e($g->fecha_gasto?->format('d/m/Y') ?? ''); ?></td>
<td class="text-end">RD$ <?php echo e(number_format($g->monto, 2)); ?></td>
</tr>
...
<td class="text-end">RD$ <?php echo e(number_format($totalGeneral, 2)); ?></td>
</tr>
</tfoot></table>
<p style="color:#999;font-size:7px;margin-top:20px;">Generado: <?php echo e(now()->format('d/m/Y H:i')); ?></p>
</body></html>
<?php /**PATH /var/www/html/sistema-facturacion/resources/views/reportes/gastos-pdf.blade.php ENDPATH**/ ?>