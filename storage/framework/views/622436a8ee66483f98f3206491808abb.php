<?php $__env->startSection('title', 'Prueba de Correos de Error'); ?>
    ...
    <div class="ui-header mb-4" style="--delay:.1s">
        ...
        <div class="ui-header-body">
            ...
            <div class="ui-header-actions">
                <a href="<?php echo e(route('owner.smtp-settings')); ?>" class="ui-btn ui-btn-ghost ui-btn-sm rounded-pill">
            ...
            <div class="stat-status-card">
                ...
                <div class="stat-body">
                    <?php if($smtpOk): ?>
                        ...
                        <small class="text-muted"><?php echo e($settings['mail_host']); ?>:<?php echo e($settings['mail_port']); ?></small>
                    <?php else: ?>
            ...
            <div class="stat-status-card">
                ...
                <div class="stat-body">
                    <?php if($alertOk): ?>
                        ...
                        <small class="text-muted"><?php echo e($settings['error_alert_email']); ?></small>
                    <?php else: ?>
            ...
            <div class="ui-card" style="--delay:.2s">
                ...
                <div class="ui-card-body">
                    ...
                    <div class="test-section section-indigo">
                        ...
                        <form method="POST" action="<?php echo e(route('owner.error-test.smtp')); ?>" class="row g-2">
                            <?php echo csrf_field(); ?>
                            <div class="col-md-8">
                                <input type="email" name="test_email" class="ui-input"
                                       value="<?php echo e(old('test_email', $settings['error_alert_email'])); ?>"
                    ...
                    <div class="test-section section-red">
                        ...
                        <div class="d-flex gap-2 flex-wrap">
                            <form method="POST" action="<?php echo e(route('owner.error-test.simulate')); ?>" class="d-inline">
                                <?php echo csrf_field(); ?>
                    ...
                    <div class="test-section section-amber">
                        ...
                        <form method="POST" action="<?php echo e(route('owner.error-test.log')); ?>">
                            <?php echo csrf_field(); ?>
                    ...
                    <div class="test-section section-green">
                        ...
                        <form method="POST" action="<?php echo e(route('owner.error-test.db-trigger')); ?>" class="row g-2">
                            <?php echo csrf_field(); ?>
                            <div class="col-md-8">
                                <input type="email" name="email" class="ui-input"
                                       value="<?php echo e(old('email', $settings['error_alert_email'])); ?>"
                ...
                <div class="ui-card-body p-0">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover ui-table mb-0">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $recentErrors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><span class="log-level <?php echo e($log->level); ?>"><?php echo e($log->level); ?></span></td>
                                    <td class="text-truncate" style="max-width:200px" title="<?php echo e($log->title); ?>"><?php echo e($log->title); ?></td>
                                    <td class="text-nowrap"><small><?php echo e(\Carbon\Carbon::parse($log->created_at)->diffForHumans()); ?></small></td>
                                </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/owner/error-test.blade.php ENDPATH**/ ?>