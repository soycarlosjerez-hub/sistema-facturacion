        ...
        <div class="col-6 col-md-3">
            <div class="ui-card h-100" style="--delay:.1s">
                <div class="ui-card-body">
                    ...
                    <div class="ui-stat-value"><?php echo e($totalHoy); ?></div>
                    <small class="text-muted"><?php echo e($pendientes); ?> pendientes</small>
                </div>
            </div>
        </div>
        <div class="col-6 col-md-3">
            <div class="ui-card h-100" style="--delay:.15s">
                <div class="ui-card-body">
                    ...
                    <div class="ui-stat-value"><?php echo e($enCamino); ?></div>
        ...
        <div class="col-6 col-md-3">
            <div class="ui-card h-100" style="--delay:.2s">
                <div class="ui-card-body">
                    ...
                    <div class="ui-stat-value"><?php echo e($entregadas); ?></div>
        ...
        <div class="col-6 col-md-3">
            <div class="ui-card h-100" style="--delay:.25s">
                <div class="ui-card-body">
                    ...
                    <div class="ui-stat-value"><?php echo e($fallidas); ?></div>
            ...
            <div class="ui-card h-100" style="--delay:.3s">
                <div class="ui-card-body">
                    ...
                    <div class="text-center py-3">
                        <div class="display-4 fw-bold text-primary"><?php echo e($totalDriversActivos); ?></div>
        ...
        <div class="col-lg-4">
            <div class="ui-card h-100" style="--delay:.35s">
                <div class="ui-card-body">
                    ...
                    <div class="text-center py-3">
                        <div class="display-4 fw-bold" style="color:#16a34a;">RD$<?php echo e(number_format($gananciasMes, 2)); ?></div>
        ...
        <div class="col-lg-4">
            <div class="ui-card h-100" style="--delay:.4s">
                <div class="ui-card-body">
                    ...
                    <?php $topDriver = $topDrivers->first(); ?>
                    <?php if($topDriver && $topDriver->driver): ?>
                        <div class="text-center py-3">
                            <div class="driver-avatar mx-auto mb-2" style="width:56px;height:56px;font-size:1.1rem;background:rgba(245,158,11,.1);color:#f59e0b;">
                                <?php echo e(strtoupper(substr($topDriver->driver->nombre, 0, 1) . substr($topDriver->driver->apellido, 0, 1))); ?>

                            </div>
                            <h5 class="fw-bold mb-1"><?php echo e($topDriver->driver->nombre); ?> <?php echo e($topDriver->driver->apellido); ?></h5>
                            <small class="text-muted">Repartidor del mes</small>
                            <div class="mt-2">
                                <span class="ui-badge ui-badge-warning">
                                    <i class="bi bi-trophy me-1"></i><?php echo e($topDriver->total); ?> entregas
                                </span>
                            </div>
                        </div>
                    <?php else: ?>
        ...
        <div class="col-lg-4">
            <div class="ui-card" style="--delay:.5s">
                <div class="ui-card-body">
                    ...
                    <?php if($topDrivers->count()): ?>
                        <ol class="list-group list-group-numbered">
                            <?php $__currentLoopData = $topDrivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="list-group-item d-flex justify-content-between align-items-start">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="badge rounded-pill" style="background:rgba(14,165,233,.1);color:#0ea5e9;width:28px;text-align:center;"><?php echo e($idx + 1); ?></span>
                                    <div>
                                        <strong><?php echo e($driver->driver->nombre ?? ''); ?> <?php echo e($driver->driver->apellido ?? ''); ?></strong>
                                        <br><small class="text-muted">Entregas del mes</small>
                                    </div>
                                </div>
                                <span class="badge rounded-pill" style="background:rgba(34,197,94,.1);color:#16a34a;"><?php echo e($driver->total); ?></span>
                            </li>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/dashboard/delivery.blade.php ENDPATH**/ ?>