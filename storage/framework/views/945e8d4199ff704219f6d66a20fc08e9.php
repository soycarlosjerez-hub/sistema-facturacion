<?php $__env->startSection('title', 'Nueva No Conformidad'); ?>
...
<div class="ui-page">
    ...
    <div class="ui-card" style="--delay:.1s">
        ...
        <div class="ui-card-body">
            <form action="<?php echo e(route('sgc.no-conformidades.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date" name="fecha_ocurrencia" class="form-control form-control-custom" value="<?php echo e(old('fecha_ocurrencia')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date" name="fecha_identificacion" class="form-control form-control-custom" value="<?php echo e(old('fecha_identificacion')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="gravedad" class="form-select form-select-custom" required>
                            ...
                            <option value="<?php echo e($key); ?>" <?php echo e(old('gravedad') == $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="auditoria_id" class="form-select form-select-custom">
                            ...
                            <option value="<?php echo e($aud->id); ?>" <?php echo e(old('auditoria_id') == $aud->id ? 'selected' : ''); ?>><?php echo e($aud->codigo); ?> - <?php echo e($aud->area_auditar); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <?php $__errorArgs = ['auditoria_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="text-danger small mt-1"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="evidencia" class="form-control form-control-custom" rows="2"><?php echo e(old('evidencia')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="analisis_causa_metodo" class="form-select form-select-custom">
                            <option value="">Seleccionar...</option>
                            <option value="5_for_why" <?php echo e(old('analisis_causa_metodo') == '5_for_why' ? 'selected' : ''); ?>>5 Por Qué</option>
                            <option value="ishikawa" <?php echo e(old('analisis_causa_metodo') == 'ishikawa' ? 'selected' : ''); ?>>Ishikawa (Espina de Pescado)</option>
                            <option value="8d" <?php echo e(old('analisis_causa_metodo') == '8d' ? 'selected' : ''); ?>>8D</option>
                            <option value="otro" <?php echo e(old('analisis_causa_metodo') == 'otro' ? 'selected' : ''); ?>>Otro</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="accion_contencion" class="form-control form-control-custom" value="<?php echo e(old('accion_contencion')); ?>" placeholder="Acción inmediata tomada">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="analisis_causa_detalle" class="form-control form-control-custom" rows="3" placeholder="Describe el análisis de causa realizado..."><?php echo e(old('analisis_causa_detalle')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="d-flex gap-2 mt-4 pt-3 border-top">
                    ...
                    <a href="<?php echo e(route('sgc.no-conformidades.index')); ?>" class="ui-btn ui-btn-ghost ui-btn-sm rounded-pill px-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/sgc/no_conformidades/create.blade.php ENDPATH**/ ?>