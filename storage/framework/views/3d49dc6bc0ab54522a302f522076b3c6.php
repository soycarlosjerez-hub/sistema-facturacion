<?php $__env->startSection('title', 'Detalle Solicitud'); ?>
    ...
    <div class="ui-header mb-4" style="--delay:.1s">
        ...
        <div class="ui-header-body">
            ...
            <div class="ui-header-actions">
                <a href="<?php echo e(route('owner.solicitudes.index')); ?>" class="ui-btn ui-btn-ghost">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <div class="fw-bold"><?php echo e($instance->nombre); ?></div>
                        </div>
                        <div class="col-md-6">
                            <label class="text-muted small fw-semibold d-block">Tipo de Negocio</label>
                            <div>
                                <?php if($instance->businessType): ?>
                                    <span class="badge bg-<?php echo e($instance->businessType->color ?? 'secondary'); ?> bg-opacity-10 text-<?php echo e($instance->businessType->color ?? 'secondary'); ?> rounded-pill px-3 py-2"><?php echo e($instance->businessType->nombre); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="text-muted small fw-semibold d-block">RNC</label>
                            <div class="fw-bold"><?php echo e($instance->rnc); ?></div>
                        </div>
                        <div class="col-md-6">
                            <label class="text-muted small fw-semibold d-block">Teléfono</label>
                            <div class="fw-bold"><?php echo e($instance->telefono); ?></div>
                        </div>
                        <div class="col-md-12">
                            <label class="text-muted small fw-semibold d-block">Dirección</label>
                            <div class="fw-bold"><?php echo e($instance->direccion); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <div class="fw-bold"><?php echo e($instance->owner_nombre ?? '—'); ?></div>
                        </div>
                        <div class="col-md-6">
                            <label class="text-muted small fw-semibold d-block">Email</label>
                            <div class="fw-bold"><?php echo e($instance->owner_email ?? '—'); ?></div>
                        </div>
                        <div class="col-md-6">
                            <label class="text-muted small fw-semibold d-block">Registrado</label>
                            <div class="fw-bold"><?php echo e($instance->created_at->format('d/m/Y H:i')); ?> hrs</div>
                        </div>
                        <div class="col-md-6">
                            <label class="text-muted small fw-semibold d-block">Última Actualización</label>
                            <div class="fw-bold"><?php echo e($instance->updated_at->format('d/m/Y H:i')); ?> hrs</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="ui-card" style="--delay:.25s">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-3">
                        <a href="<?php echo e(route('owner.instances.show', $instance->id)); ?>" class="ui-btn ui-btn-ghost w-100 mb-2">
                            <i class="bi bi-eye me-2"></i>Ver Instancia Completa
                        </a>
                        <a href="<?php echo e(route('owner.instances.config', $instance->id)); ?>" class="ui-btn ui-btn-ghost w-100 mb-2">
                    ...
                    <form action="<?php echo e(route('owner.solicitudes.aprobar', $instance->id)); ?>" method="POST" onsubmit="return confirm('¿Aprobar la solicitud de <?php echo e($instance->nombre); ?>?')">
                        <?php echo csrf_field(); ?>
                    ...
                    <form action="<?php echo e(route('owner.solicitudes.rechazar', $instance->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/owner/solicitudes/show.blade.php ENDPATH**/ ?>