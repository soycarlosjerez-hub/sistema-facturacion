...
<div class="ui-page" style="--accent:#f59e0b;--accent-rgb:245,158,11;--accent-hover:#d97706;">
    ...
    <div class="ui-header mb-4" style="--delay:0s">
        ...
        <div class="ui-header-body">
            ...
            <div class="ui-header-actions">
                <a href="<?php echo e(route('ordenes.index')); ?>" class="ui-btn ui-btn-primary ui-btn-sm rounded-pill">
    ...
    <div class="row g-4">
        <div class="col-md-5">
            <div class="ui-card h-100" style="--delay:.1s">
                ...
                <div class="card-body">
                    <form id="ordenForm" action="<?php echo e(route('ordenes.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div id="delivery_fields" style="display:none;">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="entrega_empresa_id" class="ui-select">
                                    ...
                                    <?php $__currentLoopData = \App\Models\DeliveryCompany::where('activo', true)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="cliente_id" class="ui-select" id="cliente_select">
                                ...
                                <?php $__currentLoopData = \App\Models\Cliente::orderBy('nombre')->limit(50)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="ui-sticky-bar">
        <div class="ui-sticky-bar-inner">
            ...
            <a href="<?php echo e(route('ordenes.index')); ?>" class="ui-btn ui-btn-ghost rounded-pill px-4">Cancelar</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/ordenes/create.blade.php ENDPATH**/ ?>