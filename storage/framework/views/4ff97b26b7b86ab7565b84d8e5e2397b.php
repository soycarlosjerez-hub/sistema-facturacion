<?php $__env->startSection('title', 'Dashboard Delivery'); ?>
            ...
            <div class="ui-header-left">
                ...
                <div>
                    ...
                    <div class="ui-header-meta">
                        ...
                        <span><?php echo e(now()->format('d/m/Y')); ?> — Resumen operativo</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-6 col-lg-3">
            <div class="ui-stat stat-main" style="--delay:.1s">
                <div class="ui-stat-body">
                    ...
                    <div class="ui-stat-value"><?php echo e($stats['hoy']); ?></div>
                    <div class="ui-stat-sub">
                        <i class="bi bi-arrow-up me-1"></i>vs ayer: <?php echo e($stats['variacion_hoy']); ?>
        ...
        <div class="col-6 col-lg-3">
            <div class="ui-stat stat-main" style="--delay:.15s">
                <div class="ui-stat-body">
                    ...
                    <div class="ui-stat-value" style="color:#d97706;"><?php echo e($stats['pendientes']); ?></div>
        ...
        <div class="col-6 col-lg-3">
            <div class="ui-stat stat-main" style="--delay:.2s">
                <div class="ui-stat-body">
                    ...
                    <div class="ui-stat-value" style="color:#0ea5e9;"><?php echo e($stats['en_camino']); ?></div>
        ...
        <div class="col-6 col-lg-3">
            <div class="ui-stat stat-main" style="--delay:.25s">
                <div class="ui-stat-body">
                    ...
                    <div class="ui-stat-value" style="color:#16a34a;"><?php echo e($stats['entregadas']); ?></div>
        ...
        <div class="col-6 col-lg-3">
            <div class="ui-stat stat-secondary" style="--delay:.3s">
                <div class="ui-stat-body">
                    ...
                    <div class="ui-stat-value"><?php echo e($stats['drivers_activos']); ?></div>
                    <div class="ui-stat-sub">de <?php echo e($stats['total_drivers']); ?> registrados</div>
                </div>
            </div>
        </div>
        <div class="col-6 col-lg-3">
            <div class="ui-stat stat-secondary" style="--delay:.35s">
                <div class="ui-stat-body">
                    ...
                    <div class="ui-stat-value" style="color:#16a34a;">$<?php echo e(number_format($stats['ganancias_mes'], 2)); ?></div>
        ...
        <div class="col-6 col-lg-3">
            <div class="ui-stat stat-secondary" style="--delay:.4s">
                <div class="ui-stat-body">
                    ...
                    <div class="ui-stat-value" style="color:#dc2626;"><?php echo e($stats['fallidas']); ?></div>
                    <div class="ui-stat-sub">
                        <?php echo e($stats['tasa_exito'] ?? 0); ?>% tasa éxito
                    </div>
                </div>
            </div>
        </div>
        <div class="col-6 col-lg-3">
            <div class="ui-stat stat-secondary" style="--delay:.45s">
                <div class="ui-stat-body">
                    ...
                    <div class="ui-stat-value" style="font-size:1.3rem;"><?php echo e($stats['tiempo_promedio'] ?? '—'); ?></div>
            ...
            <div class="ui-card" style="--delay:.5s">
                ...
                <div class="ui-card-body">
                    ...
                    <div class="chart-bar-container">
                        <?php $__currentLoopData = $weekly_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="chart-bar-wrapper">
                            <div class="chart-bar-value"><?php echo e($day['count']); ?></div>
                            <div class="chart-bar" style="height: <?php echo e($day['percentage']); ?>%;" title="<?php echo e($day['label']); ?>: <?php echo e($day['count']); ?> entregas"></div>
                            <div class="chart-bar-label"><?php echo e($day['short_label']); ?></div>
                        </div>
                ...
                <div class="ui-card-body">
                    ...
                    <div class="table-responsive">
                        <table class="ui-table mb-0">
                            ...
                            <tbody>
                                <?php $__empty_0 = true; $__currentLoopData = $top_drivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
                                <tr>
                                    <td>
                                        <span class="ranking-number <?php echo e($index === 0 ? 'gold' : ($index === 1 ? 'silver' : ($index === 2 ? 'bronze' : 'normal'))); ?>">
                                            <?php echo e($index + 1); ?>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <span class="fw-semibold small"><?php echo e($driver->nombre); ?> <?php echo e($driver->apellido); ?></span>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <span class="ui-badge ui-badge-info"><?php echo e($driver->entregas); ?></span>
                                    </td>
                                    <td class="text-end fw-bold small">$<?php echo e(number_format($driver->ganancia, 2)); ?></td>
                                </tr>
    ...
    <div class="ui-card" style="--delay:.6s">
        ...
        <div class="ui-card-body p-0">
            <div class="p-3 border-bottom d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('delivery-tracking.index')); ?>" class="ui-btn ui-btn-link ui-btn-sm">
            ...
            <div class="table-responsive">
                <table class="ui-table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        <?php $__empty_0 = true; $__currentLoopData = $recent_deliveries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $delivery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
                        <tr>
                            <td class="ps-4 fw-semibold">
                                <a href="<?php echo e(route('delivery-tracking.show', $delivery)); ?>" class="text-decoration-none" style="color:#0ea5e9;">
                                    #<?php echo e($delivery->orden_id); ?>

                                </a>
                            </td>
                            <td><?php echo e($delivery->orden?->cliente?->nombre ?? 'N/A'); ?></td>
                            <td>
                                <?php if($delivery->driver): ?>
                                    <small><?php echo e($delivery->driver->nombre); ?> <?php echo e($delivery->driver->apellido); ?></small>
                                <?php else: ?>
                            ...
                            <td>
                                ...
                                ?>
                                <span class="ui-badge ui-badge-<?php echo e($sc['badge']); ?>">
                                    <i class="bi <?php echo e($sc['icon']); ?> me-1"></i><?php echo e($sc['label']); ?>

                                </span>
                            </td>
                            <td><small class="text-muted"><?php echo e($delivery->created_at->format('H:i')); ?></small></td>
                            <td class="text-end pe-4">
                                <a href="<?php echo e(route('delivery-tracking.show', $delivery)); ?>" class="ui-action ui-action-view" title="Ver">
                                    <i class="bi bi-eye"></i>
                                </a>
                            </td>
                        </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/dashboard-delivery/index.blade.php ENDPATH**/ ?>