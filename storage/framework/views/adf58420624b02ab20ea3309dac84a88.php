<?php $__env->startSection('title', 'Editar Compra ' . $compra->folio); ?>
...
<div class="ui-page" style="--accent:#f59e0b;--accent-rgb:245,158,11;--accent-hover:#d97706;">
        ...
        <div class="ui-header-body">
            <div class="ui-header-left">
                ...
                <div>
                    ...
                    <div class="ui-header-meta">Compra <strong><?php echo e($compra->folio); ?></strong> · <?php echo e($compra->proveedor->nombre ?? '—'); ?></div>
                </div>
            </div>
    ...
    <form action="<?php echo e(route('compras.update', $compra)); ?>" method="POST" id="compraForm">
        <?php echo csrf_field(); ?>
                ...
                <div class="row g-3">
                    <div class="col-md-3">
                        ...
                        <select name="proveedor_id" class="ui-select ui-select-lg" required>
                            ...
                            <?php $__currentLoopData = $proveedores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proveedor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($proveedor->id); ?>" <?php echo e($compra->proveedor_id == $proveedor->id ? 'selected' : ''); ?>><?php echo e($proveedor->nombre); ?></option>
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="tipo_compra_id" class="ui-select ui-select-lg" required>
                            ...
                            <?php $__currentLoopData = $tiposCompra; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($tipo->id); ?>" <?php echo e($compra->tipo_compra_id == $tipo->id ? 'selected' : ''); ?>><?php echo e($tipo->nombre); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="col-md-3">
                        ...
                        <select name="almacen_id" class="ui-select ui-select-lg">
                            <option value="" <?php echo e(empty($compra->almacen_id) ? 'selected' : ''); ?>>Trabajar sin almacén</option>
                            <?php $__currentLoopData = $almacenes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $almacen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($almacen->id); ?>" <?php echo e(($compra->almacen_id ?? old('almacen_id')) == $almacen->id ? 'selected' : ''); ?>><?php echo e($almacen->nombre); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="col-md-3">
                        <label class="ui-label small fw-semibold">Fecha</label>
                        <input type="date" name="fecha" class="ui-input ui-input-lg" value="<?php echo e(old('fecha', $compra->fecha ? $compra->fecha->format('Y-m-d') : date('Y-m-d'))); ?>">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="ui-card mb-4">
            <div class="d-flex justify-content-between align-items-center p-4 pb-0">
                <div>
                    ...
                    <?php if($facturacion_modo === 'equipos'): ?>
                ...
                <button type="button" class="ui-btn ui-btn-solid rounded-pill px-3 btn-sm" id="btnAgregarFila" style="background:var(--accent);border-color:var(--accent);">
                    <i class="bi bi-plus-lg me-1"></i> <?php if($facturacion_modo === 'equipos'): ?> Agregar equipo <?php else: ?> Agregar fila <?php endif; ?>
                </button>
            </div>
                ...
                <table class="table table-hover align-middle mb-0" id="detalleCompra">
                    ...
                    <tbody id="detalle-body">
                        <?php $__currentLoopData = $detalles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detalle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $isEquipo = (bool) $detalle->equipo_id; ?>
                            <tr data-detalle-id="<?php echo e($detalle->id); ?>">
                                <?php if($facturacion_modo === 'equipos' && $isEquipo): ?>
                                    
                                    <td>
                                        <input type="text" name="productos[<?php echo e($loop->index); ?>][nombre]" class="ui-input nombre" list="productList" value="<?php echo e($detalle->producto->nombre ?? ''); ?>">
                                        <input type="hidden" name="productos[<?php echo e($loop->index); ?>][producto_id]" class="producto-id" value="<?php echo e($detalle->producto_id); ?>">
                                    </td>
                                    <td>
                                        <input type="text" name="productos[<?php echo e($loop->index); ?>][serial_imei]" class="ui-input serial-imei" value="<?php echo e($detalle->equipo->serial_imei ?? ''); ?>" required>
                                    </td>
                                    <td>
                                        <input type="text" name="productos[<?php echo e($loop->index); ?>][marca]" class="ui-input marca" value="<?php echo e($detalle->equipo->marca ?? ''); ?>">
                                    </td>
                                    <td>
                                        <input type="text" name="productos[<?php echo e($loop->index); ?>][modelo]" class="ui-input modelo" value="<?php echo e($detalle->equipo->modelo ?? ''); ?>">
                                    </td>
                                    <td>
                                        <input type="text" name="productos[<?php echo e($loop->index); ?>][almacenamiento_gb]" class="ui-input almacenamiento" value="<?php echo e($detalle->equipo->almacenamiento_gb ?? ''); ?>">
                                    </td>
                                    <td>
                                        <input type="text" name="productos[<?php echo e($loop->index); ?>][color]" class="ui-input color" value="<?php echo e($detalle->equipo->color ?? ''); ?>">
                                    </td>
                                    <td><input type="number" min="0" step="0.01" name="productos[<?php echo e($loop->index); ?>][precio]" class="ui-input precio" value="<?php echo e($detalle->precio_unitario); ?>" required></td>
                                    <td><input type="number" min="0" step="0.01" name="productos[<?php echo e($loop->index); ?>][precio_venta]" class="ui-input precio-venta" value="<?php echo e($detalle->equipo->precio_venta ?? ''); ?>"></td>
                                    <td><input type="number" min="0" max="100" step="0.01" name="productos[<?php echo e($loop->index); ?>][itbis_porcentaje]" class="ui-input itbis" value="<?php echo e($detalle->itbis_porcentaje ?? $systemItbis ?? 18); ?>" required></td>
                                    <td class="subtotal fw-bold text-end">RD$ <?php echo e(number_format($detalle->subtotal, 2)); ?></td>
                                    <td class="text-center">
                                        <button type="button" class="btn btn-sm btn-outline-danger rounded-pill btnEliminarFila" title="Quitar de la compra">
                                            <i class="bi bi-trash"></i>
                                        </button>
                                    </td>
                                <?php elseif($facturacion_modo === 'equipos' && !$isEquipo): ?>
                                    
                                    <td>
                                        <input type="text" name="productos[<?php echo e($loop->index); ?>][nombre]" class="ui-input nombre" list="productList" value="<?php echo e($detalle->producto->nombre ?? ''); ?>" required>
                                        <input type="hidden" name="productos[<?php echo e($loop->index); ?>][producto_id]" class="producto-id" value="<?php echo e($detalle->producto_id); ?>">
                                    </td>
                                    <td colspan="9">
                                ...
                                <?php else: ?>
                                    ...
                                    <td>
                                        <input type="text" name="productos[<?php echo e($loop->index); ?>][codigo_barras]" class="ui-input codigo-barras" value="<?php echo e($detalle->producto->codigo_barras ?? ''); ?>" placeholder="Escanear o escribir" autocomplete="off">
                                    </td>
                                    <td><input type="number" min="0.01" step="0.01" name="productos[<?php echo e($loop->index); ?>][cantidad]" class="ui-input cantidad" value="<?php echo e($detalle->cantidad); ?>" required></td>
                                    <td><input type="number" min="0" step="0.01" name="productos[<?php echo e($loop->index); ?>][precio]" class="ui-input precio" value="<?php echo e($detalle->precio_unitario); ?>" required></td>
                                    <td><input type="number" min="0" step="0.01" name="productos[<?php echo e($loop->index); ?>][precio_venta]" class="ui-input precio-venta" value="<?php echo e($detalle->producto->precio ?? ''); ?>"></td>
                                    <td><input type="number" min="0" max="100" step="0.01" name="productos[<?php echo e($loop->index); ?>][itbis_porcentaje]" class="ui-input itbis" value="<?php echo e($detalle->itbis_porcentaje ?? $systemItbis ?? 18); ?>" required></td>
                                    <td class="subtotal fw-bold text-end">RD$ <?php echo e(number_format($detalle->subtotal, 2)); ?></td>
                                    <td class="text-center">
                                        <button type="button" class="btn btn-sm btn-outline-danger rounded-pill btnEliminarFila" title="Quitar de la compra">
                    ...
                    <tfoot class="bg-light bg-opacity-50">
                        <tr>
                            <td colspan="<?php echo e($facturacion_modo === 'equipos' ? '8' : '6'); ?>" class="text-end fw-bold">Subtotal:</td>
                            <td class="fw-bold text-end" id="subtotal-display">RD$ <?php echo e(number_format($compra->subtotal ?? 0, 2)); ?></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td colspan="<?php echo e($facturacion_modo === 'equipos' ? '8' : '6'); ?>" class="text-end fw-bold">ITBIS:</td>
                            <td class="fw-bold text-end" id="itbis-display">RD$ <?php echo e(number_format($compra->itbis_total ?? 0, 2)); ?></td>
                            <td></td>
                        </tr>
                        <tr>
                            <td colspan="<?php echo e($facturacion_modo === 'equipos' ? '8' : '6'); ?>" class="text-end fw-bold fs-5">TOTAL:</td>
                            <td class="fw-bold text-end fs-5 text-primary" id="total-display">RD$ <?php echo e(number_format($compra->total, 2)); ?></td>
                            <td></td>
                        </tr>
                        <tr class="retenciones-row" style="display:none">
                            <td colspan="<?php echo e($facturacion_modo === 'equipos' ? '8' : '6'); ?>" class="text-end text-danger fw-bold">Retenciones:</td>
                            <td class="text-end fw-bold" id="retenciones-display">RD$ 0.00</td>
                            <td></td>
                        </tr>
                        <tr class="total-neto-row" style="display:none">
                            <td colspan="<?php echo e($facturacion_modo === 'equipos' ? '8' : '6'); ?>" class="text-end fw-bold fs-5">Total a Pagar:</td>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="aplica_retencion_isr" name="aplica_retencion_isr" value="1" <?php echo e($compra->aplica_retencion_isr ? 'checked' : ''); ?>>
                    ...
                    <div class="col-md-6">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="aplica_retencion_itbis" name="aplica_retencion_itbis" value="1" <?php echo e($compra->aplica_retencion_itbis ? 'checked' : ''); ?>>
        ...
        <div class="ui-card mb-4">
            <div class="card-body p-4">
                ...
                <textarea name="observaciones" class="ui-textarea" rows="2" placeholder="Notas sobre la compra (opcional)"><?php echo e(old('observaciones', $compra->observaciones)); ?></textarea>
            </div>
        </div>

        <input type="hidden" name="total" id="total-hidden" value="<?php echo e($compra->total); ?>">
    </form>
</div>

<div class="ui-sticky-bar">
    <div class="ui-sticky-bar-inner">
        <a href="<?php echo e(route('compras.index')); ?>" class="ui-btn ui-btn-ghost rounded-pill">Cancelar</a>
...
<datalist id="productList">
    <?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e($producto->nombre); ?>" data-id="<?php echo e($producto->id); ?>" data-precio="<?php echo e($producto->precio_compra); ?>" data-precio-venta="<?php echo e($producto->precio); ?>" data-barcode="<?php echo e($producto->codigo_barras); ?>" data-marca="<?php echo e($producto->marca ?? ''); ?>" data-modelo="<?php echo e($producto->modelo ?? ''); ?>"></option>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</datalist>
...
<template id="fila-template-productos">
    <tr>
        ...
        <td><input type="number" min="0" max="100" step="0.01" class="ui-input itbis" value="<?php echo e($systemItbis ?? 18); ?>" required></td>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const facturacionModo = '<?php echo e($facturacion_modo); ?>';
    const systemItbis = <?php echo e($systemItbis ?? 18); ?>;
    const compraId = <?php echo e($compra->id); ?>;
    ...
    function attachEventsProductos(row) {
        ...
        row.querySelector('.btnEliminarFila').addEventListener('click', () => {
            if (tbody.children.length === 1) {
                ...
                document.getElementById('compraForm').action = "<?php echo e(route('compras.destroy', $compra)); ?>";
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/compras/edit.blade.php ENDPATH**/ ?>