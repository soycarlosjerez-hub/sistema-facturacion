...
<div class="ui-page" style="--accent:#38bdf8;--accent-rgb:56,189,248;--accent-hover:#0ea5e9;">
    ...
    <div class="ui-header mb-4">
        ...
        <div class="ui-header-body">
            <div class="ui-header-left">
                ...
                <div>
                    <div class="ui-header-title">Nuevo Equipo</div>
                    <div class="ui-header-meta">
                        <i class="bi bi-plus-circle me-1"></i>
                        Registra un nuevo dispositivo tecnológico
                    </div>
                </div>
            </div>
    ...
    <div class="ui-card" style="--delay:.1s">
        ...
        <form id="equipoForm" action="<?php echo e(route('equipos.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="serial_imei" value="<?php echo e(old('serial_imei')); ?>" class="ui-input <?php $__errorArgs = ['serial_imei'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="serial_esn" value="<?php echo e(old('serial_esn')); ?>" class="ui-input <?php $__errorArgs = ['serial_esn'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="marca" value="<?php echo e(old('marca')); ?>" class="ui-input <?php $__errorArgs = ['marca'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="modelo" value="<?php echo e(old('modelo')); ?>" class="ui-input <?php $__errorArgs = ['modelo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="text" name="color" value="<?php echo e(old('color')); ?>" class="ui-input <?php $__errorArgs = ['color'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="number" name="almacenamiento_gb" value="<?php echo e(old('almacenamiento_gb')); ?>" class="ui-input <?php $__errorArgs = ['almacenamiento_gb'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                ...
                <div class="row g-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="tipo_dispositivo" class="ui-select">
                                ...
                                <?php $__currentLoopData = ['celular','laptop','desktop','tablet','servidor','impresora','monitor','router','switch','camara','ups','otro']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($opt); ?>" <?php echo e(old('tipo_dispositivo') == $opt ? 'selected' : ''); ?>><?php echo e(ucfirst($opt)); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="procesador" value="<?php echo e(old('procesador')); ?>" class="ui-input" placeholder="Ej. M3 Pro, i7-13700K">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="ui-label small fw-semibold">Memoria RAM</label>
                            <input type="text" name="memoria_ram" value="<?php echo e(old('memoria_ram')); ?>" class="ui-input" placeholder="Ej. 16GB, 32GB">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select name="almacenamiento_tipo" class="ui-select">
                                ...
                                <?php $__currentLoopData = ['HDD','SSD','NVMe','hybrid']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($opt); ?>" <?php echo e(old('almacenamiento_tipo') == $opt ? 'selected' : ''); ?>><?php echo e($opt); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="almacenamiento_capacidad" value="<?php echo e(old('almacenamiento_capacidad')); ?>" class="ui-input" placeholder="Ej. 512GB, 1TB">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="ui-label small fw-semibold">Sistema Operativo</label>
                            <input type="text" name="sistema_operativo" value="<?php echo e(old('sistema_operativo')); ?>" class="ui-input" placeholder="Ej. iOS 17, Windows 11">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="ui-label small fw-semibold">Puertos</label>
                            <textarea name="puertos" class="ui-input" rows="2" placeholder="Ej. USB-C, HDMI, 3.5mm audio..."><?php echo e(old('puertos')); ?></textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="ui-label small fw-semibold">Peso (gramos)</label>
                            <input type="number" name="peso_gramos" value="<?php echo e(old('peso_gramos')); ?>" class="ui-input" min="0" step="0.01" placeholder="Ej. 187">
                        </div>
                    </div>
                </div>
            </div>
...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <?php $__currentLoopData = ['disponible','vendido','en_reparacion','dañado','reservado','mantenimiento']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($opt); ?>" <?php echo e(old('estado') == $opt ? 'selected' : ''); ?>><?php echo e(ucfirst(str_replace('_', ' ', $opt))); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <div class="ui-input-group input-group-lg">
                                ...
                                <input type="number" name="precio_venta" value="<?php echo e(old('precio_venta')); ?>" class="ui-input <?php $__errorArgs = ['precio_venta'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <div class="ui-input-group input-group-lg">
                                <span class="ui-input-group-text bg-light fw-bold">$</span>
                                <input type="number" name="precio_compra" value="<?php echo e(old('precio_compra')); ?>" class="ui-input" step="0.01" min="0" placeholder="0.00">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <select name="comprado_a_proveedor_id" class="ui-select">
                                ...
                                <?php $__currentLoopData = $proveedores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prov): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($prov->id); ?>" <?php echo e(old('comprado_a_proveedor_id') == $prov->id ? 'selected' : ''); ?>><?php echo e($prov->nombre); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="date" name="fecha_compra" value="<?php echo e(old('fecha_compra')); ?>" class="ui-input">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            <label class="ui-label small fw-semibold">Factura de Compra</label>
                            <input type="text" name="factura_compra" value="<?php echo e(old('factura_compra')); ?>" class="ui-input" placeholder="Ej. F-000123">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <select name="garantia_tipo" class="ui-select">
                                ...
                                <option value="fabrica" <?php echo e(old('garantia_tipo') == 'fabrica' ? 'selected' : ''); ?>>De Fábrica</option>
                                <option value="extendida" <?php echo e(old('garantia_tipo') == 'extendida' ? 'selected' : ''); ?>>Extendida</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="date" name="garantia_desde" value="<?php echo e(old('garantia_desde')); ?>" class="ui-input">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            <label class="ui-label small fw-semibold">Garantía Hasta</label>
                            <input type="date" name="garantia_hasta" value="<?php echo e(old('garantia_hasta')); ?>" class="ui-input">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="ui-card-body">
                ...
                <div class="row g-3">
                    <div class="col-md-3">
                        <div class="d-flex align-items-center gap-3 p-3 rounded-3" style="background: rgba(220,38,38,.04);">
                            <div class="form-check form-switch mb-0">
                                <input class="form-check-input" type="checkbox" name="bloqueado_icloud" value="1" id="chk_bloqueado_icloud" role="switch" style="width:3em;height:1.5em;" <?php echo e(old('bloqueado_icloud') ? 'checked' : ''); ?>>
                    ...
                    <div class="col-md-3">
                        <div class="d-flex align-items-center gap-3 p-3 rounded-3" style="background: rgba(220,38,38,.04);">
                            <div class="form-check form-switch mb-0">
                                <input class="form-check-input" type="checkbox" name="bloqueado_fr" value="1" id="chk_bloqueado_fr" role="switch" style="width:3em;height:1.5em;" <?php echo e(old('bloqueado_fr') ? 'checked' : ''); ?>>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <textarea name="observaciones" class="ui-input" rows="3" placeholder="Notas adicionales sobre el equipo..."><?php echo e(old('observaciones')); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="ui-sticky-bar">
    <div class="ui-sticky-bar-inner">
        <div class="d-flex align-items-center gap-2">
            ...
            <span class="fw-semibold d-none d-sm-inline">Registrando nuevo equipo</span>
        </div>
        <div class="d-flex align-items-center gap-2">
            ...
            <button type="submit" form="equipoForm" class="ui-btn ui-btn-solid rounded-pill">
                <i class="bi bi-plus-circle me-1"></i>Guardar Equipo
            </button>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/equipos/create.blade.php ENDPATH**/ ?>