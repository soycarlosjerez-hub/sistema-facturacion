...
<div class="ui-page" style="--accent:#38bdf8;--accent-rgb:56,189,248;--accent-hover:#0ea5e9;">
    <div class="ui-header mb-4" style="--delay:0s">
        ...
        <div class="ui-header-body">
            ...
            <div class="ui-header-actions">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('equipos.create')): ?>
                <a href="<?php echo e(route('equipos.create')); ?>" class="ui-btn ui-btn-primary ui-btn-sm rounded-pill">
                    <i class="bi bi-plus-lg me-1"></i> Nuevo Equipo
                </a>
                <?php endif; ?>
                <a href="<?php echo e(route('equipos.exportar')); ?>" class="ui-btn ui-btn-primary ui-btn-sm rounded-pill" style="background:rgba(255,255,255,.15);">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="ui-stat">
                <div class="ui-stat-body">
                    ...
                    <div class="ui-stat-value"><?php echo e($equipos->total() ?? '-'); ?></div>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6">
            <div class="ui-stat">
                <div class="ui-stat-body">
                    ...
                    <div class="ui-stat-value" style="color:#22c55e;">
                        <?php echo e($equipos->where('estado','disponible')->count() ?? 0); ?>
            ...
            <div class="ui-stat">
                <div class="ui-stat-body">
                    ...
                    <div class="ui-stat-value" style="color:#f59e0b;">
                        <?php echo e($equipos->where('estado','en_reparacion')->count() ?? 0); ?>
            ...
            <div class="ui-stat">
                <div class="ui-stat-body">
                    ...
                    <div class="ui-stat-value" style="color:#ef4444;">
                        <?php echo e($equipos->where('estado','dañado')->count() ?? 0); ?>
    ...
    <div class="ui-card mb-4" style="--delay:.1s">
        ...
        <div class="card-body p-3">
            <form method="GET" action="<?php echo e(route('equipos.index')); ?>" id="filtros-form" class="row g-2 align-items-end">
                <div class="col-lg-3">
                    <label class="ui-label small fw-bold text-muted">Buscar</label>
                    <div class="ui-input-group">
                        <span class="ui-input-group-text"><i class="bi bi-search"></i></span>
                        <input type="text" name="search" class="ui-input" placeholder="Serial, marca, modelo..." value="<?php echo e(request('search')); ?>" autocomplete="off">
                    </div>
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-2">
                    ...
                    <select name="disponibilidad" class="ui-select">
                        <option value="">Todas</option>
                        <option value="disponible" <?php echo e(request('disponibilidad') === 'disponible' ? 'selected' : ''); ?>>Disponibles</option>
                        <option value="no_disponible" <?php echo e(request('disponibilidad') === 'no_disponible' ? 'selected' : ''); ?>>No disponibles</option>
                    </select>
                </div>
                <div class="col-lg-3 d-flex gap-2">
                    <button type="submit" class="ui-btn ui-btn-solid flex-grow-1"><i class="bi bi-funnel me-1"></i>Filtrar</button>
                    <a href="<?php echo e(route('equipos.index')); ?>" class="ui-btn ui-btn-ghost"><i class="bi bi-x-lg"></i></a>
                </div>
            </form>
        </div>
    </div>
...
$(function() {
    ...
    const table = $('#equipos-table').DataTable({
        serverSide: true,
        ajax: {
            url: '<?php echo e(route('equipos.index')); ?>',
            type: 'GET',
            data: function(d) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/equipos/index.blade.php ENDPATH**/ ?>