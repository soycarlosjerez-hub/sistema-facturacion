...
<nav class="navbar navbar-expand-md navbar-dark bg-transparent px-3 px-md-5 py-3">
    <div class="container">
        <a class="navbar-brand fw-bold fs-4 text-white" href="/">
            <i class="bi bi-box-seam me-2"></i><?php echo e(config('app.name', 'Sistema POS')); ?>

        </a>
        <div class="ms-auto d-flex gap-2">
            <?php if(Route::has('login')): ?>
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(url('/dashboard')); ?>" class="btn btn-light rounded-pill px-4 fw-semibold">
                        <i class="bi bi-speedometer2 me-1"></i> Dashboard
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-light rounded-pill px-4">
                        <i class="bi bi-box-arrow-in-right me-1"></i> Iniciar Sesión
                    </a>
                    <?php if(Route::has('register')): ?>
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-light rounded-pill px-4 fw-semibold">
            ...
            <div class="card welcome-card rounded-5 shadow-lg overflow-hidden">
                <div class="row g-0">
                    <div class="col-lg-6 p-4 p-lg-5 d-flex flex-column justify-content-center">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <div>
                                <a href="<?php echo e(url('/dashboard')); ?>" class="btn btn-primary btn-lg rounded-pill px-5 fw-bold shadow-sm">
                                    <i class="bi bi-speedometer2 me-2"></i> Ir al Dashboard
                                </a>
                            </div>
                        <?php else: ?>
                            <div class="d-flex gap-3 flex-wrap">
                                <a href="<?php echo e(route('login')); ?>" class="btn btn-primary btn-lg rounded-pill px-5 fw-bold shadow-sm">
                                    <i class="bi bi-box-arrow-in-right me-2"></i> Iniciar Sesión
                                </a>
                                <?php if(Route::has('register')): ?>
                                    <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-primary btn-lg rounded-pill px-5 fw-bold">
...
<?php /**PATH /var/www/html/sistema-facturacion/resources/views/welcome.blade.php ENDPATH**/ ?>