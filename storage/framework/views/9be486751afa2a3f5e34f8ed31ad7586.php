...
<div class="ui-page" style="--accent:#ef4444;--accent-rgb:239,68,68;--accent-hover:#dc2626;">
    ...
    <div class="ui-card" style="--delay:.1s">
        ...
        <form action="<?php echo e(route('devoluciones.store')); ?>" method="POST" id="formDevolucion">
            <?php echo csrf_field(); ?>
            ...
            <div class="ui-card-body pb-4 mb-4 border-bottom">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <div class="ui-input-group">
                            ...
                            <input type="hidden" name="venta_id" id="venta_id" value="<?php echo e($venta?->id); ?>">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="cliente_id" class="ui-select" required>
                            ...
                            <?php $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($c->id); ?>" <?php echo e($venta && $venta->cliente_id == $c->id ? 'selected' : ''); ?>><?php echo e($c->nombre); ?> (<?php echo e($c->rnc_cedula ?? '—'); ?>)</option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="col-md-2">
                        <label class="ui-label">Fecha</label>
                        <input type="date" name="fecha" class="ui-input" value="<?php echo e(old('fecha', date('Y-m-d'))); ?>" required>
                    </div>
                    <div class="col-md-2">
                ...
                <div class="row mt-3">
                    <div class="col-12">
                        ...
                        <textarea name="motivo" class="ui-input" rows="2" required minlength="5"><?php echo e(old('motivo')); ?></textarea>
                    </div>
                </div>
            </div>
...
<div class="ui-sticky-bar">
    <div class="ui-sticky-bar-inner">
        ...
        <div class="d-flex align-items-center gap-2">
            <a href="<?php echo e(route('devoluciones.index')); ?>" class="ui-btn ui-btn-ghost rounded-pill">Cancelar</a>
...
<datalist id="productList">
    <?php $__currentLoopData = \App\Models\Producto::orderBy('nombre')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e($p->nombre); ?>" data-id="<?php echo e($p->id); ?>" data-precio="<?php echo e($p->precio); ?>" data-itbis="<?php echo e($p->itbis_porcentaje ?? $systemItbis ?? 18); ?>"></option>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</datalist>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    inputVenta.addEventListener('input', () => {
        ...
        timer = setTimeout(() => {
            fetch('<?php echo e(route('devoluciones.buscar-venta')); ?>?q=' + encodeURIComponent(q))
                .then(r => r.json())
                .then(data => {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/devoluciones/create.blade.php ENDPATH**/ ?>