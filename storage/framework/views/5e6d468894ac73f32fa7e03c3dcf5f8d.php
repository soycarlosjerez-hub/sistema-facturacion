<?php $__env->startSection('title', 'Evaluaciones de Proveedores'); ?>
    ...
    <div class="ui-header mb-4" style="--delay:0s">
        ...
        <div class="ui-header-body">
            ...
            <div class="ui-header-actions">
                <a href="<?php echo e(route('sgc.evaluaciones-proveedores.create')); ?>" class="ui-btn ui-btn-primary ui-btn-sm rounded-pill">
    ...
    <div class="ui-card" style="--delay:.1s">
        ...
        <div class="ui-card-body p-0">
            <table class="dt-table datatable" id="evaluaciones-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $evaluaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eval): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><code><?php echo e($eval->codigo); ?></code></td>
                        <td class="fw-semibold"><?php echo e($eval->proveedor?->nombre ?? '—'); ?></td>
                        <td><?php echo e($eval->fecha ? $eval->fecha->format('d/m/Y') : '—'); ?></td>
                        <td><?php echo e($eval->criterio ?? '—'); ?></td>
                        <td>
                        ...
                        <td>
                            <div class="d-flex gap-1">
                                <a href="<?php echo e(route('sgc.evaluaciones-proveedores.show', $eval)); ?>" class="btn btn-sm btn-outline-primary rounded-pill" title="Ver">
                                    <i class="bi bi-eye"></i>
                                </a>
                                <form action="<?php echo e(route('sgc.evaluaciones-proveedores.destroy', $eval)); ?>" method="POST" class="d-inline" onsubmit="return confirm('¿Eliminar esta evaluación?')">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/sgc/evaluaciones_proveedores/index.blade.php ENDPATH**/ ?>