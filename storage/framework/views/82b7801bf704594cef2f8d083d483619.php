<?php $__env->startSection('title', 'Autenticación de Dos Factores'); ?>
        ...
        <div class="col-lg-8">
            ...
            <div class="alert alert-danger border-0 shadow-sm mb-4" role="alert">
                <ul class="mb-0">
                    ...
                    <li><i class="fas fa-times-circle me-1"></i><?php echo e($error); ?></li>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content border-0 shadow" style="border-radius: 1rem;">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="verifyForm" action="<?php echo e(route('two-factor.confirm')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
            ...
            <div class="card border-0 shadow-sm mb-4" style="border-radius: 1rem;">
                <div class="card-body p-4">
                    ...
                    <small class="text-muted">
                        Activado el: <?php echo e($user->two_factor_confirmed_at->format('d/m/Y H:i')); ?>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content border-0 shadow" style="border-radius: 1rem;">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="disableForm" action="<?php echo e(route('two-factor.disable')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="form-floating mb-3">
...
function enableTwoFactor() {
    fetch('<?php echo e(route("two-factor.enable")); ?>', {
        method: 'POST',
        headers: {
...
function fetchRecoveryCodes() {
    ...
    fetch('<?php echo e(route("two-factor.recovery")); ?>', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/auth/two-factor.blade.php ENDPATH**/ ?>