...
<head>
    <meta charset="utf-8">
    <title>Formulario 14-14 - <?php echo e($mesNombre); ?> <?php echo e($anio); ?></title>
    <style>
        @page {
            margin: 2cm 1.5cm;
        }
...
<body>
    ...
    <div class="header-empresa">
        ...
        <?php endif; ?>
        <div class="nombre"><?php echo e(\App\Models\SystemSetting::nombreEmpresaActual()); ?></div>
        <div class="datos">
            RNC: <?php echo e($empresa['empresa_rnc'] ?? 'N/A'); ?>

            <?php if(!empty($empresa['empresa_telefono'])): ?>
                &nbsp;&bull;&nbsp; Tel: <?php echo e($empresa['empresa_telefono']); ?>

            <?php endif; ?>
            <?php if(!empty($empresa['empresa_direccion'])): ?>
                &nbsp;&bull;&nbsp; <?php echo e($empresa['empresa_direccion']); ?>
    ...
    <div class="titulo-form">
        ...
        <div class="periodo">Período: <?php echo e(ucfirst($mesNombre)); ?> <?php echo e($anio); ?> &nbsp;|&nbsp; Código de Período: <?php echo e($resumen['periodo']); ?></div>
    </div>
    ...
    <div class="contribuyente-box">
        <table>
            <tr>
                ...
                <td class="separator"><?php echo e(\App\Models\SystemSetting::nombreEmpresaActual()); ?></td>
                <td class="label">RNC:</td>
                <td><?php echo e($empresa['empresa_rnc'] ?? 'N/A'); ?></td>
            </tr>
            <tr>
                <td class="label">Dirección Fiscal:</td>
                <td colspan="3"><?php echo e($empresa['empresa_direccion'] ?? 'N/A'); ?></td>
            </tr>
            <tr>
                <td class="label">Teléfono:</td>
                <td><?php echo e($empresa['empresa_telefono'] ?? 'N/A'); ?></td>
                <td class="label">Correo Electrónico:</td>
                <td><?php echo e($empresa['empresa_email'] ?? 'N/A'); ?></td>
            </tr>
        </table>
    </div>
    ...
    <div class="resumen-section">
        ...
        <table class="resumen-totales">
            <tr>
                ...
                <td class="val mono"><?php echo e(number_format($resumen['itbis_ventas']['total_retenido'] ?? 0, 2)); ?></td>
            </tr>
            <tr>
                <td class="lbl">Cantidad de ventas con retención:</td>
                <td class="val"><?php echo e($resumen['itbis_ventas']['cantidad_ventas'] ?? 0); ?></td>
            </tr>
        </table>
    </div>
    ...
    <div class="resumen-section">
        ...
        <table class="resumen-totales">
            <tr>
                ...
                <td class="val mono"><?php echo e(number_format($resumen['itbis_compras']['total_retenido'] ?? 0, 2)); ?></td>
            </tr>
            <tr>
                <td class="lbl">Cantidad de compras con retención:</td>
                <td class="val"><?php echo e($resumen['itbis_compras']['cantidad_compras'] ?? 0); ?></td>
            </tr>
        </table>

        <?php if(!empty($resumen['itbis_compras']['detalles'])): ?>
        <table class="detalle mt-2">
            ...
            <tbody>
                <?php $__currentLoopData = $resumen['itbis_compras']['detalles']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><?php echo e($idx + 1); ?></td>
                    <td><?php echo e($d['fecha']); ?></td>
                    <td><?php echo e($d['rnc'] ?? 'N/A'); ?></td>
                    <td><?php echo e($d['proveedor'] ?? 'N/A'); ?></td>
                    <td class="text-right mono"><?php echo e(str_pad($d['compra_id'], 5, '0', STR_PAD_LEFT)); ?></td>
                    <td class="text-right mono"><?php echo e(number_format($d['itbis_retenido'], 2)); ?></td>
                </tr>
            ...
            <tfoot>
                <tr>
                    ...
                    <td class="text-right mono"><?php echo e(number_format($resumen['itbis_compras']['total_retenido'], 2)); ?></td>
                </tr>
            </tfoot>
        </table>
        <?php else: ?>
    ...
    <div class="resumen-section">
        ...
        <table class="resumen-totales">
            <tr>
                ...
                <td class="val mono"><?php echo e(number_format($resumen['isr_compras']['total_retenido'] ?? 0, 2)); ?></td>
            </tr>
            <tr>
                <td class="lbl">Cantidad de compras con retención ISR:</td>
                <td class="val"><?php echo e($resumen['isr_compras']['cantidad_compras'] ?? 0); ?></td>
            </tr>
        </table>

        <?php if(!empty($resumen['isr_compras']['detalles'])): ?>
        <table class="detalle mt-2">
            <thead>
                <tr>
                    <th>#</th>
            ...
            <tbody>
                <?php $__currentLoopData = $resumen['isr_compras']['detalles']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><?php echo e($idx + 1); ?></td>
                    <td><?php echo e($d['fecha']); ?></td>
                    <td><?php echo e($d['rnc'] ?? 'N/A'); ?></td>
                    <td><?php echo e($d['proveedor'] ?? 'N/A'); ?></td>
                    <td class="text-right mono"><?php echo e(str_pad($d['compra_id'], 5, '0', STR_PAD_LEFT)); ?></td>
                    <td class="text-right mono"><?php echo e(number_format($d['isr_retenido'], 2)); ?></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
            <tfoot>
                <tr>
                    ...
                    <td class="text-right mono"><?php echo e(number_format($resumen['isr_compras']['total_retenido'], 2)); ?></td>
                </tr>
            </tfoot>
        </table>
        <?php else: ?>
    ...
    <div class="resumen-section" style="margin-top:16px;">
        ...
        <table class="resumen-totales">
            ...
            <tr class="total-final">
                ...
                <td class="val mono" style="color:#b91c1c;"><?php echo e(number_format(($resumen['itbis_compras']['total_retenido'] ?? 0) + ($resumen['isr_compras']['total_retenido'] ?? 0), 2)); ?></td>
            </tr>
        </table>
    </div>
    ...
    <div class="declaracion-jurada">
        ...
        <p>
            ...
            durante el período <?php echo e(ucfirst($mesNombre)); ?> de <?php echo e($anio); ?>, conforme a lo establecido en el
    ...
    <div class="footer">
        Generado el <?php echo e(now()->format('d/m/Y h:i A')); ?> &nbsp;|&nbsp; Sistema de Facturación Electrónica RD &nbsp;|&nbsp; Documento generado automáticamente
    </div>

</body>
</html>
<?php /**PATH /var/www/html/sistema-facturacion/resources/views/formularios/14-14/pdf.blade.php ENDPATH**/ ?>