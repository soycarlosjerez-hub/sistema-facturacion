<?php $__env->startSection('title', 'API Request Logs'); ?>
...
<div class="container-fluid px-4 py-3">
        ...
        <div class="col-md-3">
            <div class="ui-stat h-100">
                <div class="card-body p-3 text-center">
                    ...
                    <h3 class="ui-stat-value mb-0"><?php echo e(number_format($stats['total'] ?? 0)); ?></h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="ui-stat h-100">
                <div class="card-body p-3 text-center">
                    ...
                    <h3 class="ui-stat-value mb-0 text-success"><?php echo e(number_format($stats['success'] ?? 0)); ?></h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="ui-stat h-100">
                <div class="card-body p-3 text-center">
                    ...
                    <h3 class="ui-stat-value mb-0 text-danger"><?php echo e(number_format($stats['errors'] ?? 0)); ?></h3>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="ui-stat h-100">
                <div class="card-body p-3 text-center">
                    ...
                    <h3 class="ui-stat-value mb-0"><?php echo e(number_format($stats['avg_response_time'] ?? 0, 0)); ?>ms</h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="ui-card mb-4" style="--delay:.15s">
        ...
        <div class="card-body p-4">
            <form method="GET" action="<?php echo e(route('owner.api-requests')); ?>">
                <div class="row g-3">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" name="uri" class="ui-input" placeholder="Buscar URI..." value="<?php echo e(request('uri')); ?>">
                    </div>
                    <div class="col-md-2">
                        <label class="ui-label">Estado</label>
                        <select name="response_status" class="ui-select">
                            <option value="">Todos</option>
                            <option value="200" <?php echo e(request('response_status') == '200' ? 'selected' : ''); ?>>200 OK</option>
                            <option value="201" <?php echo e(request('response_status') == '201' ? 'selected' : ''); ?>>201 Created</option>
                            <option value="401" <?php echo e(request('response_status') == '401' ? 'selected' : ''); ?>>401 Unauthorized</option>
                            <option value="403" <?php echo e(request('response_status') == '403' ? 'selected' : ''); ?>>403 Forbidden</option>
                            <option value="404" <?php echo e(request('response_status') == '404' ? 'selected' : ''); ?>>404 Not Found</option>
                            <option value="422" <?php echo e(request('response_status') == '422' ? 'selected' : ''); ?>>422 Unprocessable</option>
                            <option value="500" <?php echo e(request('response_status') == '500' ? 'selected' : ''); ?>>500 Server Error</option>
                        </select>
                    </div>
                    <div class="col-md-2">
                ...
                <?php if(request()->anyFilled(['method','uri','response_status','fecha_desde','fecha_hasta','search'])): ?>
                <div class="mt-2">
                    <a href="<?php echo e(route('owner.api-requests')); ?>" class="ui-btn ui-btn-ghost btn-sm"><i class="bi bi-x-lg me-1"></i> Limpiar filtros</a>
                </div>
                <?php endif; ?>
            </form>
        </div>
    ...
    <div class="ui-card" style="--delay:.2s">
        ...
        <div class="card-header bg-transparent border-0 p-4 d-flex justify-content-between align-items-center">
            <h5 class="fw-bold mb-0"><i class="bi bi-list me-2"></i> Peticiones (<?php echo e($logs->total()); ?>)</h5>
            <span class="ui-badge ui-badge-neutral"><?php echo e($logs->perPage()); ?> por p&aacute;gina</span>
        </div>
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <span class="ui-badge ui-badge-<?php echo e($log->method === 'GET' ? 'info' : ($log->method === 'POST' ? 'primary' : ($log->method === 'PUT' || $log->method === 'PATCH' ? 'warning' : 'danger'))); ?>">
                                <?php echo e($log->method); ?>

                            </span>
                        </td>
                        <td>
                            <code style="font-size: 0.8em;"><?php echo e(Str::limit($log->uri, 60)); ?></code>
                        </td>
                        <td>
                            <span class="ui-badge ui-badge-<?php echo e($log->response_status >= 200 && $log->response_status < 300 ? 'success' : ($log->response_status >= 400 && $log->response_status < 500 ? 'warning' : 'danger')); ?>">
                                <?php echo e($log->response_status); ?>

                            </span>
                        </td>
                        <td><?php echo e($log->response_time_ms ?? '-'); ?>ms</td>
                        <td><?php echo e($log->user?->name ?? ($log->businessInstance?->owner?->name ?? '-')); ?></td>
                        <td><small><?php echo e($log->ip_address ?? '-'); ?></small></td>
                        <td><small><?php echo e($log->created_at?->format('Y-m-d H:i:s')); ?></small></td>
                        <td>
                            <button class="ui-action ui-action-view" onclick="showDetails(<?php echo e($log->id); ?>, '<?php echo e(addslashes(json_encode($log))); ?>')" title="Ver detalle">
                                <i class="bi bi-eye"></i>
                            </button>
                        </td>
                    </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/owner/api-requests.blade.php ENDPATH**/ ?>