<?php $__env->startSection('title', 'Nuevo Dueño de Plataforma'); ?>
        ...
        <div class="col-lg-8">
            <div class="form-glass-card" style="--delay:.2s">
                ...
                <div class="card-body p-4 p-md-5 position-relative" style="z-index:1;">
                    <form action="<?php echo e(route('owner.owners.store')); ?>" method="POST" id="ownerForm">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/owner/owners/create.blade.php ENDPATH**/ ?>