<?php $__env->startSection('title', 'Usuarios de Instancia'); ?>
    ...
    <div class="premium-header-blue mb-4">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3" style="position:relative; z-index:2;">
            ...
            <div class="d-flex gap-2">
                <a href="<?php echo e(route('instance.users.create', $instance->id)); ?>" class="ui-btn ui-btn-primary ui-btn-sm rounded-pill">
            ...
            <div class="ui-stat">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="stat-value"><?php echo e($stats['sin_rol']); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="ui-stat">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="stat-value"><?php echo e($stats['total'] - $stats['sin_rol']); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="ui-card">
                ...
                <div class="card-header bg-transparent border-0 pb-0 pt-4 px-4">
                    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                        ...
                        <form method="GET" action="<?php echo e(route('instance.users.index', $instance->id)); ?>" class="d-flex gap-2 flex-wrap">
                            <div class="input-group" style="min-width: 220px;">
                                <span class="input-group-text bg-light border-end-0"><i class="bi bi-search"></i></span>
                                <input type="text" name="buscar" class="form-control border-start-0" placeholder="Buscar por nombre o email..." value="<?php echo e(request('buscar')); ?>" style="background: #f8fafc;">
                            </div>
                            <select name="instance_role" class="form-select" style="min-width: 180px; background: #f8fafc;" onchange="this.form.submit()">
                                <option value="">Todos los roles</option>
                                <?php $__currentLoopData = $instanceRoles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($role->id); ?>" <?php echo e(request('instance_role') == $role->id ? 'selected' : ''); ?>><?php echo e($role->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <?php if(request('buscar') || request('instance_role')): ?>
                                <a href="<?php echo e(route('instance.users.index', $instance->id)); ?>" class="btn btn-light border"><i class="bi bi-x-lg"></i></a>
                            <?php endif; ?>
                        </form>
                    </div>
                </div>
                <div class="card-body p-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $usuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="user-row">
                                            <td class="ps-4">
                                                <div class="d-flex align-items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <small class="text-muted">Creado <?php echo e($usuario->created_at->diffForHumans()); ?></small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <?php if($usuario->instanceRole): ?>
                                                    <span class="role-badge" style="background: rgba(59,130,246,.1); color: #2563eb;">
                                                        <i class="bi bi-shield-check"></i> <?php echo e($usuario->instanceRole->name); ?>
                                            ...
                                            <td>
                                                <?php if($usuario->sucursal): ?>
                                                    <small><?php echo e($usuario->sucursal->nombre); ?></small>
                                                <?php else: ?>
                                            ...
                                            <td class="text-end pe-4">
                                                <div class="d-flex gap-1 justify-content-end">
                                                    <a href="<?php echo e(route('instance.users.show', [$instance->id, $usuario->id])); ?>" class="ui-action ui-action-view" title="Ver perfil">
                                                        <i class="bi bi-eye"></i>
                                                    </a>
                                                    <a href="<?php echo e(route('instance.users.edit', [$instance->id, $usuario->id])); ?>" class="ui-action ui-action-edit" title="Editar">
                                                        <i class="bi bi-pencil"></i>
                                                    </a>
                                                    <?php if($usuario->role !== 'admin-business' || \App\Models\User::where('business_instance_id', $instance->id)->where('role', 'admin-business')->count() > 1): ?>
                                                        <form action="<?php echo e(route('instance.users.destroy', [$instance->id, $usuario->id])); ?>" method="POST" class="d-inline" onsubmit="return UI.confirm.delete('¿Eliminar al usuario &quot;<?php echo e($usuario->name); ?>&quot;?')">
                    ...
                    <?php else: ?>
                        <div class="text-center py-5">
                            ...
                            <a href="<?php echo e(route('instance.users.create', $instance->id)); ?>" class="ui-btn ui-btn-solid rounded-pill px-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/instance/users/index.blade.php ENDPATH**/ ?>