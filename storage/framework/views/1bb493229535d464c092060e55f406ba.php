<?php $__env->startSection('title', 'Nueva Evaluación Periódica'); ?>
...
<div class="ui-page" style="--accent:#8b5cf6;--accent-rgb:139,92,246;--accent-hover:#7c3aed;">
    ...
    <div class="ui-header mb-4" style="--delay:0s">
        ...
        <div class="ui-header-body">
            ...
            <div class="ui-header-actions">
                <a href="<?php echo e(route('sgc.evaluaciones-proveedores.periodico.index')); ?>" class="ui-btn ui-btn-ghost ui-btn-sm rounded-pill">
    ...
    <form action="<?php echo e(route('sgc.evaluaciones-proveedores.periodico.store')); ?>" method="POST" id="instanceForm">
        <?php echo csrf_field(); ?>
        <div class="row g-4">
            <div class="col-lg-8">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="proveedor_id" class="ui-select <?php $__errorArgs = ['proveedor_id'];
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="periodo" class="ui-input <?php $__errorArgs = ['periodo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('periodo')); ?>" placeholder="Ej: Q1-2026, Enero 2026" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="puntuacion" class="ui-input <?php $__errorArgs = ['puntuacion'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('puntuacion')); ?>" min="0" max="100" step="0.01" placeholder="Ej: 85">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="observaciones" class="ui-input <?php $__errorArgs = ['observaciones'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" rows="3" placeholder="Observaciones adicionales..."><?php echo e(old('observaciones')); ?></textarea>
...
<div class="ui-sticky-bar">
    <div class="ui-sticky-bar-inner">
        <a href="<?php echo e(route('sgc.evaluaciones-proveedores.periodico.index')); ?>" class="ui-btn ui-btn-ghost rounded-pill">Cancelar</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/sgc/evaluaciones_proveedores/periodico/create.blade.php ENDPATH**/ ?>