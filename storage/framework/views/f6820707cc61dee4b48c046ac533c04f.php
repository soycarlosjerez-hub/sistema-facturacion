...
<div class="ui-page" style="--accent:#f59e0b;--accent-rgb:245,158,11;--accent-hover:#d97706;">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3" style="position:relative; z-index:2;">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <h4 class="fw-bold mb-1 text-white"><?php echo e($user->name); ?></h4>
                    <small class="text-white opacity-75"><?php echo e($user->email); ?></small>
                </div>
            </div>
            <a href="<?php echo e(route('instance.users.index', $user->business_instance_id)); ?>" class="ui-btn ui-btn-primary ui-btn-sm rounded-pill">
    ...
    <form id="editUserForm" action="<?php echo e(route('instance.users.update', [$user->business_instance_id, $user->id])); ?>" method="POST">
        <?php echo csrf_field(); ?>
                ...
                <div class="ui-card h-100">
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="ui-input" value="<?php echo e(old('name', $user->name)); ?>" required>
                        </div>

                        <div class="mb-3">
                            <label class="ui-label">Correo Electrónico</label>
                            <input type="email" name="email" class="ui-input" value="<?php echo e(old('email', $user->email)); ?>" required>
                        </div>
                            ...
                            <div class="role-picker" id="rolePicker">
                                <?php if($instanceRoles->count() > 0): ?>
                                    <?php $__currentLoopData = $instanceRoles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="role-card <?php echo e(old('instance_role_id', $user->instance_role_id) == $rol->id ? 'active' : ''); ?>" data-role-id="<?php echo e($rol->id); ?>">
                                            <input type="radio" name="instance_role_id" value="<?php echo e($rol->id); ?>" class="d-none" <?php echo e(old('instance_role_id', $user->instance_role_id) == $rol->id ? 'checked' : ''); ?>>
    ...
    <div class="premium-sticky-bar">
        <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="d-flex gap-2">
                <a href="<?php echo e(route('instance.users.index', $user->business_instance_id)); ?>" class="btn-cancel">Cancelar</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/instance/users/edit.blade.php ENDPATH**/ ?>