<?php $__env->startSection('title', 'Manejador de Roles'); ?>
...
<div class="container-fluid px-4 ui-page" style="--accent:#ef4444;--accent-rgb:239,68,68;--accent-hover:#dc2626;">
    <div class="ui-header">
        ...
        <div class="ui-header-body w-100">
            ...
            <div class="ui-header-actions">
                <a href="<?php echo e(route($routePrefix . 'roles.matrix')); ?>" class="ui-btn ui-btn-primary rounded-pill px-3">
                    <i class="bi bi-grid-3x3-gap me-1"></i>Matriz
                </a>
                <a href="<?php echo e(route($routePrefix . 'roles.create')); ?>" class="ui-btn ui-btn-primary rounded-pill px-3 fw-bold">
            ...
            <div class="ui-stat">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="stat-value"><?php echo e($stats['permisos']); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="ui-stat">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="stat-value"><?php echo e($stats['usuarios']); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="ui-stat">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="stat-value"><?php echo e($stats['con_usuarios']); ?></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row g-3">
        <?php $__empty_0 = true; $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
            <?php
            ...
            <div class="col-xl-4 col-md-6">
                <div class="role-big-card <?php echo e($esProtegido ? 'protected' : ''); ?>"
                     style="--role-color: <?php echo e($cfg['color']); ?>; --role-gradient: <?php echo e($cfg['gradient']); ?>;">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div class="role-icon-lg" style="background: <?php echo e($cfg['gradient']); ?>;">
                    ...
                    <div class="role-name text-dark"><?php echo e($cfg['label'] ?: ucfirst($rol->name)); ?></div>
                    <p class="text-muted small mb-3"><?php echo e($cfg['desc']); ?></p>

                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <small class="text-muted fw-bold" style="font-size: 0.7rem;">
                            <i class="bi bi-key"></i> <?php echo e($rol->permissions_count); ?> / <?php echo e($stats['permisos']); ?> permisos
                        </small>
                        <small class="fw-bold" style="color: <?php echo e($cfg['color']); ?>;"><?php echo e($pct); ?>%</small>
                    </div>
                    <div class="perm-bar">
                        <div class="perm-bar-fill" style="width: <?php echo e($pct); ?>%;"></div>
                    </div>

                    <div class="d-flex justify-content-between align-items-center mt-3">
                        <div class="d-flex align-items-center gap-2">
                            <i class="bi bi-people-fill text-muted"></i>
                            <span class="fw-bold text-dark"><?php echo e($rol->users_count); ?></span>
                            <small class="text-muted"><?php echo e($rol->users_count == 1 ? 'usuario' : 'usuarios'); ?></small>
                        </div>
                        <div class="d-flex gap-1">
                            <a href="<?php echo e(route($routePrefix . 'roles.show', $rol)); ?>" class="ui-action ui-action-edit" title="Ver detalle">
                                <i class="bi bi-eye"></i>
                            </a>
                            <a href="<?php echo e(route($routePrefix . 'roles.edit', $rol)); ?>" class="ui-action ui-action-edit" title="Editar permisos">
                                <i class="bi bi-pencil"></i>
                            </a>
                            <?php if($rol->name !== 'admin' && $rol->users_count == 0): ?>
                                <form action="<?php echo e(route($routePrefix . 'roles.destroy', $rol)); ?>" method="POST" class="d-inline" onsubmit="return confirm('¿Eliminar el rol &quot;<?php echo e($rol->name); ?>&quot;?')">
            ...
            <div class="col-12">
                <div class="ui-card">
                    ...
                    <div class="card-body text-center py-5">
                        ...
                        <a href="<?php echo e(route($routePrefix . 'roles.create')); ?>" class="ui-btn ui-btn-solid rounded-pill px-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/roles/index.blade.php ENDPATH**/ ?>