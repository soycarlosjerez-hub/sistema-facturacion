<?php $__env->startSection('title', 'Detalle de Reservación'); ?>
...
<div class="ui-page" style="--accent:#10b981;--accent-rgb:16,185,129;--accent-hover:#059669;">
                ...
                <div>
                    <nav aria-label="breadcrumb mb-1">
                        <ol class="breadcrumb mb-0" style="font-size:.78rem;">
                            <li class="breadcrumb-item"><a href="<?php echo e(route('restaurante.reservaciones.index')); ?>" style="color:var(--accent);">Reservaciones</a></li>
                            <li class="breadcrumb-item active"><?php echo e($reservacion->cliente_nombre); ?></li>
                        </ol>
                    </nav>
                    <h3 class="mb-0 fw-bold" style="color:#1e293b; font-size:1.3rem;">
                        <i class="bi bi-calendar-check me-2" style="color:var(--accent);"></i>Reservación #<?php echo e($reservacion->id); ?>

                    </h3>
                    <div class="d-flex align-items-center gap-2 mt-1" style="font-size:.82rem; color:#64748b;">
                        <i class="bi bi-clock"></i>
                        <?php echo e($reservacion->fecha_hora->format('d \d\e F \d\e Y \a \l\a\s h:i A')); ?>

                    </div>
                </div>
                <div class="reservacion-actions ms-auto">
                    
                    <a href="<?php echo e(route('restaurante.reservaciones.index')); ?>" class="ui-btn ui-btn-ghost ui-btn-sm rounded-pill">
                    ...
                    <?php if($reservacion->estado === 'pendiente'): ?>
                        <button type="button" class="ui-btn ui-btn-sm rounded-pill" style="background:linear-gradient(135deg,#3b82f6,#2563eb);color:#fff;" onclick="cambiarEstado(<?php echo e($reservacion->id); ?>, 'confirmada')">
                            <i class="bi bi-check-circle"></i> Confirmar
                        </button>
                    <?php endif; ?>
                    <?php if($reservacion->estado === 'confirmada'): ?>
                        <button type="button" class="ui-btn ui-btn-sm rounded-pill" style="background:linear-gradient(135deg,#3b82f6,#2563eb);color:#fff;" onclick="cambiarEstado(<?php echo e($reservacion->id); ?>, 'cumplida')">
                            <i class="bi bi-check-all"></i> Marcar Cumplida
                        </button>
                    <?php endif; ?>
                    <?php if($reservacion->estado !== 'cancelada' && $reservacion->estado !== 'cumplida'): ?>
                        <button type="button" class="ui-btn ui-btn-sm rounded-pill ui-btn-danger" onclick="cambiarEstado(<?php echo e($reservacion->id); ?>, 'cancelada')">
                ...
                <div class="ui-card-body">
                    <div class="d-flex align-items-center gap-3">
                        <div class="mesa-show-number">
                            <?php echo e($reservacion->mesa->numero ?? '#'); ?>

                        </div>
                        <div class="mesa-show-info flex-grow-1">
                            <p class="mesa-show-name"><?php echo e($reservacion->mesa->nombre ?? 'Mesa ' . ($reservacion->mesa->numero ?? '')); ?></p>
                            <p class="mesa-show-cap">
                                <i class="bi bi-people me-1"></i>Capacidad: <?php echo e($reservacion->mesa->capacidad); ?> personas
                                <?php if($reservacion->mesa->ubicacion): ?>
                                    · <i class="bi bi-geo-alt me-1"></i><?php echo e($reservacion->mesa->ubicacion->nombre); ?>

                                <?php endif; ?>
                            </p>
                        </div>
                    </div>
                    <?php if($reservacion->mesa->categoria): ?>
                        <div class="mt-3">
                            <span class="ui-badge" style="background:<?php echo e($reservacion->mesa->categoria->color); ?>20; color:<?php echo e($reservacion->mesa->categoria->color); ?>; border:1px solid <?php echo e($reservacion->mesa->categoria->color); ?>40;">
                                <?php echo e($reservacion->mesa->categoria->nombre); ?>
                ...
                <div class="info-detail-body">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        <div class="ui-user-avatar ui-user-avatar-sm ui-user-avatar-green" style="font-size:.9rem; width:44px; height:44px;">
                            <?php echo e(strtoupper(substr($reservacion->cliente_nombre, 0, 2))); ?>

                        </div>
                        <div>
                            <div class="fw-bold"><?php echo e($reservacion->cliente_nombre); ?></div>
                        </div>
                    </div>
                    <?php if($reservacion->cliente): ?>
                        <div class="field-row">
                            <span class="field-label"><i class="bi bi-link-45deg"></i> Perfil</span>
                            <span class="field-value">
                                <a href="<?php echo e(route('clientes.show', $reservacion->cliente)); ?>">Ver perfil completo <i class="bi bi-box-arrow-up-right ms-1"></i></a>
                            </span>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="ui-card-body text-center">
                    <div class="mb-3">
                        <span class="badge rounded-pill fs-6 px-4 py-2
                            <?php echo e($reservacion->estado === 'pendiente' ? 'bg-warning' : ''); ?>

                            <?php echo e($reservacion->estado === 'confirmada' ? 'bg-success' : ''); ?>

                            <?php echo e($reservacion->estado === 'cumplida' ? 'bg-info text-white' : ''); ?>

                            <?php echo e($reservacion->estado === 'cancelada' ? 'bg-secondary' : ''); ?>
                            ...
                            ?>
                            <?php echo e($iconos[$reservacion->estado] ?? '📋'); ?> <?php echo e(ucfirst($reservacion->estado)); ?>
                    ...
                    <div class="row g-2 text-start">
                        <div class="col-6 field-row px-0 border-0 mb-0">
                            ...
                            <span class="field-value fw-bold" style="font-size:1.3rem;"><?php echo e($reservacion->personas); ?></span>
                        </div>
                    </div>
                    <div class="mt-3">
                        <small class="text-muted">Mesa asignada</small><br>
                        <strong style="font-size:1.3rem; color:var(--accent);">
                            <i class="bi bi-table me-1"></i>Mesa <?php echo e($reservacion->mesa->numero); ?>
            ...
            <div class="row g-3">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="field-row" style="flex-direction:column; align-items:flex-start; gap:.5rem;">
                        ...
                        <span class="field-value"><?php echo e($reservacion->cliente_email ?: '—'); ?></span>
                        <?php if($reservacion->cliente_email): ?>
                            <a href="mailto:<?php echo e($reservacion->cliente_email); ?>" class="mt-1" style="font-size:.78rem;">
    ...
    <div class="info-detail-card mb-4" style="animation-delay:.3s;">
        ...
        <div class="info-detail-body">
            <div class="notas-box"><?php echo e($reservacion->notas); ?></div>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="info-detail-card" style="animation-delay:.35s;">
        ...
        <div class="info-detail-body">
            <div class="timestamp-item">
                ...
                <div>
                    <div class="timestamp-timeline">Creada por <?php echo e($reservacion->user->name ?? 'Usuario'); ?></div>
                    <div class="timestamp-meta"><?php echo e($reservacion->created_at->format('d/m/Y h:i A')); ?> · <?php echo e($reservacion->created_at->diffForHumans()); ?></div>
                </div>
            </div>
            <?php if($reservacion->updated_at && $reservacion->updated_at->gt($reservacion->created_at)): ?>
            <div class="timestamp-item">
                <div class="timestamp-icon modified"><i class="bi bi-pencil"></i></div>
                <div>
                    <div class="timestamp-timeline">Ultima modificación por <?php echo e($reservacion->user->name ?? 'Usuario'); ?></div>
                    <div class="timestamp-meta"><?php echo e($reservacion->updated_at->format('d/m/Y h:i A')); ?> · <?php echo e($reservacion->updated_at->diffForHumans()); ?></div>
                </div>
            </div>
            <?php endif; ?>
        </div>
...
<div class="modal fade" id="reservaModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <form method="POST" action="<?php echo e(route('restaurante.reservaciones.update', $reservacion)); ?>" class="modal-content rounded-4 border-0 shadow" id="form-editar-reserva">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
            <div class="modal-header border-0" style="background:linear-gradient(135deg,#10b981,#059669);border-radius:1rem 1rem 0 0;">
                <h5 class="fw-bold text-white"><i class="bi bi-pencil me-2"></i>Editar Reservación #<?php echo e($reservacion->id); ?></h5>
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <select name="mesa_id" id="edit-mesa-id" class="ui-select" required>
                        ...
                        <?php $__currentLoopData = $reservacion->mesa ? [$reservacion->mesa] : []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php $__currentLoopData = \App\Models\Mesa::deSucursal()->orderBy('numero')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($m->id); ?>" <?php echo e($reservacion->mesa_id == $m->id ? 'selected' : ''); ?>>
                                <?php echo e($m->nombre ?? 'Mesa '.$m->numero); ?> (Cap. <?php echo e($m->capacidad); ?>, Est. <?php echo e($m->estado); ?>)
                            </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" name="cliente_nombre" id="edit-cliente-nombre" class="ui-input" value="<?php echo e($reservacion->cliente_nombre); ?>" required maxlength="200">
                </div>
                <div class="row g-2">
                    <div class="col-6">
                        <label class="ui-label">Teléfono</label>
                        <input type="text" name="cliente_telefono" id="edit-cliente-telefono" class="ui-input" value="<?php echo e($reservacion->cliente_telefono); ?>" maxlength="30">
                    </div>
                    <div class="col-6">
                        <label class="ui-label">Email</label>
                        <input type="email" name="cliente_email" id="edit-cliente-email" class="ui-input" value="<?php echo e($reservacion->cliente_email); ?>" maxlength="200">
                    </div>
                </div>
                <div class="row g-2 mt-2">
                    <div class="col-6">
                        <label class="ui-label">Personas <span class="text-danger">*</span></label>
                        <input type="number" name="personas" id="edit-personas" class="ui-input" value="<?php echo e($reservacion->personas); ?>" min="1" required>
                    </div>
                    <div class="col-6">
                        <label class="ui-label">Fecha y Hora <span class="text-danger">*</span></label>
                        <input type="datetime-local" name="fecha_hora" id="edit-fecha-hora" class="ui-input" value="<?php echo e($reservacion->fecha_hora->format('Y-m-d\TH:i')); ?>" required>
                    </div>
                </div>
                <div class="mb-3 mt-2">
                    <label class="ui-label">Notas</label>
                    <textarea name="notas" id="edit-notas" class="ui-textarea" rows="3" maxlength="500"><?php echo e($reservacion->notas); ?></textarea>
                </div>
            </div>
...
function eliminarReservacion() {
    if (!confirm('¿Eliminar la reservación de ' + '<?php echo e(addslashes($reservacion->cliente_nombre)); ?>'? Esta acción no se puede deshacer.')) return;
    var form = document.createElement('form');
    form.method = 'POST';
    form.action = '/restaurante/reservaciones/<?php echo e($reservacion->id); ?>';
    form.style.display = 'none';
    var h1 = document.createElement('input'); h1.type = 'hidden'; h1.name = '_token'; h1.value = document.querySelector('meta[name="csrf-token"]')?.content || '';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/restaurante/reservaciones-show.blade.php ENDPATH**/ ?>