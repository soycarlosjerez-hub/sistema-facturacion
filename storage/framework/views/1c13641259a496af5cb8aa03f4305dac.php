<?php $__env->startSection('title', 'Nuevo Usuario - ' . $instance->nombre); ?>
        ...
        <div class="ui-header-body">
            <div class="ui-header-left">
                ...
                <div>
                    ...
                    <p class="mb-0 opacity-75"><i class="bi bi-plus-circle me-1"></i><?php echo e($instance->nombre); ?> &middot; <?php echo e($instance->businessType?->nombre ?? 'Sin tipo'); ?></p>
                </div>
            </div>
        ...
        <div class="col-lg-7">
            <div class="ui-card" style="--delay:.15s">
                ...
                <div class="card-body p-4">
                    <form method="POST" action="<?php echo e(route('owner.instances.users.store', $instance)); ?>" id="instanceForm">
                        <?php echo csrf_field(); ?>

                        <div class="alert alert-info rounded-4 border-0 bg-info bg-opacity-10 small" role="alert">
                            <i class="bi bi-info-circle me-2"></i>
                            Este usuario ser&aacute; asignado a <strong><?php echo e($instance->nombre); ?></strong> con tipo de negocio <strong><?php echo e($instance->businessType?->nombre ?? '&mdash;'); ?></strong>.
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-bold small">Nombre <span class="text-danger">*</span></label>
                            <input type="text" name="name" class="ui-input rounded-pill <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name')); ?>" required placeholder="Nombre completo">
                        </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email')); ?>" required placeholder="usuario@ejemplo.com">
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-bold small">Contrase&ntilde;a <span class="text-danger">*</span></label>
                            <div class="position-relative">
                                <input type="password" name="password" id="passwordField" class="ui-input rounded-pill pe-5 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" <?php echo e(old('auto_password') ? 'readonly' : ''); ?> placeholder="M&iacute;nimo 12 caracteres">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="position-relative">
                                <input type="password" name="password_confirmation" id="passwordConfirmationField" class="ui-input rounded-pill pe-5" <?php echo e(old('auto_password') ? 'readonly' : ''); ?> placeholder="Repetir contrase&ntilde;a">
                        ...
                        <div class="d-flex align-items-center gap-3 p-3 rounded-3 mb-3" style="background:rgba(var(--accent-rgb,245,158,11),.05);">
                            <div class="form-check form-switch mb-0">
                                <input class="form-check-input" type="checkbox" name="auto_password" id="autoPasswordCheck" value="1" <?php echo e(old('auto_password') ? 'checked' : ''); ?> onchange="handleAutoPassword()" role="switch" style="width:3em;height:1.5em;">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="instance_role_id" class="ui-select rounded-pill <?php $__errorArgs = ['instance_role_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <option value="<?php echo e($ir->id); ?>" <?php echo e(old('instance_role_id') == $ir->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/owner/instances/users/create.blade.php ENDPATH**/ ?>