...
<div class="ui-page" style="--accent:#6366f1;--accent-rgb:99,102,241;--accent-hover:#4f46e5;padding-bottom: 80px;">
    ...
    <form action="<?php echo e(route('configuracion.update')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="ui-card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="empresa_nombre" class="ui-input" value="<?php echo e($settings['empresa_nombre'] ?? ''); ?>">
                            </div>
                            <div class="col-md-6">
                                <label class="ui-label small fw-bold">RNC (Registro Nacional)</label>
                                <input type="text" name="empresa_rnc" class="ui-input" value="<?php echo e($settings['empresa_rnc'] ?? ''); ?>">
                            </div>
                            <div class="col-md-12">
                                <label class="ui-label small fw-bold">Eslogan / Nota de Factura</label>
                                <input type="text" name="sistema_slogan" class="ui-input" value="<?php echo e($settings['sistema_slogan'] ?? ''); ?>">
                            </div>
                            <div class="col-md-6">
                                <label class="ui-label small fw-bold">Teléfono de Contacto</label>
                                <input type="text" name="empresa_telefono" class="ui-input" value="<?php echo e($settings['empresa_telefono'] ?? ''); ?>">
                            </div>
                            <div class="col-md-6">
                                <label class="ui-label small fw-bold">Dirección Física</label>
                                <input type="text" name="empresa_direccion" class="ui-input" value="<?php echo e($settings['empresa_direccion'] ?? ''); ?>">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="ui-card-body">
                        <div class="row g-3 align-items-center">
                            <div class="col-md-3 text-center">
                                <div id="logoPreviewContainer" style="display: <?php echo e($businessInstance && $businessInstance->logo ? 'block' : 'none'); ?>;">
                                    <img id="logoPreview" src="<?php echo e($businessInstance && $businessInstance->logo ? asset('storage/' . $businessInstance->logo) : ''); ?>" alt="Logo" style="max-width: 100%; max-height: 120px; border-radius: 12px; object-fit: contain;">
                                </div>
                                <div id="logoPlaceholder" style="display: <?php echo e($businessInstance && $businessInstance->logo ? 'none' : 'block'); ?>;">
                            ...
                            <div class="col-md-9">
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-6 d-flex align-items-end">
                                        <div id="logoActions" style="display: <?php echo e($businessInstance && $businessInstance->logo ? 'block' : 'none'); ?>;">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <div class="ui-input-group">
                                    ...
                                    <input type="number" step="0.01" name="impuesto_itbis" class="ui-input" value="<?php echo e($settings['impuesto_itbis'] ?? ''); ?>">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <label class="ui-label small fw-bold">Eslogan / Nota de Factura</label>
            ...
            <div class="col-lg-4">
                ...
                <div class="ui-card mt-3" style="--delay:.2s">
                    ...
                    <div class="ui-card-body">
                        ...
                        <?php if(!$businessInstance->setup_completed): ?>
                            <div class="alert alert-warning rounded-3 p-2 small mb-3 d-flex align-items-center gap-2">
                                <i class="bi bi-exclamation-triangle"></i>
                                <span>Setup pendiente</span>
                            </div>
                        <?php endif; ?>
                        <a href="<?php echo e(route('setup.wizard')); ?>" class="ui-btn ui-btn-ghost w-100 rounded-pill fw-bold">
                        ...
                        <?php if($businessInstance->setup_completed): ?>
                            ...
                            <div class="mt-2 text-center">
                                <a href="<?php echo e(route('setup.restart')); ?>" class="text-muted small" id="btnReiniciarSetup">
        ...
        <?php if(auth()->user()->hasRole('owner') || auth()->user()->hasRole('root')): ?>
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <select name="mail_mailer" class="ui-select">
                                    <option value="log" <?php echo e(($settings['mail_mailer'] ?? 'log') === 'log' ? 'selected' : ''); ?>>Log (solo depuración)</option>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="mail_host" class="ui-input" value="<?php echo e($settings['mail_host'] ?? ''); ?>" placeholder="smtp.gmail.com">
                            </div>
                            <div class="col-md-2">
                                <label class="ui-label small fw-bold">Puerto</label>
                                <input type="number" name="mail_port" class="ui-input" value="<?php echo e($settings['mail_port'] ?? '587'); ?>">
                            </div>
                            <div class="col-md-2">
                                ...
                                <select name="mail_encryption" class="ui-select">
                                    ...
                                    <option value="null" <?php echo e(($settings['mail_encryption'] ?? '') === 'null' ? 'selected' : ''); ?>>Ninguno</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <label class="ui-label small fw-bold">Usuario</label>
                                <input type="text" name="mail_username" class="ui-input" value="<?php echo e($settings['mail_username'] ?? ''); ?>">
                            </div>
                            <div class="col-md-4">
                                <label class="ui-label small fw-bold">Contraseña</label>
                                <input type="password" name="mail_password" class="ui-input" placeholder="<?php echo e(($settings['mail_password'] ?? '') ? '********' : 'Ingresar contraseña'); ?>">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="email" name="mail_from_address" class="ui-input" value="<?php echo e($settings['mail_from_address'] ?? ''); ?>" placeholder="no-reply@ejemplo.com">
                            </div>
                            <div class="col-md-4">
                                <label class="ui-label small fw-bold">Nombre Remitente</label>
                                <input type="text" name="mail_from_name" class="ui-input" value="<?php echo e($settings['mail_from_name'] ?? ''); ?>" placeholder="Sistema de Facturación">
                            </div>
                        </div>
...
<div class="modal fade" id="testEmailModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-4 border-0 shadow">
            <form action="<?php echo e(route('configuracion.test-email')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/configuracion/index.blade.php ENDPATH**/ ?>