<?php $__env->startSection('title', 'Pagos de Alquiler'); ?>
        ...
        <div class="d-flex justify-content-between align-items-center position-relative" style="z-index:2;">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <small class="text-white opacity-75"><?php echo e($pagos->count()); ?> pagos registrados</small>
                </div>
            </div>
            <div>
                <a href="<?php echo e(route('alquileres.pagos.create')); ?>" class="btn btn-light rounded-pill px-4 shadow-sm fw-bold" style="backdrop-filter:blur(8px);background:rgba(255,255,255,.2);border:1.5px solid rgba(255,255,255,.35);">
...
<script>
$(function() {
    const data = <?php echo json_encode($pagos, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/alquileres/pagos/index.blade.php ENDPATH**/ ?>