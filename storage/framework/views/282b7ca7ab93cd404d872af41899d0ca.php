<?php $__env->startSection('title', 'Editar Cuenta Bancaria'); ?>
...
<div class="ui-page" style="--accent:#10b981;--accent-rgb:16,185,129;--accent-hover:#059669;">
            ...
            <div class="ui-header-left">
                ...
                <div>
                    ...
                    <div class="ui-header-meta">
                        ...
                        <?php echo e($cuentasBancarium->nombre); ?>
    ...
    <form id="cuentaForm" action="<?php echo e(route('cuentas-bancarias.update', $cuentasBancarium)); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nombre', $cuentasBancarium->nombre)); ?>" required placeholder="Ej. Cuenta Corriente BHD">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('banco', $cuentasBancarium->banco)); ?>" placeholder="Ej. Banco Popular, BHD, Scotiabank">
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="ahorros" <?php echo e(old('tipo_cuenta', $cuentasBancarium->tipo_cuenta) === 'ahorros' ? 'selected' : ''); ?>>Ahorros</option>
                            <option value="corriente" <?php echo e(old('tipo_cuenta', $cuentasBancarium->tipo_cuenta) === 'corriente' ? 'selected' : ''); ?>>Corriente</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('numero_cuenta', $cuentasBancarium->numero_cuenta)); ?>" placeholder="000-000000-0">
...
unset($__errorArgs, $__bag); ?>">
                            <option value="RD" <?php echo e(old('moneda', $cuentasBancarium->moneda) === 'RD' ? 'selected' : ''); ?>>RD (Peso Dominicano)</option>
                            <option value="USD" <?php echo e(old('moneda', $cuentasBancarium->moneda) === 'USD' ? 'selected' : ''); ?>>USD (Dólar)</option>
                            <option value="EUR" <?php echo e(old('moneda', $cuentasBancarium->moneda) === 'EUR' ? 'selected' : ''); ?>>EUR (Euro)</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('titular', $cuentasBancarium->titular)); ?>" placeholder="Nombre del titular">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('cedula_ruc', $cuentasBancarium->cedula_ruc)); ?>" placeholder="000-0000000-0">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('saldo_inicial', $cuentasBancarium->saldo_inicial)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-check form-switch pt-4">
                            <input class="form-check-input" type="checkbox" name="activo" value="1" id="chk-activo" <?php echo e($cuentasBancarium->activo ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/cuentas-bancarias/edit.blade.php ENDPATH**/ ?>