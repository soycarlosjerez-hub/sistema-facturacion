<?php $__env->startSection('title', 'Reporte de Propinas'); ?>
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-4">
            <div class="ui-stat text-center p-3">
                ...
                <div class="ui-stat-value text-success">RD$ <?php echo e(number_format($totalGlobal, 2)); ?></div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="ui-stat text-center p-3">
                <div class="ui-stat-label">Órdenes con Propina</div>
                <div class="ui-stat-value text-primary"><?php echo e($ordenesConPropina); ?></div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="ui-stat text-center p-3">
                <div class="ui-stat-label">Promedio Global</div>
                <div class="ui-stat-value text-warning">RD$ <?php echo e(number_format($ordenesConPropina > 0 ? $totalGlobal / $ordenesConPropina : 0, 2)); ?></div>
            </div>
        </div>
    </div>
        ...
        <div class="card-body p-0">
            <div class="table-responsive px-3 py-3">
                <table id="propinasTable" class="table align-middle mb-0">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $propinas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="fw-medium"><?php echo e($p->usuario?->name ?? '—'); ?></td>
                            <td class="text-center"><?php echo e($p->total_ordenes); ?></td>
                            <td class="text-end fw-bold text-success">RD$ <?php echo e(number_format($p->total_propinas, 2)); ?></td>
                            <td class="text-end">RD$ <?php echo e(number_format($p->promedio_propina, 2)); ?></td>
                        </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/reportes/propinas.blade.php ENDPATH**/ ?>