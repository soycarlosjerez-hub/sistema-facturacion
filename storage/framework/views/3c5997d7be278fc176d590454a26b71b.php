            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    <?php $__empty_0 = true; $__currentLoopData = $tipos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
                        <tr id="row-<?php echo e($tipo->id); ?>">
                            <td class="ps-4 text-muted"><?php echo e($tipo->id); ?></td>
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    <span class="badge bg-<?php echo e($tipo->color); ?> bg-opacity-10 text-<?php echo e($tipo->color); ?> rounded-circle p-2">
                                        <i class="bi <?php echo e($tipo->icon); ?>"></i>
                                    </span>
                                    <div>
                                        <div class="fw-bold"><?php echo e($tipo->nombre); ?></div>
                                        <?php if($tipo->descripcion): ?>
                                            <small class="text-muted"><?php echo e($tipo->descripcion); ?></small>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </td>
                            <td><code><?php echo e($tipo->slug); ?></code></td>
                            <td class="text-center">
                                <button class="btn btn-sm btn-outline-primary rounded-pill" onclick="openModulesModal(<?php echo e($tipo->id); ?>, '<?php echo e($tipo->nombre); ?>')">
                                    <i class="bi bi-grid-3x3-gap me-1"></i><?php echo e($tipo->modules->count()); ?> módulos
                                </button>
                            </td>
                            <td class="text-center">
                                <?php if($tipo->activo): ?>
                            ...
                            <td class="text-center"><?php echo e($tipo->orden); ?></td>
                            <td class="text-end pe-4">
                                <button class="ui-action ui-action-edit me-1" onclick="openEditModal(<?php echo e($tipo->toJson()); ?>)" title="Editar">
                                    <i class="bi bi-pencil"></i>
                                </button>
                                <form action="<?php echo e(route('business-types.destroy', $tipo)); ?>" method="POST" class="d-inline">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="submit" class="ui-action ui-action-delete" onclick="event.preventDefault();UI.confirm.delete('<?php echo e(route('business-types.destroy', $tipo)); ?>', '<?php echo e(addslashes($tipo->nombre)); ?>')" title="Eliminar">
...
<div class="modal fade" id="createModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-4 border-0 shadow">
            <form action="<?php echo e(route('business-types.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
        ...
        <div class="modal-content rounded-4 border-0 shadow">
            ...
            <div class="modal-body">
                ...
                <div id="modulesContent" style="display:none;">
                    ...
                    ?>
                    <?php $__currentLoopData = $modulosPorCategoria; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria => $modulos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="mb-3">
                            <h6 class="text-muted small fw-bold text-uppercase mb-2"><?php echo e(ucfirst($categoria)); ?></h6>
                            <div class="row g-2">
                                <?php $__currentLoopData = $modulos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $mod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-md-6 col-lg-4">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input module-check" type="checkbox"
                                                   data-modulo="<?php echo e($key); ?>" id="mod-<?php echo e($key); ?>">
                                            <label class="form-check-label small" for="mod-<?php echo e($key); ?>">
                                                <i class="bi <?php echo e($mod['icon']); ?> me-1 text-muted"></i><?php echo e($mod['label']); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/business-types/index.blade.php ENDPATH**/ ?>