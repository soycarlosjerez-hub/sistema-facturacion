    ...
    <div class="error-card">
        ...
        <div class="btn-group-actions">
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('suscripcion.index')); ?>" class="btn-premium btn-success-action">
                    <i class="bi bi-credit-card-2-front"></i>
                    Ver Suscripción
                </a>
            <?php endif; ?>

            <a href="<?php echo e(url('/logout')); ?>" class="btn-premium btn-secondary-action">
...
<?php /**PATH /var/www/html/sistema-facturacion/resources/views/errors/instancia-bloqueada.blade.php ENDPATH**/ ?>