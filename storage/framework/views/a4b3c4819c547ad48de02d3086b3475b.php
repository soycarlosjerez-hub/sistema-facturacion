<?php $__env->startSection('title', 'Cola de Repartidores'); ?>
...
<div class="ui-page" style="--accent:#0ea5e9;--accent-rgb:14,165,233;--accent-hover:#0284c7;">
    ...
    <?php $totalActivas = $drivers->sum('totalActivas'); ?>
                ...
                <div class="card-body p-3">
                    <div class="d-flex align-items-center gap-2">
                        <div class="driver-stat" style="background:rgba(245,158,11,.08)">
                            <span class="driver-stat-value text-warning"><?php echo e($drivers->where('totalActivas', '>', 0)->count()); ?></span>
                ...
                <div class="card-body p-3">
                    <div class="d-flex align-items-center gap-2">
                        <div class="driver-stat" style="background:rgba(217,119,6,.08)">
                            <span class="driver-stat-value" style="color:#d97706"><?php echo e($drivers->sum(function($d) { return $d->pendientes->count(); })); ?></span>
                ...
                <div class="card-body p-3">
                    <div class="d-flex align-items-center gap-2">
                        <div class="driver-stat" style="background:rgba(2,132,199,.08)">
                            <span class="driver-stat-value" style="color:#0284c7"><?php echo e($drivers->sum(function($d) { return $d->enCamino->count(); })); ?></span>
                ...
                <div class="card-body p-3">
                    <div class="d-flex align-items-center gap-2">
                        <div class="driver-stat" style="background:rgba(22,163,74,.08)">
                            <span class="driver-stat-value" style="color:#15803d"><?php echo e($drivers->sum(function($d) { return $d->entregadasHoy; })); ?></span>
    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-lg-6 col-xl-4">
            <div class="driver-card">
                ...
                <div class="p-3 border-bottom" style="border-color:rgba(0,0,0,.06) !important;">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="flex-grow-1">
                            <h6 class="fw-bold mb-0"><?php echo e($driver->nombre); ?> <?php echo e($driver->apellido); ?></h6>
                            <?php if($driver->telefono): ?>
                            <small class="text-muted"><i class="bi bi-telephone me-1"></i><?php echo e($driver->telefono); ?></small>
                            <?php endif; ?>
                        </div>
                        <?php if($driver->totalActivas > 0): ?>
                        <span class="badge bg-primary rounded-pill"><?php echo e($driver->totalActivas); ?></span>
                        <?php else: ?>
                ...
                <div class="p-2 border-bottom" style="border-color:rgba(0,0,0,.04) !important;">
                    <div class="driver-stats">
                        <div class="driver-stat">
                            <span class="driver-stat-value" style="color:#d97706"><?php echo e($driver->pendientes->count()); ?></span>
                            <span class="driver-stat-label">Pendientes</span>
                        </div>
                        <div class="driver-stat">
                            <span class="driver-stat-value" style="color:#0284c7"><?php echo e($driver->enCamino->count()); ?></span>
                            <span class="driver-stat-label">En Camino</span>
                        </div>
                        <div class="driver-stat">
                            <span class="driver-stat-value" style="color:#15803d"><?php echo e($driver->entregadasHoy); ?></span>
                ...
                <?php if($driver->pendientes->count() > 0): ?>
                <div class="p-3" style="background:rgba(245,158,11,.04);">
                    <h7 class="fw-bold mb-2" style="color:#d97706; font-size:0.75rem; text-transform:uppercase; letter-spacing:0.05em;">
                        <i class="bi bi-clock me-1"></i>Pendientes (<?php echo e($driver->pendientes->count()); ?>)
                    </h7>
                    <ul class="orden-list">
                            ...
                            <div class="d-flex justify-content-between align-items-start gap-2">
                                <div class="flex-grow-1">
                                    ...
                                    <div class="small text-muted mb-1">
                                        <i class="bi bi-person me-1"></i><?php echo e($p->orden->cliente->nombre ?? 'Consumidor Final'); ?>

                                    </div>
                                    <div class="fw-bold" style="font-size:0.82rem">
                                        <?php echo e($systemMoneda ?? 'RD$'); ?> <?php echo e(number_format($p->orden->total, 2)); ?>

                                    </div>
                                    <div class="small text-muted" style="font-size:0.72rem">
                                        <?php if($p->orden->direccion_entrega): ?>
                                        <i class="bi bi-geo-alt me-1"></i><?php echo e(Str::limit($p->orden->direccion_entrega, 40)); ?>
                ...
                <?php if($driver->enCamino->count() > 0): ?>
                <div class="p-3" style="background:rgba(14,165,233,.04);">
                    <h7 class="fw-bold mb-2" style="color:#0284c7; font-size:0.75rem; text-transform:uppercase; letter-spacing:0.05em;">
                        <i class="bi bi-truck me-1"></i>En Camino (<?php echo e($driver->enCamino->count()); ?>)
                    </h7>
                    <ul class="orden-list">
                        ...
                        <li class="orden-item">
                            <div class="d-flex justify-content-between align-items-start gap-2">
                                <div class="flex-grow-1">
                                    ...
                                    <div class="small text-muted mb-1">
                                        <i class="bi bi-person me-1"></i><?php echo e($e->orden->cliente->nombre ?? 'Consumidor Final'); ?>

                                    </div>
                                    <div class="fw-bold" style="font-size:0.82rem">
                                        <?php echo e($systemMoneda ?? 'RD$'); ?> <?php echo e(number_format($e->orden->total, 2)); ?>

                                    </div>
                                    <div class="small text-muted" style="font-size:0.72rem">
                                        <?php if($e->orden->direccion_entrega): ?>
                                        <i class="bi bi-geo-alt me-1"></i><?php echo e(Str::limit($e->orden->direccion_entrega, 40)); ?>
                ...
                <?php if($driver->totalActivas === 0 && $driver->entregadasHoy === 0): ?>
        ...
        <div class="col-12">
            <div class="ui-card">
                <div class="card-body p-5 text-center text-muted">
                    ...
                    <a href="<?php echo e(route('delivery-drivers.create')); ?>" class="btn btn-sm btn-primary rounded-pill">
...
<script>
const driverToken = '<?php echo e(csrf_token()); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/delivery-drivers/queue.blade.php ENDPATH**/ ?>