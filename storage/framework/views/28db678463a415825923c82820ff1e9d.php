<?php $__env->startSection('title', 'Auditorías Internas'); ?>
...
<div class="ui-page">
    ...
    <div class="ui-header mb-4" style="--delay:0s">
        ...
        <div class="ui-header-body">
            <div class="ui-header-left">
                ...
                <div>
                    <h4 class="ui-header-title">Auditorías Internas</h4>
                    <div class="ui-header-meta">
                        <i class="bi bi-list-ul me-1"></i> Programación y seguimiento de auditorías internas
                    </div>
                </div>
            </div>
            <div class="ui-header-actions">
                <a href="<?php echo e(route('sgc.auditorias.programas')); ?>" class="ui-btn ui-btn-ghost ui-btn-sm rounded-pill me-2">
                    <i class="bi bi-calendar3 me-1"></i> Programas
                </a>
            </div>
        </div>
        <div class="mt-3">
            <form method="GET" action="<?php echo e(route('sgc.auditorias.index')); ?>" class="d-flex gap-2 align-items-center flex-wrap">
                ...
                <?php if(request('buscar') || request('estado')): ?>
                    <a href="<?php echo e(route('sgc.auditorias.index')); ?>" class="ui-btn ui-btn-ghost ui-btn-sm rounded-pill px-3 text-white border-white border-opacity-25">
    ...
    <div class="ui-card" style="--delay:.1s">
        ...
        <div class="ui-card-body p-0">
            <table class="dt-table datatable" id="auditorias-table">
                <thead>
                    <tr>
                        <th>Código</th>
                        <th>Área</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><code><?php echo e($aud->codigo); ?></code></td>
                        <td><?php echo e($aud->area_auditar); ?></td>
                        <td><?php echo e($aud->programa ? $aud->programa->ano_label : '-'); ?></td>
                        <td><?php echo e($aud->fecha_programada ? $aud->fecha_programada->format('d/m/Y') : '-'); ?></td>
                        <td><?php echo e($aud->responsable_auditor ? $aud->responsableAuditor->name : '-'); ?></td>
                        <td><span class="badge-status badge-<?php echo e($aud->estado); ?>"><?php echo e($aud->estado_label); ?></span></td>
                        <td><span class="badge bg-primary bg-opacity-10 text-primary" style="font-size:.7rem;"><?php echo e($aud->hallazgos_count); ?></span></td>
                        <td>
                            <div class="d-flex gap-1">
                                <a href="<?php echo e(route('sgc.auditorias.show', $aud)); ?>" class="btn btn-sm btn-outline-primary rounded-pill" title="Ver">
                                    <i class="bi bi-eye"></i>
                                </a>
                            </div>
                        </td>
...
document.addEventListener('DOMContentLoaded', function() {
    const table = document.getElementById('auditorias-table');
    if (table && typeof $.fn.DataTable === 'function') {
        $(table).DataTable({
            ...
            language: {
                ...
                zeroRecords: 'No se encontraron auditorías',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/sgc/auditorias/index.blade.php ENDPATH**/ ?>