            ...
            <div class="ui-header-left">
                ...
                <div>
                    ...
                    <div class="ui-header-meta">
                        ...
                        <?php echo e($proveedores->count()); ?> registro(s)
                    </div>
                </div>
            </div>
            <div class="ui-header-actions">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('proveedores.create')): ?>
                <a href="<?php echo e(route('proveedores.create')); ?>" class="ui-btn ui-btn-solid ui-btn-sm rounded-pill">
            ...
            <form method="GET" id="search-form" class="row g-2 align-items-center">
                <div class="col-lg-4">
                    <div class="ui-input-group">
                        ...
                        <input type="text" name="buscar" id="busqueda-proveedor" class="ui-input" placeholder="Nombre, RNC, teléfono o email..." value="<?php echo e(request('buscar')); ?>" autocomplete="off">
                    </div>
                </div>
                ...
                <div class="col-lg-2 d-flex gap-2">
                    ...
                    <a href="<?php echo e(route('proveedores.index')); ?>" class="ui-btn ui-btn-ghost"><i class="bi bi-x-lg"></i></a>
                </div>
                <div class="col-lg-4 text-end">
                    <div class="d-flex gap-2 justify-content-end">
                        <a href="<?php echo e(route('proveedores.importar')); ?>" class="ui-btn ui-btn-solid rounded-pill shadow-sm fw-medium">
                            <i class="bi bi-upload me-1"></i> Importar CSV
                        </a>
                        <a href="<?php echo e(route('proveedores.exportar', request()->all())); ?>" class="ui-btn ui-btn-solid rounded-pill shadow-sm fw-medium">
                            <i class="bi bi-file-excel me-1"></i> Excel
                        </a>
                        <a href="<?php echo e(route('proveedores.pdf', request()->all())); ?>" class="ui-btn ui-btn-solid rounded-pill shadow-sm fw-medium">
...
<script>
$(function() {
    const data = <?php echo json_encode($proveedores, 15, 512) ?>;
            ...
            },
            {
                ...
                render: function(data) {
                    return renderAcciones(data.id, {
                        show: '<?php echo e(url("proveedores")); ?>/' + data.id,
                        edit: '<?php echo e(url("proveedores")); ?>/' + data.id + '/edit',
                        delete: '<?php echo e(url("proveedores")); ?>/' + data.id,
                        csrf: csrfToken,
                        nombre: data.nombre
                    });
                }
    ...
    $('#proveedores-table').on('click', '.toggle-activo', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '<?php echo e(url("proveedores")); ?>/' + id + '/toggle',
                    method: 'PUT',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/proveedores/index.blade.php ENDPATH**/ ?>