<?php $__env->startSection('title', 'Comisiones Delivery'); ?>
    ...
    <div class="ui-card filter-card mb-4"><div class="ui-card-accent"></div><div class="px-4 py-3">
        <form method="GET" class="row g-2 align-items-end">
            <div class="col-auto">
                ...
                <input type="date" name="desde" class="ui-input rounded-3" value="<?php echo e($desde); ?>">
            </div>
            <div class="col-auto">
                <label class="ui-label small fw-semibold mb-0">Hasta</label>
                <input type="date" name="hasta" class="ui-input rounded-3" value="<?php echo e($hasta); ?>">
            </div>
            ...
            <div class="table-responsive px-3 py-3">
                <table id="deliveryResumenTable" class="table align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="fw-medium"><?php echo e($c['nombre']); ?></td>
                            <td class="text-center"><?php echo e($c['ventas']); ?></td>
                            <td class="text-end fw-bold">RD$ <?php echo e(number_format($c['total_fee'], 2)); ?></td>
                        </tr>
                    ...
                    <tfoot class="fw-bold">
                        <tr>
                            <th>Total</th>
                            <th class="text-center"><?php echo e(collect($companies)->sum('ventas')); ?></th>
                            <th class="text-end fw-bold">RD$ <?php echo e(number_format($totalFees, 2)); ?></th>
                        </tr>
                    </tfoot>
                </table>
            </div>
        ...
        <div class="card-body p-0">
            <div class="table-responsive px-3 py-3">
                <table id="deliveryDetalleTable" class="table align-middle mb-0">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $detalles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($v->id); ?></td>
                            <td><?php echo e($v->created_at->format('d/m/Y H:i')); ?></td>
                            <td><?php echo e($v->mesa?->nombre ?? '—'); ?></td>
                            <td><?php echo e($v->deliveryCompany?->nombre ?? '—'); ?></td>
                            <td class="text-end">RD$ <?php echo e(number_format($v->total, 2)); ?></td>
                            <td class="text-end fw-bold">RD$ <?php echo e(number_format($v->delivery_fee, 2)); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/reportes/delivery-comisiones.blade.php ENDPATH**/ ?>