<?php $__env->startSection('title', 'Reporte de Retenciones'); ?>
        ...
        <div class="ui-header-body w-100">
            <div class="ui-header-left">
                ...
                <div>
                    ...
                    <div class="ui-header-meta">Período: <?php echo e(ucfirst(Carbon\Carbon::create()->month($mes)->translatedFormat('F'))); ?> <?php echo e($anio); ?></div>
                </div>
            </div>
            <div class="ui-header-actions">
                <a href="<?php echo e(route('reportes.retenciones.csv', request()->all())); ?>" class="ui-btn ui-btn-solid rounded-pill"><i class="bi bi-download me-1"></i> CSV</a>
        ...
        <form method="GET" class="row g-2 align-items-end">
            ...
            <div class="col-auto">
                <select name="mes" class="ui-select">
                    <?php $__currentLoopData = range(1, 12); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($m); ?>" <?php echo e($mes == $m ? 'selected' : ''); ?>><?php echo e(Carbon\Carbon::create()->month($m)->translatedFormat('F')); ?></option>
            ...
            <div class="col-auto">
                <select name="tipo" class="ui-select">
                    <option value="compras" <?php echo e($tipo === 'compras' ? 'selected' : ''); ?>>Compras</option>
                    <option value="ventas" <?php echo e($tipo === 'ventas' ? 'selected' : ''); ?>>Ventas</option>
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-4">
            <div class="ui-stat text-center p-3">
                ...
                <div class="ui-stat-value">RD$ <?php echo e(number_format($totalRetIsr, 2)); ?></div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="ui-stat text-center p-3">
                ...
                <div class="ui-stat-value">RD$ <?php echo e(number_format($totalRetItbis, 2)); ?></div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="ui-stat text-center p-3">
                ...
                <div class="ui-stat-value">RD$ <?php echo e(number_format($totalGeneral, 2)); ?></div>
            </div>
        </div>
    </div>
            ...
            <table id="retencionesComprasTable" class="table align-middle mb-0">
                ...
                <tbody>
                    <?php $__currentLoopData = $compras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="ps-4"><span class="fw-semibold small"><?php echo e($c->proveedor?->nombre ?? 'N/A'); ?></span></td>
                            <td><span class="font-monospace small"><?php echo e($c->proveedor?->rnc ?? ''); ?></span></td>
                            <td><span class="font-monospace small"><?php echo e($c->folio ?? '#' . $c->id); ?></span></td>
            ...
            <table id="retencionesVentasTable" class="table align-middle mb-0">
                ...
                <tbody>
                    <?php $__currentLoopData = $ventas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="ps-4"><span class="fw-semibold small"><?php echo e($v->cliente?->nombre ?? 'N/A'); ?></span></td>
                            <td><span class="font-monospace small"><?php echo e($v->cliente?->rnc_cedula ?? ''); ?></span></td>
                            <td><span class="font-monospace small">#<?php echo e(str_pad($v->id, 5, '0', STR_PAD_LEFT)); ?></span></td>
                            <td><small><?php echo e($v->created_at->format('d/m/Y')); ?></small></td>
                            <td class="text-end">RD$ <?php echo e(number_format($v->total, 2)); ?></td>
                            <td class="text-end text-danger">RD$ <?php echo e(number_format($v->retencion_isr ?? 0, 2)); ?></td>
                            <td class="text-end text-danger">RD$ <?php echo e(number_format($v->retencion_itbis ?? 0, 2)); ?></td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/reportes/retenciones.blade.php ENDPATH**/ ?>