<?php $__env->startSection('title', 'Nuevo Certificado Digital'); ?>
...
<div class="ui-page">
    ...
    <div class="ui-card mb-5" style="--delay:.1s">
        ...
        <form id="certificadoForm" action="<?php echo e(route('certificados-digitales.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/certificados-digitales/create.blade.php ENDPATH**/ ?>