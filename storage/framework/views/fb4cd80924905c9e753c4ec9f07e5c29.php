<?php $__env->startSection('title', 'Editar Plantilla de Gasto'); ?>
...
<div class="ui-page" style="--accent:#8b5cf6;--accent-rgb:139,92,246;--accent-hover:#7c3aed;">
            ...
            <div class="ui-header-left">
                ...
                <div>
                    ...
                    <div class="ui-header-meta">
                        ...
                        <span><?php echo e($plantillaGasto->nombre); ?></span>
                    </div>
                </div>
            </div>
    ...
    <form id="plantillaForm" action="<?php echo e(route('plantilla-gastos.update', $plantillaGasto)); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                           value="<?php echo e(old('nombre', $plantillaGasto->nombre)); ?>" placeholder="Ej: Luz eléctrica mensual" required>
...
unset($__errorArgs, $__bag); ?>">
                                        <option value="1" <?php echo e(old('activo', $plantillaGasto->activo) == 1 ? 'selected' : ''); ?>>Activa</option>
                                        <option value="0" <?php echo e(old('activo', $plantillaGasto->activo) == 0 ? 'selected' : ''); ?>>Inactiva</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>"
                                          maxlength="500" placeholder="Detalle breve de esta plantilla..."><?php echo e(old('descripcion', $plantillaGasto->descripcion)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key); ?>" <?php echo e(old('categoria', $plantillaGasto->categoria) === $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <?php $__currentLoopData = $metodosPago; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key); ?>" <?php echo e(old('metodo_pago', $plantillaGasto->metodo_pago) === $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
...
unset($__errorArgs, $__bag); ?>"
                                           value="<?php echo e(old('comprobante', $plantillaGasto->comprobante)); ?>" maxlength="100" placeholder="Ej: FAC-0001">
...
unset($__errorArgs, $__bag); ?>"
                                          maxlength="2000" placeholder="Observaciones adicionales..."><?php echo e(old('notas', $plantillaGasto->notas)); ?></textarea>
                ...
                <div class="ui-card h-100" style="--delay:.2s">
                    ...
                    <div class="ui-card-body p-4">
                        ...
                        <div style="font-size:.875rem;color:#64748b;line-height:1.8;">
                            <p><strong class="text-dark">Creada:</strong> <?php echo e($plantillaGasto->created_at->format('d/m/Y H:i')); ?></p>
                            <p><strong class="text-dark">Última actualización:</strong> <?php echo e($plantillaGasto->updated_at->format('d/m/Y H:i')); ?></p>
                            <p><strong class="text-dark">Estado:</strong> 
                                <span class="badge <?php echo e($plantillaGasto->activo ? 'bg-success' : 'bg-secondary'); ?>">
                                    <?php echo e($plantillaGasto->activo ? 'Activa' : 'Inactiva'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/plantilla-gastos/edit.blade.php ENDPATH**/ ?>