<?php $__env->startSection('title', 'Centro de Reportes'); ?>
...
<div class="container-fluid px-4 ui-page" style="--accent:#8b5cf6;--accent-rgb:139,92,246;--accent-hover:#7c3aed;">
            ...
            <div class="ui-header-left">
                ...
                <div>
                    ...
                    <div class="ui-header-meta">
                        <?php if($sucursalActiva): ?>
                            Sucursal: <strong><?php echo e($sucursalActiva->nombre); ?></strong>
                        <?php else: ?>
                            Todas las sucursales
                        <?php endif; ?>
                        &middot; <?php echo e(now()->format('d/m/Y')); ?>
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-3 col-6">
            <div class="ui-stat text-center p-3">
                ...
                <div class="ui-stat-value">RD$ <?php echo e(number_format($ventasHoy, 2)); ?></div>
            </div>
        </div>
        <div class="col-md-3 col-6">
            <div class="ui-stat text-center p-3">
                ...
                <div class="ui-stat-value">RD$ <?php echo e(number_format($ventasMes, 2)); ?></div>
            </div>
        </div>
        <div class="col-md-3 col-6">
            <div class="ui-stat text-center p-3">
                ...
                <div class="ui-stat-value">RD$ <?php echo e(number_format($comprasMes, 2)); ?></div>
            </div>
        </div>
        <div class="col-md-3 col-6">
            <div class="ui-stat text-center p-3">
                ...
                <div class="ui-stat-value" style="color:#059669;">RD$ <?php echo e(number_format($utilidadMes, 2)); ?></div>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4 col-md-6">
            <a href="<?php echo e(route('reportes.compras')); ?>" class="text-decoration-none">
                <div class="ui-card h-100 report-card">
                    <div class="card-body p-4 text-center">
        ...
        <div class="col-lg-4 col-md-6">
            <a href="<?php echo e(route('reportes.stock')); ?>" class="text-decoration-none">
                <div class="ui-card h-100 report-card">
                    <div class="card-body p-4 text-center">
                        ...
                        <?php if($productosBajoStock > 0): ?>
                            <span class="badge bg-danger mt-2"><?php echo e($productosBajoStock); ?> producto(s) bajo stock</span>
                        <?php endif; ?>
                    </div>
                </div>
            </a>
        ...
        <div class="col-lg-4 col-md-6">
            <a href="<?php echo e(route('reportes.caja')); ?>" class="text-decoration-none">
                <div class="ui-card h-100 report-card">
                    <div class="card-body p-4 text-center">
                        ...
                        <?php if($sesionesAbiertas > 0): ?>
                            <span class="badge bg-success mt-2"><?php echo e($sesionesAbiertas); ?> sesión(es) abierta(s)</span>
                        <?php endif; ?>
                    </div>
                </div>
            </a>
        ...
        <div class="col-lg-4 col-md-6">
            <a href="<?php echo e(route('reportes.gastos')); ?>" class="text-decoration-none">
                <div class="ui-card h-100 report-card">
                    <div class="card-body p-4 text-center">
                        <div class="rounded-circle bg-warning bg-opacity-10 text-warning mx-auto d-flex align-items-center justify-content-center mb-3" style="width:64px;height:64px;">
        ...
        <div class="col-lg-4 col-md-6">
            <a href="<?php echo e(route('reportes.utilidades')); ?>" class="text-decoration-none">
                <div class="ui-card h-100 report-card">
                    <div class="card-body p-4 text-center">
        ...
        <div class="col-lg-4 col-md-6">
            <a href="<?php echo e(route('reportes.fiscales')); ?>" class="text-decoration-none">
                <div class="ui-card h-100 report-card">
                    <div class="card-body p-4 text-center">
        ...
        <div class="col-lg-4 col-md-6">
            <a href="<?php echo e(route('reportes.retenciones')); ?>" class="text-decoration-none">
                <div class="ui-card h-100 report-card">
                    <div class="card-body p-4 text-center">
        ...
        <div class="col-lg-4 col-md-6">
            <a href="<?php echo e(route('reportes.restaurante')); ?>" class="text-decoration-none">
                <div class="ui-card h-100 report-card">
                    <div class="card-body p-4 text-center">
        ...
        <div class="col-lg-4 col-md-6">
            <a href="<?php echo e(route('reportes.resumen')); ?>" class="text-decoration-none">
                <div class="ui-card h-100 report-card">
                    <div class="card-body p-4 text-center">
                        <div class="rounded-circle bg-primary bg-opacity-10 text-primary mx-auto d-flex align-items-center justify-content-center mb-3" style="width:64px;height:64px;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/reportes/index.blade.php ENDPATH**/ ?>