<?php $__env->startSection('title', 'Nuevo Tipo de Vehículo'); ?>
...
<div class="ui-page" style="--accent:#3b82f6;--accent-rgb:59,130,246;--accent-hover:#2563eb;">
    ...
    <form action="<?php echo e(route('vehiculo-tipos.store')); ?>" method="POST" id="instanceForm">
        <?php echo csrf_field(); ?>
        <div class="row g-4">
            <div class="col-lg-8">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('nombre')); ?>" required placeholder="Ej: Camión, Moto, Carro">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('codigo')); ?>" placeholder="Ej: CAM, MOT, CAR">
...
unset($__errorArgs, $__bag); ?>" rows="3" placeholder="Descripción del tipo de vehículo"><?php echo e(old('descripcion')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('capacidad_maxima')); ?>" min="0" step="0.01" placeholder="Ej: 5000">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/vehiculo-tipos/create.blade.php ENDPATH**/ ?>