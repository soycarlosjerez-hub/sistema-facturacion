<?php $__env->startSection('title', 'Ubicaciones de Mesas'); ?>
            ...
            <div class="ui-header-left">
                ...
                <div>
                    ...
                    <div class="ui-header-meta">
                        ...
                        <span><?php echo e($ubicaciones->count()); ?> ubicación(es)</span>
                    </div>
                </div>
            </div>
...
<script>
$(function() {
    const data = <?php echo json_encode($ubicaciones, 15, 512) ?>;
    ...
    document.getElementById('ubicacionModal').addEventListener('hidden.bs.modal', function() {
        ...
        document.getElementById('ubicacionForm').action = '<?php echo e(route("restaurante.ubicaciones.store")); ?>';
    });
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/restaurante/ubicaciones/index.blade.php ENDPATH**/ ?>