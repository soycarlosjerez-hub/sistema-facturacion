        ...
        <div class="waiting-card">
            ...
            <div class="waiting-details">
                <div class="detail-row">
                    ...
                    <span class="detail-value"><?php echo e($instance->nombre); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Tipo de Negocio</span>
                    <span class="detail-value"><?php echo e($instance->businessType?->nombre ?? 'N/A'); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Registrado</span>
                    <span class="detail-value"><?php echo e($instance->created_at->format('d/m/Y H:i')); ?></span>
                </div>
                <div class="detail-row">
            ...
            <div class="waiting-actions">
                ...
                <a href="<?php echo e(route('login')); ?>" class="btn-wait btn-wait-primary">
...
<?php /**PATH /var/www/html/sistema-facturacion/resources/views/solicitud-pendiente/index.blade.php ENDPATH**/ ?>