...
<head>
    <meta charset="UTF-8">
    <title>Recibimos tu referencia de transferencia</title>
    <style>
...
<div class="container">
    ...
    <div class="content">
        ...
        <p>Hemos recibido la referencia de transferencia de <strong><?php echo e($empresa); ?></strong>. Nuestro equipo la validar&aacute; en breve.</p>
        <div class="details">
            <p><strong>Monto:</strong> RD$ <?php echo e($monto); ?></p>
            <p><strong>Referencia:</strong> <?php echo e($referencia); ?></p>
        </div>
        <p>Una vez confirmada, su suscripci&oacute;n quedar&aacute; activa y recibir&aacute; una notificaci&oacute;n de confirmaci&oacute;n.</p>
...
</html><?php /**PATH /var/www/html/sistema-facturacion/resources/views/emails/transferencia-recibida.blade.php ENDPATH**/ ?>