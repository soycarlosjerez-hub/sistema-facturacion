<?php $__env->startSection('title', 'API Reference'); ?>
    ...
    <main class="api-main" id="apiMain">
        <div class="api-header">
            <div class="d-flex align-items-center gap-2 mb-2">
                ...
                <a href="<?php echo e(route('api.documentation.export')); ?>" class="btn btn-sm btn-outline-success rounded-pill ms-auto" title="Exportar documentación para IA">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/api/documentation.blade.php ENDPATH**/ ?>