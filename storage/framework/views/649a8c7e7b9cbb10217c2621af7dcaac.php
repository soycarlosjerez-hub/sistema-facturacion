...
<style>
    ...
    .perm-section-title {
        ...
        font-weight: 800; color: <?php echo e($cfg['color'] ?? '#f59e0b'); ?>;
...
<div class="container-fluid px-4 ui-page" style="--accent:#3b82f6;--accent-rgb:59,130,246;--accent-hover:#2563eb">
        ...
        <div class="row align-items-center" style="position:relative; z-index:2;">
            <div class="col-md-auto text-center text-md-start mb-3 mb-md-0">
                <div class="profile-avatar mx-auto mx-md-0">
                    <?php echo e(strtoupper(substr($usuario->name, 0, 1))); ?><?php echo e(strtoupper(substr(explode(' ', $usuario->name)[1] ?? '', 0, 1))); ?>
            ...
            <div class="col-md text-center text-md-start" style="position: relative; z-index: 2;">
                <div class="d-flex align-items-center gap-2 justify-content-center justify-content-md-start mb-2 flex-wrap">
                    <?php if($cfg): ?>
                        <span class="badge bg-white text-dark px-3 py-1 rounded-pill fw-bold" style="font-size: 0.75rem;">
                            <i class="bi <?php echo e($cfg['icon']); ?> me-1" style="color: <?php echo e($cfg['color']); ?>;"></i><?php echo e($cfg['label']); ?>
                ...
                <h2 class="fw-bold mb-1"><?php echo e($usuario->name); ?></h2>
                <p class="mb-0 opacity-90"><i class="bi bi-envelope me-1"></i><?php echo e($usuario->email); ?></p>
            </div>
            <div class="col-md-auto mt-3 mt-md-0 text-md-end" style="position: relative; z-index: 2;">
                <div class="d-flex gap-2 justify-content-center justify-content-md-end flex-wrap">
                    ...
                    <a href="<?php echo e(route('usuarios.edit', $usuario->id)); ?>" class="ui-btn ui-btn-solid ui-btn-sm rounded-pill">
    ...
    <div class="row g-3 mb-3">
        <div class="col-md-3 col-6">
            <div class="ui-stat p-3" style="--delay:.1s">
                ...
                <div class="ui-stat-value text-primary"><?php echo e($permisos->count()); ?></div>
                <small class="text-muted">de <?php echo e(Spatie\Permission\Models\Permission::count()); ?> totales</small>
            </div>
        </div>
        <div class="col-md-3 col-6">
            <div class="ui-stat p-3" style="--delay:.15s">
                <div class="ui-stat-label"><i class="bi bi-diagram-3 me-1"></i>Módulos</div>
                <div class="ui-stat-value text-info"><?php echo e($permGrouped->count()); ?></div>
        ...
        <div class="col-md-3 col-6">
            <div class="ui-stat p-3" style="--delay:.2s">
                ...
                <div class="ui-stat-value text-success"><?php echo e($usuario->created_at->format('d M Y')); ?></div>
        ...
        <div class="col-md-3 col-6">
            <div class="ui-stat p-3" style="--delay:.25s">
                ...
                <div class="ui-stat-value text-warning"><?php echo e($usuario->updated_at->format('d M Y')); ?></div>
                <small class="text-muted"><?php echo e($usuario->updated_at->diffForHumans()); ?></small>
            </div>
        </div>
    </div>
    ...
    <div class="ui-card" style="--delay:.3s">
        ...
        <div class="card-body p-4">
            <?php $__empty_0 = true; $__currentLoopData = $permGrouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modulo => $perms): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
                <div class="perm-section perm-filterable" data-text="<?php echo e(strtolower($modulo)); ?>">
                    <div class="perm-section-title">
                        <i class="bi bi-folder2-open"></i>
                        <?php echo e(ucfirst($modulo)); ?> <span class="text-muted ms-1" style="font-size: 0.7rem;">(<?php echo e($perms->count()); ?>)</span>
                    </div>
                    <div>
                        <?php $__currentLoopData = $perms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <span class="perm-pill <?php echo e($cls); ?> perm-filterable" data-text="<?php echo e(strtolower($p->name)); ?>">
                                <i class="bi bi-check2"></i> <?php echo e(str_replace($modulo.'.', '', $p->name)); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/usuarios/show.blade.php ENDPATH**/ ?>