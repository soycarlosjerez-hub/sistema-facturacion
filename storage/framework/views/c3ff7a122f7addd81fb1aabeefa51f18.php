...
<div class="container-fluid px-4 py-3 premium-page">
    ...
    <form action="<?php echo e(route('alquileres.pagos.store')); ?>" method="POST" id="instanceForm">
        <?php echo csrf_field(); ?>
        <div class="row g-4">
            <div class="col-lg-8">
                        ...
                        <div class="row g-3">
                                ...
                                <div class="form-floating-modern">
                                    ...
                                    <select name="contrato_id" id="contrato_id" class="form-control" required>
                                        ...
                                        <?php $__currentLoopData = $contratos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contrato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($contrato->id); ?>" <?php echo e(old('contrato_id')==$contrato->id?'selected':''); ?>>
                                                <?php echo e($contrato->vivienda->nombre); ?> - <?php echo e($contrato->inquilino->nombre); ?> (RD$ <?php echo e(number_format($contrato->monto_alquiler, 2)); ?>)
                                            </option>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating-modern">
                                    ...
                                    <input type="number" step="0.01" name="monto" id="monto" class="form-control" value="<?php echo e(old('monto')); ?>" placeholder=" " required>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating-modern">
                                    ...
                                    <input type="date" name="fecha_pago" id="fecha_pago" class="form-control" value="<?php echo e(old('fecha_pago', date('Y-m-d'))); ?>" required>
                                ...
                                <div class="form-floating-modern">
                                    ...
                                    <select name="mes_cobrado" id="mes_cobrado" class="form-control" required>
                                        <?php $__currentLoopData = ['Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $mes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($index+1); ?>" <?php echo e(old('mes_cobrado',date('n'))==$index+1?'selected':''); ?>><?php echo e($mes); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-floating-modern">
                                    ...
                                    <input type="number" name="ano_cobrado" id="ano_cobrado" class="form-control" value="<?php echo e(old('ano_cobrado', date('Y'))); ?>" min="2020" max="2100" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-floating-modern">
                                    ...
                                    <select name="metodo_pago" id="metodo_pago" class="form-control" required>
                                        ...
                                        <option value="deposito" <?php echo e(old('metodo_pago')=='deposito'?'selected':''); ?>>Dep�sito</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating-modern">
                                    ...
                                    <input type="text" name="recibo_numero" id="recibo_numero" class="form-control" value="<?php echo e(old('recibo_numero')); ?>" placeholder=" ">
                            ...
                            <div class="col-12">
                                <div class="form-floating-modern">
                                    ...
                                    <textarea name="notas" id="notas" class="form-control" placeholder=" " rows="2"><?php echo e(old('notas')); ?></textarea>
...
<div class="premium-sticky-bar">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="<?php echo e(route('alquileres.pagos.index')); ?>" class="btn-cancel me-2">Cancelar</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/alquileres/pagos/create.blade.php ENDPATH**/ ?>