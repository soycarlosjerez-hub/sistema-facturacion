<?php $__env->startSection('title', 'Programas de Auditoría'); ?>
    ...
    <div class="ui-header mb-4" style="--delay:0s">
        ...
        <div class="ui-header-body">
            ...
            <div class="ui-header-actions">
                <a href="<?php echo e(route('sgc.auditorias.programas.create')); ?>" class="ui-btn ui-btn-primary ui-btn-sm rounded-pill">
        ...
        <div class="ui-card-body p-0">
            <table class="dt-table datatable" id="programas-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><code><?php echo e($prog->ano_label); ?></code></td>
                        <td><?php echo e($prog->descripcion_truncada ?: '-'); ?></td>
                        <td><?php echo e($prog->auditor_jefe_label); ?></td>
                        <td><?php echo e($prog->periodo_label); ?></td>
                        <td>
                            <span class="badge bg-primary bg-opacity-10 text-primary" style="font-size:.7rem;"><?php echo e($prog->auditorias_count); ?></span>
                            <?php if($prog->completadas_count > 0): ?>
                            <span class="badge bg-success bg-opacity-10 text-success" style="font-size:.65rem;"><?php echo e($prog->completadas_count); ?> OK</span>
                            <?php endif; ?>
                        </td>
                        <td><span class="badge-status badge-<?php echo e($prog->estado); ?>"><?php echo e($prog->estado_label); ?></span></td>
                    </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/sgc/auditorias/programas/index.blade.php ENDPATH**/ ?>