...
<div class="ui-page" style="--accent:#6366f1;--accent-rgb:99,102,241;--accent-hover:#4f46e5;">
    ...
    <form id="cotizacion-form" action="<?php echo e(route('cotizaciones.store')); ?>" method="POST" autocomplete="off">
        <?php echo csrf_field(); ?>
        <div class="row g-3">
                    ...
                    <div class="ui-card-body">
                        <div class="row g-3">
                            <div class="col-md-3">
                                ...
                                <input type="text" class="ui-input" value="<?php echo e($numero); ?>" disabled>
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="date" name="fecha_validez" class="ui-input" value="<?php echo e(old('fecha_validez', date('Y-m-d', strtotime('+15 days')))); ?>" required>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="ui-card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <textarea name="notas" class="ui-input" rows="3" placeholder="Notas internas..."><?php echo e(old('notas')); ?></textarea>
                            </div>
                            <div class="col-md-6">
                                <label class="ui-label small fw-semibold">
                                    <i class="bi bi-file-text me-1"></i> Términos y Condiciones
                                </label>
                                <textarea name="condiciones" class="ui-input" rows="3" placeholder="Ej: Validez 15 días, pago 50% anticipado..."><?php echo e(old('condiciones', 'Precios incluyen ITBIS. Validez de la oferta: 15 días.')); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="d-flex justify-content-between mb-2 align-items-center">
                            ...
                            <div class="ui-input-group input-group-sm" style="width: 130px;">
                                ...
                                <input type="number" name="descuento" id="descuento" class="ui-input text-end" 
                                       value="<?php echo e(old('descuento', 0)); ?>" min="0" step="0.01">
                            </div>
                        </div>
                        <hr>
    ...
    <div class="ui-sticky-bar d-flex justify-content-end align-items-center gap-3">
        ...
        <a href="<?php echo e(route('cotizaciones.index')); ?>" class="ui-btn ui-btn-ghost rounded-pill px-4">Cancelar</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/cotizaciones/create.blade.php ENDPATH**/ ?>