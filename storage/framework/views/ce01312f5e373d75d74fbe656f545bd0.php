<?php $__env->startSection('title', 'Nueva Instalación'); ?>
...
<div class="ui-page" style="--accent:#06b6d4;--accent-rgb:6,182,212;--accent-hover:#0891b2;">
    ...
    <div class="ui-card" style="--delay:.1s;max-width:960px;margin:0 auto;">
        ...
        <div class="ui-card-body">
            <form action="<?php echo e(route('climatizacion.instalaciones.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('programada_para')); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('direccion_instalacion')); ?>" placeholder="Dirección donde se realizará la instalación" maxlength="300">
...
unset($__errorArgs, $__bag); ?>" rows="3" placeholder="Instrucciones u observaciones internas..." maxlength="2000"><?php echo e(old('nota_interna')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="ui-sticky-bar" style="position:sticky;bottom:0;left:0;right:0;background:rgba(255,255,255,.85);backdrop-filter:blur(20px);border-top:2px solid #06b6d4;padding:.7rem 1.5rem;z-index:1050;box-shadow:0 -4px 20px rgba(0,0,0,.08);margin:0 -1.75rem -1.5rem;border-radius:0 0 var(--radius-2xl) var(--radius-2xl);">
                    <div class="ui-sticky-bar-inner">
                        <a href="<?php echo e(route('climatizacion.instalaciones.index')); ?>" class="ui-btn ui-btn-ghost"><i class="bi bi-x-lg"></i> Cancelar</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/climatizacion/instalaciones/create.blade.php ENDPATH**/ ?>