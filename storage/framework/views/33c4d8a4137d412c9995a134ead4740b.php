...
<div class="ui-page" style="--accent:#6366f1;--accent-rgb:99,102,241;--accent-hover:#4f46e5;">
    <div class="ui-header mb-4" style="--delay:0s">
        ...
        <div class="ui-header-body">
            ...
            <div class="ui-header-actions">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('tecnicos.create')): ?>
                <a href="<?php echo e(route('tecnicos.create')); ?>" class="ui-btn ui-btn-primary ui-btn-sm rounded-pill">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="ui-stat">
                <div class="ui-stat-body">
                    ...
                    <div class="ui-stat-value"><?php echo e($tecnicos->total() ?? 0); ?></div>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6">
            <div class="ui-stat">
                <div class="ui-stat-body">
                    ...
                    <div class="ui-stat-value" style="color:#22c55e;">
                        <?php echo e($tecnicos->where('activo', true)->count()); ?>
            ...
            <div class="ui-stat">
                <div class="ui-stat-body">
                    ...
                    <div class="ui-stat-value" style="color:#64748b;">
                        <?php echo e($tecnicos->where('activo', false)->count()); ?>
            ...
            <div class="ui-stat">
                <div class="ui-stat-body">
                    ...
                    <div class="ui-stat-value" style="color:#8b5cf6;">
                        RD$ <?php echo e(number_format($tecnicos->avg('tarifa_hora') ?? 0, 2)); ?>
    ...
    <div class="ui-card mb-4" style="--delay:.1s">
        ...
        <div class="card-body p-3">
            <form method="GET" action="<?php echo e(route('tecnicos.index')); ?>" id="filtros-form" class="row g-2 align-items-end">
                <div class="col-lg-4">
                    <label class="ui-label small fw-bold text-muted">Buscar</label>
                    <div class="ui-input-group">
                        <span class="ui-input-group-text"><i class="bi bi-search"></i></span>
                        <input type="text" name="search" class="ui-input" placeholder="Nombre, cédula, teléfono, email..." value="<?php echo e(request('search')); ?>" autocomplete="off">
                    </div>
                </div>
                <div class="col-lg-3">
                    ...
                    <select name="especialidad" class="ui-select">
                        ...
                        <?php $__currentLoopData = $especialidades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $esp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($esp->nombre); ?>" <?php echo e(request('especialidad') === $esp->nombre ? 'selected' : ''); ?>><?php echo e($esp->nombre); ?></option>
                ...
                <div class="col-lg-2 d-flex gap-2">
                    ...
                    <a href="<?php echo e(route('tecnicos.index')); ?>" class="ui-btn ui-btn-ghost"><i class="bi bi-x-lg"></i></a>
                </div>
            </form>
        </div>
    </div>
...
$(function() {
    const table = $('#tecnicos-table').DataTable({
        serverSide: true,
        ajax: {
            url: '<?php echo e(route('tecnicos.index')); ?>',
            type: 'GET',
            data: function(d) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/tecnicos/index.blade.php ENDPATH**/ ?>