<?php $__env->startSection('title', 'Órdenes de Emergencia'); ?>
    ...
    <div class="ui-header" style="--delay:0s">
        ...
        <div class="ui-header-body">
            ...
            <div class="ui-header-actions">
                <a href="<?php echo e(route('climatizacion.ordenes-emergencia.create')); ?>" class="ui-btn ui-btn-primary ui-btn-sm rounded-pill">
        ...
        <div class="col-sm-6">
            <div class="ui-stat" style="--delay:.05s">
                ...
                <div class="ui-stat-body text-center">
                    ...
                    <div class="ui-stat-value"><?php echo e($criticas); ?></div>
        ...
        <div class="col-sm-6">
            <div class="ui-stat" style="--delay:.1s">
                ...
                <div class="ui-stat-body text-center">
                    ...
                    <div class="ui-stat-value"><?php echo e($activas); ?></div>
        ...
        <div class="ui-card-body">
            <form method="GET" class="row g-2 align-items-end">
                <div class="col-lg-3">
                    ...
                    <input type="text" name="search" class="ui-input" placeholder="Código, cliente, dirección..." value="<?php echo e(request('search')); ?>" autocomplete="off">
                </div>
                <div class="col-lg-2">
                    ...
                    <select name="prioridad" class="ui-select">
                        ...
                        <?php $__currentLoopData = \App\Models\OrdenEmergencia::PRIORIDADES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($key); ?>" <?php echo e(request('prioridad') === $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                ...
                <div class="col-lg-2">
                    ...
                    <select name="tipo_falla" class="ui-select">
                        ...
                        <?php $__currentLoopData = \App\Models\OrdenEmergencia::TIPOS_FALLA; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($key); ?>" <?php echo e(request('tipo_falla') === $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="col-lg-3 d-flex gap-2">
                    ...
                    <a href="<?php echo e(route('climatizacion.ordenes-emergencia.index')); ?>" class="ui-btn ui-btn-ghost ui-btn-sm rounded-pill">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="fw-bold" style="color:var(--accent);">
                                <a href="<?php echo e(route('climatizacion.ordenes-emergencia.show', $orden)); ?>" class="text-decoration-none" style="color:inherit;">
                                    <?php echo e($orden->codigo); ?>

                                </a>
                            </td>
                            <td>
                                <div class="fw-medium"><?php echo e($orden->cliente?->nombre ?? '—'); ?></div>
                                <?php if($orden->contacto_telefono): ?>
                                    <small class="text-muted"><?php echo e($orden->contacto_telefono); ?></small>
                                <?php endif; ?>
                            </td>
                            <td>
                                <?php
                                ...
                                ?>
                                <span class="badge rounded-pill <?php echo e($prioridadClass); ?>">
                                    <?php echo e(\App\Models\OrdenEmergencia::PRIORIDADES[$orden->prioridad] ?? $orden->prioridad); ?>

                                </span>
                            </td>
                            <td>
                                <span class="small"><?php echo e(\App\Models\OrdenEmergencia::TIPOS_FALLA[$orden->tipo_falla] ?? $orden->tipo_falla); ?></span>
                            </td>
                            <td>
                                <span class="small text-muted d-block" style="max-width:180px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;" title="<?php echo e($orden->direccion); ?>">
                                    <?php echo e($orden->direccion ?: '—'); ?>
                            ...
                            <td>
                                ...
                                ?>
                                <span class="ui-badge <?php echo e($estadoBadge); ?>">
                            ...
                            <td class="text-end pe-4">
                                <div class="d-flex justify-content-end gap-1">
                                    <a href="<?php echo e(route('climatizacion.ordenes-emergencia.show', $orden)); ?>"
                                       class="ui-action ui-action-view" title="Ver detalle">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <?php if($orden->estado !== 'cerrada'): ?>
                                        <a href="<?php echo e(route('climatizacion.ordenes-emergencia.edit', $orden)); ?>"
                                           class="ui-action ui-action-edit" title="Editar">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                    <?php endif; ?>
                                    <form action="<?php echo e(route('climatizacion.ordenes-emergencia.destroy', $orden)); ?>"
                                          method="POST" class="d-inline"
                                          onsubmit="return UI?.confirm?.delete?.('<?php echo e(route('climatizacion.ordenes-emergencia.destroy', $orden)); ?>', '<?php echo e(addslashes($orden->codigo)); ?>') || confirm('¿Eliminar <?php echo e(addslashes($orden->codigo)); ?>?');">
                        ...
                        <tr>
                            <td colspan="10">
                                <div class="ui-empty-state">
                                    ...
                                    <a href="<?php echo e(route('climatizacion.ordenes-emergencia.create')); ?>" class="ui-btn ui-btn-solid ui-btn-sm mt-2 rounded-pill">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/climatizacion/emergencias/index.blade.php ENDPATH**/ ?>