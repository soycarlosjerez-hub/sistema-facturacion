<?php $__env->startSection('title', 'Nuevo Repartidor'); ?>
...
<div class="ui-page" style="--accent:#0ea5e9;--accent-rgb:14,165,233;--accent-hover:#0284c7;">
    <div class="ui-header mb-4" style="--delay:0s">
        ...
        <div class="ui-header-body">
            <div class="ui-header-left">
                ...
                <div>
                    <h4 class="ui-header-title">Nuevo Repartidor</h4>
                    <div class="ui-header-meta">
                        <i class="bi bi-plus-circle me-1"></i>
                        <span>Registrar un nuevo repartidor en el sistema</span>
                    </div>
                </div>
            </div>
    ...
    <div class="ui-card mb-5" style="--delay:.1s">
        ...
        <form id="driverForm" method="POST" action="<?php echo e(route('delivery-drivers.store')); ?>">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('nombre')); ?>" required maxlength="100" placeholder="Ej: Juan">
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('apellido')); ?>" required maxlength="100" placeholder="Ej: Pérez">
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('cedula')); ?>" required maxlength="20" placeholder="Ej: 001-0000000-0">
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('licencia_conducir')); ?>" maxlength="30" placeholder="Ej: A-II-12345">
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('telefono')); ?>" required maxlength="20" placeholder="Ej: 809-000-0000">
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('whatsapp')); ?>" maxlength="20" placeholder="Ej: 809-000-0000">
...
unset($__errorArgs, $__bag); ?>"
                              rows="3" maxlength="500" placeholder="Notas internas sobre el repartidor..."><?php echo e(old('notas')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-check form-switch mt-2">
                    <input type="checkbox" name="activo" id="activo" class="form-check-input" value="1" <?php echo e(old('activo', true) ? 'checked' : ''); ?>>
...
<div class="ui-sticky-bar">
    <div class="ui-sticky-bar-inner">
        ...
        <button type="submit" form="driverForm" class="ui-btn ui-btn-solid ui-btn-sm rounded-pill">
            <i class="bi bi-check-lg me-2"></i>Guardar Repartidor
        </button>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/delivery-drivers/create.blade.php ENDPATH**/ ?>