    ...
    <div class="ui-header" style="--delay:0s;">
        ...
        <div class="ui-header-body">
            ...
            <div class="ui-header-actions">
                <a href="<?php echo e(route('climatizacion.mantenimientos.export')); ?>" class="ui-btn ui-btn-primary" title="Exportar Excel">
                    <i class="bi bi-download me-1"></i> Exportar
                </a>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('mantenimientos.create')): ?>
                <a href="<?php echo e(route('climatizacion.mantenimientos.create')); ?>" class="ui-btn ui-btn-solid rounded-pill">
        ...
        <div class="ui-card-body">
            <form method="GET" class="row g-3 align-items-end">
                <div class="col-md-4">
                    ...
                    <input type="text" name="search" class="ui-input" placeholder="Número, cliente o falla..." value="<?php echo e(request('search')); ?>">
                </div>
                <div class="col-md-3">
                    ...
                    <select name="tipo" class="ui-select">
                        ...
                        <?php $__currentLoopData = \App\Models\Mantenimiento::TIPOS; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($val); ?>" <?php echo e(request('tipo') === $val ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                ...
                <div class="col-md-2 d-flex gap-2">
                    ...
                    <a href="<?php echo e(route('climatizacion.mantenimientos.index')); ?>" class="ui-btn ui-btn-ghost flex-fill">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    $('#mantenimientosTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo e(route("climatizacion.mantenimientos.index")); ?>',
            data: function(d) {
                d.search = '<?php echo e(request("search")); ?>';
                d.tipo = '<?php echo e(request("tipo")); ?>';
                d.estado = '<?php echo e(request("estado")); ?>';
            }
        },
        columns: [
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/climatizacion/mantenimientos/index.blade.php ENDPATH**/ ?>