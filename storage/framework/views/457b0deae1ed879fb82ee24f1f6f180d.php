<?php $__env->startSection('title', 'Secuencias de e-CF'); ?>
...
<div class="container-fluid px-4 ui-page" style="--accent:#8b5cf6;--accent-rgb:139,92,246;--accent-hover:#7c3aed">
    <div class="ui-header mb-4" style="--delay:0s">
        ...
        <div class="ui-header-body">
            ...
            <div class="ui-header-actions">
                <a href="<?php echo e(route('ecf.index')); ?>" class="ui-btn ui-btn-primary ui-btn-sm rounded-pill"><i class="bi bi-receipt me-1"></i>Ver Documentos</a>
                <a href="<?php echo e(route('secuencias-ecf.create')); ?>" class="ui-btn ui-btn-primary ui-btn-sm rounded-pill"><i class="bi bi-plus-lg me-1"></i>Nueva Secuencia</a>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <div class="ui-stat-value"><?php echo e($stats['activas']); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <div class="ui-stat-value"><?php echo e($stats['vencidas']); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <div class="ui-stat-value"><?php echo e($stats['agotadas']); ?></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row g-3">
        <?php $__empty_0 = true; $__currentLoopData = $secuencias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?>
        <div class="col-xl-4 col-md-6">
            <div class="ui-card h-100 overflow-hidden position-relative
                <?php echo e($sec->vencida() ? 'border-top border-4 border-warning' : ($sec->agotada() ? 'border-top border-4 border-danger' : 'border-top border-4 border-primary')); ?>" style="--delay:.1s">
                <div class="ui-card-accent"></div>
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <div>
                            <span class="badge bg-primary bg-opacity-10 text-primary px-3 py-2 rounded-pill fw-bold fs-6">
                                <?php echo e($sec->tipo_ecf); ?>

                            </span>
                            <h5 class="fw-bold mt-2 mb-0"><?php echo e($sec->nombre); ?></h5>
                            <small class="text-muted"><?php echo e(\App\Models\SecuenciaEcf::TIPOS[$sec->tipo_ecf] ?? ''); ?></small>
                        </div>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg rounded-3">
                                <li><a class="dropdown-item" href="<?php echo e(route('secuencias-ecf.edit', $sec)); ?>"><i class="bi bi-pencil me-2"></i>Editar</a></li>
                                <li>
                                    <form action="<?php echo e(route('secuencias-ecf.toggle', $sec)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <button class="dropdown-item <?php echo e($sec->activo ? 'text-danger' : 'text-success'); ?>">
                                            <i class="bi <?php echo e($sec->activo ? 'bi-slash-circle' : 'bi-check-circle'); ?> me-2"></i>
                                            <?php echo e($sec->activo ? 'Desactivar' : 'Activar'); ?>
                                ...
                                <li>
                                    <form action="<?php echo e(route('secuencias-ecf.destroy', $sec)); ?>" method="POST" onsubmit="return UI.confirm.delete('¿Eliminar esta secuencia?')">
                    ...
                    <?php if($sec->vencida()): ?>
                        <div class="alert alert-warning border-0 rounded-3 py-2 small mb-3">
                            <i class="bi bi-clock-history me-1"></i>Vencida el <?php echo e($sec->fecha_vencimiento->format('d/m/Y')); ?>

                        </div>
                    <?php elseif($sec->agotada()): ?>
                    ...
                    <?php else: ?>
                        <div class="alert alert-success border-0 rounded-3 py-2 small mb-3">
                            <i class="bi bi-check-circle me-1"></i>Vence <?php echo e($sec->fecha_vencimiento->format('d/m/Y')); ?>

                        </div>
                    <?php endif; ?>

                    <?php $uso = $sec->porcentajeUso(); ?>
                    <div class="mb-2 d-flex justify-content-between align-items-end">
                        <small class="text-muted fw-bold" style="font-size:0.7rem;">CONSUMO</small>
                        <span class="fw-bold small"><?php echo e(number_format($uso, 1)); ?>%</span>
                    </div>
                    <div class="progress rounded-pill mb-3" style="height: 8px; background: #f1f5f9;">
                        <div class="progress-bar <?php echo e($uso > 85 ? 'bg-danger' : ($uso > 60 ? 'bg-warning' : 'bg-success')); ?>"
                             style="width: <?php echo e($uso); ?>%"></div>
                    </div>
                    ...
                    <div class="row g-2 text-center small">
                        <div class="col-4">
                            <div class="bg-light rounded-3 p-2">
                                ...
                                <span class="fw-bold"><?php echo e(str_pad($sec->desde, 10, '0', STR_PAD_LEFT)); ?></span>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="bg-primary bg-opacity-10 rounded-3 p-2">
                                <small class="text-muted d-block">Próximo</small>
                                <span class="fw-bold text-primary"><?php echo e($sec->tipo_ecf); ?><?php echo e(str_pad($sec->actual + 1, 10, '0', STR_PAD_LEFT)); ?></span>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="bg-light rounded-3 p-2">
                                <small class="text-muted d-block">Hasta</small>
                                <span class="fw-bold"><?php echo e(str_pad($sec->hasta, 10, '0', STR_PAD_LEFT)); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-12 text-center py-5">
            ...
            <a href="<?php echo e(route('secuencias-ecf.create')); ?>" class="ui-btn ui-btn-solid rounded-pill">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/secuencias-ecf/index.blade.php ENDPATH**/ ?>