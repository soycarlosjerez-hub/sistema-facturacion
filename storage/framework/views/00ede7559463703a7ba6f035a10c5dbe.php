<?php $__env->startSection('title', 'Importar Categorías'); ?>
...
<div class="ui-page" style="--accent:#ec4899;--accent-rgb:236,72,153;--accent-hover:#db2777;">
    ...
    <div class="ui-card mb-4" style="--delay:.1s;">
        ...
        <div class="card-body p-4">
            <form action="<?php echo e(route('categorias.importar.procesar')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/sistema-facturacion/resources/views/categorias/import.blade.php ENDPATH**/ ?>