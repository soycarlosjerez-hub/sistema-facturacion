    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="fw-bold mb-1"><i class="bi bi-arrow-return-left text-primary me-2"></i>Nueva Devoluci&oacute;n</h2>
                    <p class="text-muted mb-0">Registra la devoluci&oacute;n de productos de una venta.</p>
                </div>
                <a href="{{ route('devoluciones.index') }}" class="btn btn-light rounded-pill px-4 shadow-sm fw-bold">
                ...
                <div class="card border-0 shadow-sm rounded-4 mb-4">
                    ...
                    <div class="card-footer bg-light border-top border-light p-4 text-end">
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('devoluciones.index') }}" class="btn btn-light rounded-pill px-4">Cancelar</a>
