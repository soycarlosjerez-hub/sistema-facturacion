    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">{{ $m->almacen->nombre }}</td>
                <td class="text-center {{ $m->tipo }}">{{ ucfirst($m->tipo) }}</td>
                <td class="text-center {{ $m->tipo }}">{{ $m->tipo === 'entrada' ? '+' : '-' }}{{ $m->cantidad }}</td>
                <td>{{ $m->nota ?? $m->motivo ?? 'Movimiento de inventario' }}</td>
