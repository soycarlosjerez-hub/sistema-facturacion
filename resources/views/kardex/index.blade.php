...
<div class="container-fluid px-4 py-4">
    ...
    <div class="filter-card p-4 mb-4">
        <form method="GET" id="search-form" class="row g-3 align-items-end">
            <div class="col-lg-3">
                <label class="form-label text-muted small fw-bold text-uppercase tracking-wider">Buscar por nota</label>
                <div class="input-group">
                    <span class="input-group-text bg-white border-end-0 text-muted"><i class="bi bi-search"></i></span>
                    <input type="text" name="buscar" id="busqueda-kardex" class="form-control border-start-0 ps-0" 
                           placeholder="Concepto o nota..." value="{{ request('buscar') }}" autocomplete="off">
                </div>
            </div>
            <div class="col-lg-3">
                <label class="form-label text-muted small fw-bold text-uppercase tracking-wider">Producto</label>
                <select name="producto_id" class="form-select bg-white">
            ...
            <div class="col-lg-3">
                ...
                <select name="almacen_id" class="form-select bg-white">
            ...
            <div class="col-lg-3 d-flex gap-2">
                ...
                <a href="{{ route('kardex.index') }}" class="btn btn-outline-secondary rounded-circle" style="width: 38px; height: 38px; display: flex; align-items: center; justify-content: center;" title="Limpiar Filtros"><i class="bi bi-arrow-counterclockwise"></i></a>
            </div>
        </form>
    </div>

    <!-- Lista de Movimientos -->
    <div class="table-responsive" style="min-height: 400px;" id="kardex-container">
        <table class="table table-custom mb-0 w-100">
            <thead class="text-muted small text-uppercase tracking-wider" style="border-bottom: 2px solid #e2e8f0;">
                <tr>
                    ...
                    <th class="pb-3 text-center">Almacén</th>
            ...
            <tbody id="kardex-tbody">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <span class="status-badge bg-light text-secondary border d-inline-block">
