...
<div class="container-fluid px-4">
    <div class="premium-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h3 class="fw-bold mb-1"><i class="bi bi-pencil me-2"></i>Editar Instancia</h3>
    ...
    <!-- Danger Zone -->
    <div class="card border-0 shadow-sm rounded-4 mt-5 overflow-hidden" style="border-left: 4px solid #dc2626 !important;">
