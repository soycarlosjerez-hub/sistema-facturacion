...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-bold mb-1"><i class="bi bi-plus-circle text-success me-2"></i>Nueva Instancia</h2>
            <p class="text-muted mb-0">Crear una nueva instancia de negocio multi-tenant.</p>
        </div>
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('owner.instances.store') }}">
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-6">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('owner.instances.index') }}" class="btn btn-light rounded-pill px-4">Cancelar</a>
