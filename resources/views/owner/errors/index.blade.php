        ...
        <div class="card-body p-3">
            <form method="GET" class="row g-2 align-items-end">
                <div class="col-md-2">
                    ...
                    <select name="instance_id" class="form-select form-select-sm">
                        ...
                        @foreach($instances as $inst)
                            <option value="{{ $inst->id }}" {{ request('instance_id') == $inst->id ? 'selected' : '' }}>{{ $inst->nombre }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-2">
                    ...
                    <input type="text" name="search" class="form-control form-control-sm" placeholder="Mensaje..." value="{{ request('search') }}">
                </div>
                <div class="col-md-1">
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr class="error-row" data-bs-toggle="modal" data-bs-target="#errorModal{{ $log->id }}">
                            <td>
                                <small class="fw-bold">{{ $log->tenant?->nombre ?? '—' }}</small>
                            </td>
                            ...
                            <td class="text-truncate" style="max-width:280px;">{{ $log->title }}</td>
            ...
            <div class="modal-body">
                <div class="row g-3 mb-3">
                    <div class="col-md-4">
                        ...
                        <span class="fw-bold">{{ $log->tenant?->nombre ?? '—' }}</span>
                    </div>
                    <div class="col-md-4">
