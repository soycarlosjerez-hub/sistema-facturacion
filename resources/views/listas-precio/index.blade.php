...
<div class="container-fluid px-4 py-4">
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="price-card h-100 d-flex flex-column p-4">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <div class="icon-wrapper">
                        <i class="bi bi-tag-fill"></i>
                    </div>
                    <div class="dropdown">
                        <button class="btn btn-light rounded-circle shadow-sm" style="width: 35px; height: 35px; display: flex; align-items: center; justify-content: center;" data-bs-toggle="dropdown">
                ...
                <div class="border-top pt-3 mt-3">
                    ...
                    <a href="{{ route('listas-precio.show', $lista) }}" class="btn btn-primary bg-opacity-10 text-primary border-0 w-100 rounded-pill fw-bold hover-bg-primary transition">
