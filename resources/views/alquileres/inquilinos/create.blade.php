                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="ui-input-group">
                                        ...
                                        <input type="text" name="nombre" id="nombre" class="ui-input @error('nombre') is-invalid @enderror" value="{{ old('nombre') }}" placeholder="" required>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="ui-input-group">
                                        ...
                                        <input type="text" name="cedula" id="cedula" class="ui-input" value="{{ old('cedula') }}" placeholder="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="ui-input-group">
                                        ...
                                        <input type="text" name="telefono" id="telefono" class="ui-input" value="{{ old('telefono') }}" placeholder="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="ui-input-group">
                                        ...
                                        <input type="email" name="email" id="email" class="ui-input" value="{{ old('email') }}" placeholder="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="ui-input-group">
                                        ...
                                        <input type="text" name="direccion" id="direccion" class="ui-input" value="{{ old('direccion') }}" placeholder="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="ui-input-group">
                                        ...
                                        <textarea name="notas" id="notas" class="ui-textarea" placeholder="" rows="3">{{ old('notas') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="ui-sticky-bar">
    <div class="ui-sticky-bar-inner">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="{{ route('alquileres.inquilinos.index') }}" class="ui-btn ui-btn-ghost rounded-pill me-2">Cancelar</a>
