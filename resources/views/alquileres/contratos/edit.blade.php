...
<div class="container-fluid px-4 py-3 premium-page">
    <div class="premium-header mb-4" style="background: linear-gradient(135deg, #f59e0b, #f97316);">
        ...
        <div class="d-flex align-items-center gap-3 position-relative" style="z-index:2;">
            ...
            <div><h4 class="fw-bold mb-1 text-white">Contrato #{{ $contrato->id }}</h4><small class="text-white opacity-75">Editando contrato de alquiler</small></div>
        </div>
    </div>
    ...
    <form action="{{ route('alquileres.contratos.update', $contrato) }}" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <div class="form-floating-modern">
                                    ...
                                    <input type="date" name="fecha_inicio" id="fecha_inicio" class="form-control" value="{{ old('fecha_inicio', $contrato->fecha_inicio->format('Y-m-d')) }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-floating-modern">
                                    ...
                                    <input type="date" name="fecha_fin" id="fecha_fin" class="form-control" value="{{ old('fecha_fin', $contrato->fecha_fin?->format('Y-m-d')) }}">
                                    <label class="form-label-float" for="fecha_fin">Fecha Fin</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-floating-modern">
                            ...
                            <div class="col-md-4">
                                <div class="form-floating-modern">
                                    ...
                                    <input type="number" name="dia_pago" id="dia_pago" class="form-control" value="{{ old('dia_pago', $contrato->dia_pago) }}" min="1" max="31">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="form-floating-modern">
                                    ...
                                    <input type="number" step="0.01" name="monto_alquiler" id="monto_alquiler" class="form-control" value="{{ old('monto_alquiler', $contrato->monto_alquiler) }}" placeholder=" " required>
                            ...
                            <div class="col-12">
                                <div class="form-floating-modern">
                                    ...
                                    <input type="number" step="0.01" name="monto_deposito" id="monto_deposito" class="form-control" value="{{ old('monto_deposito', $contrato->monto_deposito) }}" placeholder=" ">
                            ...
                            <div class="col-12">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="deposito_pagado">Dep�sito pagado</label>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="mt-4 d-flex gap-2">
            <button type="submit" class="btn btn-primary rounded-pill px-5 fw-bold shadow-sm" style="background:linear-gradient(135deg,#f59e0b,#f97316);border:0;"><i class="bi bi-save me-1"></i>Guardar Cambios</button>
