                            ...
                            <div class="tab-pane fade" id="tabItems">
                                <div class="row g-3">
                                    <div class="historial-columns" style="display: none;">
                                        <div class="col-md-4">
                                            <label class="toggle-switch">
                                                <input type="checkbox" name="mostrar_columna_ncf" value="1" {{ old('mostrar_columna_ncf') ? 'checked' : '' }}>
                                                <span class="toggle-slider"></span>
                                        ...
                                        <div class="col-md-4">
                                            <label class="toggle-switch">
                                                <input type="checkbox" name="mostrar_columna_cajero" value="1" {{ old('mostrar_columna_cajero') ? 'checked' : '' }}>
                                                <span class="toggle-slider"></span>
                                        ...
                                        <div class="col-md-4">
                                            <label class="toggle-switch">
                                                <input type="checkbox" name="mostrar_columna_sucursal" value="1" {{ old('mostrar_columna_sucursal') ? 'checked' : '' }}>
                                                <span class="toggle-slider"></span>
