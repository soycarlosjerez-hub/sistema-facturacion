...
<div class="container-fluid py-4">
    <div class="premium-header">
        <div class="d-flex justify-content-between align-items-center position-relative" style="z-index: 1;">
            <div>
                <h3 class="fw-bold mb-1"><i class="bi bi-pencil-square me-2"></i>Editar Proveedor</h3>
                <p class="mb-0 opacity-75">Actualiza la información comercial de tu proveedor</p>
            </div>
    ...
    <div class="card border-0 shadow-lg rounded-4 overflow-hidden" style="background: rgba(255, 255, 255, 0.9); backdrop-filter: blur(12px);">
        <div class="card-header bg-white border-bottom border-light p-4">
            <h5 class="fw-bold mb-0 text-dark"><i class="bi bi-info-circle text-warning me-2"></i>Detalles del Proveedor</h5>
        </div>
        ...
        <form id="proveedorForm" action="{{ route('proveedores.update', $proveedore->id) }}" method="POST">
            ...
            <div class="card-body p-4 p-md-5">
                <div class="d-flex align-items-center mb-4 p-3 rounded-3" style="background: rgba(245, 158, 11, 0.08); border-left: 4px solid #f59e0b;">
                    ...
                    <span class="text-muted small">Editando: <strong>{{ $proveedore->nombre }}</strong></span>
                </div>
