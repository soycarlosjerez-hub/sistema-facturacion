...
<div class="container-fluid px-4 py-3">
    ...
    <div class="premium-header d-flex justify-content-between align-items-center">
        <div>
            <h2 class="fw-bold mb-1 d-flex align-items-center">
                <i class="bi bi-truck me-3 fs-1 opacity-75"></i> Catálogo de Proveedores
            </h2>
        ...
        <form method="GET" id="search-form" class="row g-3 align-items-end">
            <div class="col-lg-6">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="buscar" id="busqueda-proveedor" class="form-control border-start-0 ps-0" placeholder="Nombre, RNC, teléfono o email..." value="{{ request('buscar') }}" autocomplete="off">
                </div>
            </div>
    ...
    <div id="proveedores-container" class="table-responsive" style="min-height:400px;">
        <table class="table table-hover align-middle mb-0 w-100">
            <thead class="text-muted small text-uppercase tracking-wider" style="border-bottom: 2px solid #e2e8f0;">
                <tr>
                    ...
                    <th class="text-center pb-3">Identificación (RNC)</th>
            ...
            <tbody id="proveedores-tbody">
                ...
                <tr>
                    ...
                    <td>
                        <div class="fw-medium text-dark"><i class="bi bi-telephone text-muted me-2"></i>{{ $p->telefono ?? '&mdash;' }}</div>
                        <div class="text-muted small mt-1"><i class="bi bi-envelope text-muted me-2"></i>{{ $p->email ?? '&mdash;' }}</div>
                    </td>
                    ...
                    <td class="text-end pe-4">
                        <div class="d-flex justify-content-end gap-1">
                            <a href="{{ route('proveedores.show', $p) }}" class="btn btn-icon-hover text-info" title="Ver">
                                <i class="bi bi-eye"></i>
                            </a>
                            <a href="{{ route('proveedores.edit', $p) }}" class="btn btn-icon-hover text-primary" title="Editar">
                ...
                <tr>
                    <td colspan="5" class="text-center py-5">
                        <div class="d-flex flex-column align-items-center justify-content-center p-5">
                            ...
                            <p class="text-muted mb-4 text-center" style="max-width:400px;">Aún no se han registrado proveedores en tu directorio.</p>
