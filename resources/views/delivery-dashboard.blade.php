        ...
        <div class="col-6 col-md-3">
            <div class="ui-card h-100" style="--delay:.1s">
                <div class="ui-card-body">
                    ...
                    <div class="ui-stat-value">{{ $todayStats['total'] ?? 0 }}</div>
                    <small class="text-muted">{{ $todayStats['pendientes'] ?? 0 }} pendientes</small>
                </div>
            </div>
        </div>
        <div class="col-6 col-md-3">
            <div class="ui-card h-100" style="--delay:.15s">
                <div class="ui-card-body">
                    ...
                    <div class="ui-stat-value">{{ $todayStats['en_camino'] ?? 0 }}</div>
        ...
        <div class="col-6 col-md-3">
            <div class="ui-card h-100" style="--delay:.2s">
                <div class="ui-card-body">
                    ...
                    <div class="ui-stat-value">{{ $todayStats['entregadas'] ?? 0 }}</div>
        ...
        <div class="col-6 col-md-3">
            <div class="ui-card h-100" style="--delay:.25s">
                <div class="ui-card-body">
                    ...
                    <div class="ui-stat-value">{{ $todayStats['fallidas'] ?? 0 }}</div>
            ...
            <div class="ui-card h-100" style="--delay:.3s">
                <div class="ui-card-body">
                    ...
                    <div class="text-center py-3">
                        <div class="display-4 fw-bold text-primary">{{ $totalDrivers ?? 0 }}</div>
        ...
        <div class="col-lg-4">
            <div class="ui-card h-100" style="--delay:.35s">
                <div class="ui-card-body">
                    ...
                    <div class="text-center py-3">
                        <div class="display-4 fw-bold" style="color:#16a34a;">RD${{ number_format($monthlyEarnings ?? 0, 2) }}</div>
                    ...
                    @if(isset($topDriver) && $topDriver)
                        <div class="text-center py-3">
                            <div class="driver-avatar mx-auto mb-2" style="width:56px;height:56px;font-size:1.1rem;background:rgba(245,158,11,.1);color:#f59e0b;">
                                {{ strtoupper(substr($topDriver['nombre'], 0, 1) . substr($topDriver['apellido'], 0, 1)) }}
                            </div>
                            <h5 class="fw-bold mb-1">{{ $topDriver['nombre'] }}</h5>
                            <small class="text-muted">{{ $topDriver['apellido'] }}</small>
                            <div class="mt-2">
                                <span class="ui-badge ui-badge-warning">
                                    <i class="bi bi-trophy me-1"></i>{{ $topDriver['entregas'] }} entregas
                                </span>
                            </div>
                        </div>
                    @else
        ...
        <div class="col-lg-8">
            <div class="ui-card" style="--delay:.45s">
                <div class="ui-card-body">
                    ...
                    <canvas id="deliveriesChart" height="240"></canvas>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="ui-card" style="--delay:.5s">
                <div class="ui-card-body">
                    ...
                    @if(isset($topDrivers) && count($topDrivers))
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-start">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div>
                                        ...
                                        <br><small class="text-muted">{{ $driver['apellido'] }}</small>
                                    </div>
                                </div>
                                <span class="badge rounded-pill" style="background:rgba(34,197,94,.1);color:#16a34a;">{{ $driver['entregas'] }}</span>
                            </li>
                            @endforeach
                        </ol>
                    @else
