...
<div class="container-fluid px-4">
    ...
    <div class="card shadow-sm border-0 rounded-4">
        <div class="card-header bg-transparent pt-4 px-4">
            <h4 class="fw-bold mb-0"><i class="bi bi-plus-square me-2"></i>Nuevo Diseño</h4>
        </div>
        <div class="card-body p-4">
            <form action="{{ route('tattoo.disenos.store') }}" method="POST">
                @csrf
                <div class="row g-3">
                    <div class="col-md-8">
                ...
                <div class="mt-4 d-flex gap-2">
                    <button type="submit" class="btn btn-primary rounded-pill px-5 fw-bold">Guardar Diseño</button>
