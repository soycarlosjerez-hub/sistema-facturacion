...
<div class="ui-page" style="--accent:#8b5cf6;--accent-rgb:139,92,246;--accent-hover:#7c3aed;">
    ...
    <form action="{{ route('category-subcategories.update', $categorySubcategory) }}" method="POST" id="instanceForm">
        @csrf
        @method('PUT')
        <div class="row g-4">
            <div class="col-lg-8">
                        ...
                        <div class="row g-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="category_id" class="ui-select @error('category_id') is-invalid @enderror" required>
                                        ...
                                        @foreach($categories as $cat)
                                            <option value="{{ $cat->id }}" {{ old('category_id', $categorySubcategory->category_id) == $cat->id ? 'selected' : '' }}>{{ $cat->nombre }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nombre" class="ui-input @error('nombre') is-invalid @enderror" value="{{ old('nombre', $categorySubcategory->nombre) }}" required placeholder="Nombre de la subcategoría">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="descripcion" class="ui-input @error('descripcion') is-invalid @enderror" rows="3" placeholder="Descripción opcional">{{ old('descripcion', $categorySubcategory->descripcion) }}</textarea>
                                    @error('descripcion')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="activa" value="1" id="activa" {{ old('activa', $categorySubcategory->activa ?? true) ? 'checked' : '' }} role="switch" style="width:3em;height:1.5em;">
