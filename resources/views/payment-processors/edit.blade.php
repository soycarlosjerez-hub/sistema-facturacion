        ...
        <div class="ui-header-body">
            <div class="ui-header-left">
                ...
                <div>
                    ...
                    <div class="ui-header-meta">{{ $paymentProcessor->nombre }}</div>
                </div>
            </div>
            ...
            <form action="{{ route('payment-processors.update', $paymentProcessor) }}" method="POST" id="instanceForm">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nombre" class="ui-input @error('nombre') is-invalid @enderror" value="{{ old('nombre', $paymentProcessor->nombre) }}" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="ui-input-group">
                            <input type="number" step="0.01" name="comision_porcentaje" class="ui-input" value="{{ old('comision_porcentaje', $paymentProcessor->comision_porcentaje) }}" min="0" max="100" style="border-right:0;border-radius:var(--radius) 0 0 var(--radius);">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="ui-input-group">
                            ...
                            <input type="number" step="0.01" name="comision_fija" class="ui-input" value="{{ old('comision_fija', $paymentProcessor->comision_fija) }}" min="0" style="border-left:0;border-radius:0 var(--radius) var(--radius) 0;">
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="api_key" class="ui-input @error('api_key') is-invalid @enderror" value="{{ old('api_key', $paymentProcessor->api_key) }}" placeholder="Ej. pk_live_xxxxx">
                        @error('api_key')<div class="text-danger small mt-1">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-md-6">
                        <label class="ui-label fw-semibold">API Secret</label>
                        <div class="ui-input-group">
                            <input type="password" name="api_secret" class="ui-input @error('api_secret') is-invalid @enderror" value="{{ old('api_secret', $paymentProcessor->api_secret ? '********' : '') }}" placeholder="••••••••" style="border-right:0;border-radius:var(--radius) 0 0 var(--radius);">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="url" name="api_endpoint" class="ui-input @error('api_endpoint') is-invalid @enderror" value="{{ old('api_endpoint', $paymentProcessor->api_endpoint) }}" placeholder="https://api.procesador.com/v1">
