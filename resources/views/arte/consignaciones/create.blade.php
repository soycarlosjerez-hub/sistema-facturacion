...
<div class="container-fluid px-4 py-3">
    ...
    <div class="ui-card" style="--delay:.15s">
        ...
        <div class="ui-card-body">
            <form method="POST" action="{{ route('arte.consignaciones.store') }}" id="consignacionForm">
                @csrf
                <div class="row g-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="consignante" id="consignante" class="ui-input @error('consignante') is-invalid @enderror" value="{{ old('consignante') }}" placeholder="Nombre del consignante" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="porcentaje_comision" id="porcentaje_comision" class="ui-input" step="0.01" min="0" max="100" value="{{ old('porcentaje_comision', 0) }}">
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="monto_entregado" id="monto_entregado" class="ui-input" step="0.01" min="0" value="{{ old('monto_entregado', 0) }}">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="notas" id="notas" class="ui-textarea" rows="3">{{ old('notas') }}</textarea>
                    </div>
                </div>
            </form>
        </div>
