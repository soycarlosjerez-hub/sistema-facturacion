...
#comprasTable tbody tr:hover { background:rgba(59,130,246,.04); }
...
body.dark-mode #comprasTable tbody tr:hover { background:rgba(59,130,246,.08); }
...
<div class="container-fluid px-4 premium-page">
    <div class="premium-header d-flex flex-wrap justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center position-relative w-100" style="z-index:2;">
            <div>
                ...
                <p style="color:rgba(255,255,255,.8);" class="mb-0">Período: {{ $desde }} al {{ $hasta }} &middot; {{ $cantidad }} compra(s)</p>
            </div>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-3"><div class="premium-stat-card text-center p-3"><div class="stat-label">Total General</div><div class="stat-value text-primary">RD$ {{ number_format($totalGeneral, 2) }}</div></div></div>
        <div class="col-md-3"><div class="premium-stat-card text-center p-3"><div class="stat-label">ITBIS</div><div class="stat-value text-warning">RD$ {{ number_format($totalItbis, 2) }}</div></div></div>
        <div class="col-md-3"><div class="premium-stat-card text-center p-3"><div class="stat-label">Retenciones</div><div class="stat-value text-danger">RD$ {{ number_format($totalRetenciones, 2) }}</div></div></div>
    </div>
