...
<div class="container-fluid px-4 premium-page">
    <div class="premium-header d-flex flex-wrap justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center position-relative w-100" style="z-index:2;">
            <div>
                ...
                <p class="text-white-50 mb-0">Período: {{ ucfirst(Carbon\Carbon::create()->month($mes)->translatedFormat('F')) }} {{ $anio }}</p>
            </div>
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-4"><div class="premium-card card-accent blue h-100"><div class="card-body p-3 text-center"><small class="text-muted text-uppercase fw-bold" style="font-size:.65rem;">Retención ISR</small><h4 class="fw-bold mb-0 mt-1 text-primary">RD$ {{ number_format($totalRetIsr, 2) }}</h4></div></div></div>
        <div class="col-md-4"><div class="premium-card card-accent blue h-100"><div class="card-body p-3 text-center"><small class="text-muted text-uppercase fw-bold" style="font-size:.65rem;">Retención ITBIS</small><h4 class="fw-bold mb-0 mt-1 text-warning">RD$ {{ number_format($totalRetItbis, 2) }}</h4></div></div></div>
        <div class="col-md-4"><div class="premium-card card-accent blue h-100"><div class="card-body p-3 text-center"><small class="text-muted text-uppercase fw-bold" style="font-size:.65rem;">Total Retenido</small><h4 class="fw-bold mb-0 mt-1 text-danger">RD$ {{ number_format($totalGeneral, 2) }}</h4></div></div></div>
    </div>
