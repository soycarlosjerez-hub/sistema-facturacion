...
#propinasTable tbody tr:hover { background:rgba(59,130,246,.04); }
...
body.dark-mode #propinasTable tbody tr:hover { background:rgba(59,130,246,.08); }
</style>
@endpush
    ...
    <div class="premium-header d-flex flex-wrap justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center position-relative w-100" style="z-index:2;">
            <div>
                ...
                <p class="mb-0" style="color:rgba(255,255,255,.8);">Propinas por mesero</p>
            </div>
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-4">
            <div class="premium-stat-card text-center p-3">
                ...
                <div class="stat-value text-success">RD$ {{ number_format($totalGlobal, 2) }}</div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="premium-stat-card text-center p-3">
                <div class="stat-label">Órdenes con Propina</div>
                <div class="stat-value text-primary">{{ $ordenesConPropina }}</div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="premium-stat-card text-center p-3">
                <div class="stat-label">Promedio Global</div>
                <div class="stat-value text-warning">RD$ {{ number_format($ordenesConPropina > 0 ? $totalGlobal / $ordenesConPropina : 0, 2) }}</div>
            </div>
        </div>
    </div>
