...
<div class="ui-page" style="--accent:#06b6d4;--accent-rgb:6,182,212;--accent-hover:#0891b2;">
    <div class="ui-header mb-4">
        ...
        <div class="ui-header-body">
            <div class="ui-header-left">
                ...
                <div>
                    <h4 class="ui-header-title">Editar Paquete: {{ $paquete->nombre }}</h4>
    ...
    <form id="paquete-form" action="{{ route('lavadero.paquetes.update', $paquete) }}" method="POST">
        @csrf @method('PUT')
        <div class="row g-3">
            <div class="col-lg-8">
                <div class="ui-card">
                            ...
                            <div class="paquete-item-row">
                                <div class="row g-2 align-items-center">
                                    <div class="col-md-3">
                                        ...
                                        <select name="items[{{ $loop->index }}][tipo]" class="ui-select ui-select-sm" onchange="toggleItemField(this)">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="items[{{ $loop->index }}][servicio_id]" class="form-select form-select-sm item-servicio-field">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="items[{{ $loop->index }}][producto_id]" class="form-select form-select-sm item-producto-field" style="display:none;">
                                            <option value="">Seleccionar...</option>
                                            @foreach($productos as $p)
                                            <option value="{{ $p->id }}" {{ $item->producto_id == $p->id ? 'selected' : '' }}>{{ $p->nombre }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-2">
