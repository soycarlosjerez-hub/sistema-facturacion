...
<div class="container-fluid py-4" style="background: rgba(255,255,255,0.6); backdrop-filter: blur(10px); border-radius: 1.5rem;">
    <div class="premium-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2 class="fw-bold mb-1"><i class="bi bi-pencil-square me-2"></i>Editar Compra</h2>
                <p class="mb-0 opacity-75">Compra <strong>{{ $compra->folio }}</strong> · {{ $compra->proveedor->nombre ?? '—' }}</p>
            </div>
...
<div class="sticky-save-bar">
    <div class="d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center gap-3">
            ...
            <span class="text-muted"><i class="bi bi-info-circle me-1"></i>Editando compra {{ $compra->folio }}</span>
        </div>
