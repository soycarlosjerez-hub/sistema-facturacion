...
@section('title', 'Nuevo Item de Paquete')
...
<div class="ui-page" style="--accent:#06b6d4;--accent-rgb:6,182,212;--accent-hover:#0891b2;">
    <div class="ui-header mb-4">
        ...
        <div class="ui-header-body">
            <div class="ui-header-left">
                ...
                <div>
                    <h4 class="ui-header-title">Nuevo Item de Paquete</h4>
                    <div class="ui-header-meta"><i class="bi bi-list-check me-1"></i><span>Agregar servicio o producto a un paquete</span></div>
                </div>
            </div>
    ...
    <form id="paquete-item-form" action="{{ route('lavadero-paquete-items.store') }}" method="POST">
        @csrf
        <div class="row g-3">
            <div class="col-lg-8">
                <div class="ui-card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex gap-3">
                                <div class="form-check">
                                    <input type="radio" name="tipo" id="tipo-servicio" value="servicio" class="form-check-input" {{ old('tipo', 'servicio') == 'servicio' ? 'checked' : '' }} onclick="toggleTipo()">
                                    <label class="form-check-label" for="tipo-servicio">Servicio</label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" name="tipo" id="tipo-producto" value="producto" class="form-check-input" {{ old('tipo') == 'producto' ? 'checked' : '' }} onclick="toggleTipo()">
                        ...
                        <div class="mb-3" id="campo-producto" style="display:none;">
                ...
                <div class="ui-card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="cantidad" class="ui-input" value="{{ old('cantidad', 1) }}" min="0.01" step="0.01">
                        </div>
                        <div class="mb-3">
                            <label class="ui-label">Orden</label>
                            <input type="number" name="orden" class="ui-input" value="{{ old('orden') }}" min="0">
                        </div>

                        <div class="mt-4">
                            <div class="d-flex align-items-center gap-3 p-3 rounded-3" style="background:rgba(6,182,212,0.05);">
                                <div class="form-check form-switch mb-0">
                                    <input class="form-check-input" type="checkbox" name="incluir_automatico" value="1" id="chk-incluir-automatico" {{ old('incluir_automatico') ? 'checked' : '' }} role="switch" style="width:3em;height:1.5em;">
