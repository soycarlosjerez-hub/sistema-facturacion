            ...
            <form action="{{ route('sucursales.store') }}" method="POST" id="instanceForm">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="codigo" class="ui-input" value="{{ old('codigo') }}" required maxlength="20" placeholder="SUC-001">
                    </div>
                    <div class="col-md-6">
                        <label class="ui-label">Nombre <span class="text-danger">*</span></label>
                        <input type="text" name="nombre" class="ui-input" value="{{ old('nombre') }}" required maxlength="255" placeholder="Sucursal Principal">
                    </div>
                    <div class="col-12">
                        <label class="ui-label">Direcci&oacute;n</label>
                        <input type="text" name="direccion" class="ui-input" value="{{ old('direccion') }}" maxlength="500" placeholder="Calle, n&uacute;mero, sector, ciudad">
                    </div>
                    <div class="col-md-6">
                        <label class="ui-label">Tel&eacute;fono</label>
                        <input type="text" name="telefono" class="ui-input" value="{{ old('telefono') }}" maxlength="50" placeholder="809-555-0101">
                    </div>
                    <div class="col-md-6">
                        <label class="ui-label">Email</label>
                        <input type="email" name="email" class="ui-input" value="{{ old('email') }}" maxlength="255" placeholder="sucursal@ejemplo.com">
                    </div>
                    <div class="col-md-6">
                        <label class="ui-label">RNC</label>
                        <input type="text" name="rnc" class="ui-input" value="{{ old('rnc') }}" maxlength="20" placeholder="123456789">
                    </div>
                    <div class="col-md-3">
