    ...
    <div class="ui-header" style="--delay:0s;">
        ...
        <div class="ui-header-body">
            <div class="ui-header-left">
                ...
                <div>
                    <h1 class="ui-header-title">Editar: {{ $instalacion->numero }}</h1>
                    <div class="ui-header-meta">
                        <span>Modificar instalación de climatización</span>
                        <span class="divider">·</span>
                        <a href="{{ route('climatizacion.instalaciones.show', $instalacion) }}" style="color:rgba(255,255,255,.8);text-decoration:none;">
    ...
    <div class="ui-card" style="--delay:.1s;max-width:960px;margin:0 auto;">
        ...
        <div style="padding:1.25rem 1.75rem 0;">
            <div class="ui-card-title" style="padding:0;margin-bottom:.15rem;">
                <i class="bi bi-pencil-square"></i> Editar Instalación #{{ $instalacion->numero }}
            </div>
            ...
            <form action="{{ route('climatizacion.instalaciones.update', $instalacion) }}" method="POST">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="datetime-local" name="programada_para" class="ui-input @error('programada_para') is-invalid @enderror"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="datetime-local" name="completada_en" class="ui-input @error('completada_en') is-invalid @enderror"
                            value="{{ old('completada_en', $instalacion->completada_en ? $instalacion->completada_en->format('Y-m-d\TH:i') : '') }}">
                        @error('completada_en') <div class="invalid-feedback d-block">{{ $message }}</div> @enderror
                    </div>

                    <div class="col-12">
                        <label class="ui-label">Dirección de Instalación</label>
                        <input type="text" name="direccion_instalacion" class="ui-input @error('direccion_instalacion') is-invalid @enderror"
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="nota_interna" class="ui-textarea @error('nota_interna') is-invalid @enderror" rows="3" placeholder="Instrucciones u observaciones internas..." maxlength="2000">{{ old('nota_interna', $instalacion->nota_interna) }}</textarea>
                ...
                <div class="ui-sticky-bar" style="position:sticky;bottom:0;left:0;right:0;background:rgba(255,255,255,.85);backdrop-filter:blur(20px);border-top:2px solid #06b6d4;padding:.7rem 1.5rem;z-index:1050;box-shadow:0 -4px 20px rgba(0,0,0,.08);margin:0 -1.75rem -1.5rem;border-radius:0 0 var(--radius-2xl) var(--radius-2xl);">
                    <div class="ui-sticky-bar-inner">
                        <a href="{{ route('climatizacion.instalaciones.show', $instalacion) }}" class="ui-btn ui-btn-ghost"><i class="bi bi-x-lg"></i> Cancelar</a>
