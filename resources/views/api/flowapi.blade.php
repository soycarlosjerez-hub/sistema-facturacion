@extends('layouts.app')
@section('title', 'FlowApi Documentation')
    ...
    <main class="api-main" id="apiMain">
        <div class="api-header">
            <div class="d-flex align-items-center gap-2 mb-2">
                ...
                <a href="{{ route('flowapi.documentation.export') }}" class="btn btn-sm btn-outline-success rounded-pill ms-auto" title="Exportar documentación para IA">
