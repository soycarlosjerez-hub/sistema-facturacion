            ...
            <div class="card-body p-4 p-md-5">
                ...
                <div class="row g-4">
                    <div class="col-md-3">
                        ...
                        <input type="number" name="configuracion[copias]" id="config_copias" class="ui-input" value="{{ old('configuracion.copias', 1) }}" min="1" max="10" required>
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="configuracion[densidad]" id="config_densidad" class="ui-select">
                            <option value="normal" {{ old('configuracion.densidad', 'normal') === 'normal' ? 'selected' : '' }}>Normal</option>
                            <option value="alta" {{ old('configuracion.densidad') === 'alta' ? 'selected' : '' }}>Alta (mas oscuro)</option>
                            <option value="baja" {{ old('configuracion.densidad') === 'baja' ? 'selected' : '' }}>Baja (ahorro tinta)</option>
                        </select>
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="configuracion[font_size]" id="config_font_size" class="ui-select">
                            ...
                            <option value="9px" {{ old('configuracion.font_size', '') === '9px' ? 'selected' : '' }}>9px (pequeo)</option>
                            <option value="11px" {{ old('configuracion.font_size') === '11px' ? 'selected' : '' }}>11px (normal)</option>
                            <option value="12px" {{ old('configuracion.font_size') === '12px' ? 'selected' : '' }}>12px (grande)</option>
                            <option value="14px" {{ old('configuracion.font_size') === '14px' ? 'selected' : '' }}>14px (grande)</option>
                        </select>
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="configuracion[impresion]" id="config_impresion" class="ui-select">
                            <option value="normal" {{ old('configuracion.impresion', 'normal') === 'normal' ? 'selected' : '' }}>Normal</option>
                            <option value="compacto" {{ old('configuracion.impresion') === 'compacto' ? 'selected' : '' }}>Compacto (lineas juntas)</option>
                            <option value="espaciado" {{ old('configuracion.impresion') === 'espaciado' ? 'selected' : '' }}>Espaciado (mas legible)</option>
                        </select>
                ...
                <div class="row g-4 mt-2">
                    <div class="col-md-12">
                        ...
                        <div class="row g-2">
                            <div class="col">
                                <input type="number" name="configuracion[margenes][top]" class="ui-input text-center" value="{{ old('configuracion.margenes.top', 3) }}" min="0" max="20" placeholder="Top">
                                <small class="text-muted">Superior</small>
                            </div>
                            <div class="col">
                                <input type="number" name="configuracion[margenes][right]" class="ui-input text-center" value="{{ old('configuracion.margenes.right', 2) }}" min="0" max="20" placeholder="Right">
                                <small class="text-muted">Derecho</small>
                            </div>
                            <div class="col">
                                <input type="number" name="configuracion[margenes][bottom]" class="ui-input text-center" value="{{ old('configuracion.margenes.bottom', 3) }}" min="0" max="20" placeholder="Bottom">
                                <small class="text-muted">Inferior</small>
                            </div>
                            <div class="col">
                                <input type="number" name="configuracion[margenes][left]" class="ui-input text-center" value="{{ old('configuracion.margenes.left', 2) }}" min="0" max="20" placeholder="Left">
