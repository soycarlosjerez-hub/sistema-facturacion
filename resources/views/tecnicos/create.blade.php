...
.form-floating-modern .form-label { position: static; }
</style>
@endpush
    ...
    <div class="ui-header mb-4" style="--delay:0s">
        ...
        <div class="ui-header-body">
            <div class="ui-header-left">
                ...
                <div>
                    <h4 class="ui-header-title">Nuevo Técnico</h4>
                    <div class="ui-header-meta">Registra un técnico en el sistema</div>
                </div>
            </div>
            ...
            <form action="{{ route('tecnicos.store') }}" method="POST">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="cedula" id="cedula" class="form-control @error('cedula') is-invalid @enderror" value="{{ old('cedula') }}">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.01" min="0" name="tarifa_hora" id="tarifa_hora" class="form-control @error('tarifa_hora') is-invalid @enderror" value="{{ old('tarifa_hora') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.01" min="0" name="tarifa_fija" id="tarifa_fija" class="form-control @error('tarifa_fija') is-invalid @enderror" value="{{ old('tarifa_fija') }}">
                ...
                <div class="ui-card mb-4" style="--delay:.2s">
                    ...
                    <div class="card-body p-4">
                        ...
                        <textarea name="notas" id="notas" class="form-control @error('notas') is-invalid @enderror" rows="3" placeholder="Observaciones adicionales del técnico">{{ old('notas') }}</textarea>
