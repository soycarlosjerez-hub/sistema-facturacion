...
{
    /**
     * Tabla para categorías y subcategorías del lavadero (alimentos, bebidas, accesorios).
     * Soporta árbol de categorías con nivel de raíz (parent_id NULL) y subcategorías (parent_id SET).
     */
    public function up(): void
    {
        Schema::create('category_subcategories', function (Blueprint $table) {
            ...
            $table->unique(['category_id', 'business_type_id', 'parent_id', 'nombre']);
        });
    }
