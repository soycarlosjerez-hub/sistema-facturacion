...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::table('riesgos', function (Blueprint $table) {
            $table->foreign('auditoria_id')->references('id')->on('auditorias_internas')->onDelete('set null');
            $table->foreign('mejora_continua_id')->references('id')->on('mejoras_continuas')->onDelete('set null');
        });
    }
