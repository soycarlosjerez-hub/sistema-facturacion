...
class PagosInstanciaFullSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $rows = [
            ...
            ['id' => 2, 'business_instance_id' => 9, 'plan_id' => 1, 'monto' => 7500.0, 'mes_pagado' => '2026-08-01', 'fecha_pago' => '2026-08-14 17:35:14', 'metodo_pago' => 'transferencia', 'referencia_externa' => 'REGISTRO-AUTOSERVICIO', 'estado_pago' => 'completado', 'notas' => 'Registro autoservicio — pendiente de confirmación (implementación + primer mes)', 'registrado_por' => 30, 'created_at' => '2026-08-14 17:35:14', 'updated_at' => '2026-08-14 17:35:14'],
        ];
