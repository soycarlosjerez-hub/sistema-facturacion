...
class BusinessTypesFullSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $rows = [
            ...
            ['id' => 10, 'slug' => 'tecnologia', 'nombre' => 'Tienda de Celulares / Reparaciones', 'descripcion' => 'Venta de celulares, accesorios y servicios técnicos de reparación', 'color' => 'danger', 'icon' => 'bi-phone', 'activo' => 1, 'orden' => 9, 'config' => null, 'created_at' => '2026-07-22 23:36:18', 'updated_at' => '2026-07-22 23:36:18'],
