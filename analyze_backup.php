...
$tables = ["categorias", "clientes", "productos", "ventas", "venta_detalles", "mesas", "tipos_ventas", "almacen_movimientos", "business_instances", "system_settings", "instance_api_keys"];
foreach ($tables as $t) {
